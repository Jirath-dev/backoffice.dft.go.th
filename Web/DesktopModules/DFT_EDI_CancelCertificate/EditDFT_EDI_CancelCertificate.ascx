<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_CancelCertificate.EditDFT_EDI_CancelCertificate" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_CancelCertificate.ascx.vb" %>
