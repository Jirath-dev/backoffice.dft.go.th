<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_BookingForm_Summary.EditDFT_EDI_BookingForm_Summary" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_BookingForm_Summary.ascx.vb" %>
