<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_CheckingF04.EditDFT_EDI_CheckingF04" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_CheckingF04.ascx.vb" %>
