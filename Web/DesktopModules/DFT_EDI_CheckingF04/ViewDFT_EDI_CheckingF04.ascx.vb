...
Namespace NTi.Modules.DFT_EDI_CheckingF04
    Partial Class ViewDFT_EDI_CheckingF04
...
#End Region
        ...
        Function LoadCertificateList() As SqlDataReader
            Try
                ...
                myReader = SqlHelper.ExecuteReader(objConn, CommandType.StoredProcedure, "vi_select_Follow_NewDS", _
                New SqlParameter("@TCat", IIf(chkType.Checked, 2, 1)), _
