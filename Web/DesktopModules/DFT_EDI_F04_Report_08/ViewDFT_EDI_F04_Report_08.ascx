<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_F04_Report_08.ViewDFT_EDI_F04_Report_08" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_F04_Report_08.ascx.vb" %>
                                                ...
                                                <table cols="2" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td nowrap class="groupboxheader">
                                                            <font class="groupbox">&#160;&#160;รายงานการรับรายงานเอกสารประกอบคำขอหนังสือรับรองฯ
                                                                (ยกเลิกใบอนุญาต)&#160;&#160;</font></td>
                                        ...
                                        <tr>
                                            <td style="width: 100%">
                                                <table cellpadding="0" cellspacing="0" dwcopytype="CopyTableColumn">
                                                    <tr>
                                                        <td>
                                                            <font class="FormLabel">&nbsp;ประเภทหนังสือรับรองฯ:&nbsp;</font></td>
                                                        <td>
                                                            <telerik:RadComboBox id="rcbSFormType" runat="server" Skin="Web20" Width="400px" Font-Size="10pt" Font-Names="Tahoma" MarkFirstMatch="True" Filter="StartsWith">
                                                            </telerik:RadComboBox>
                                                        </td>
                                                        <td>
                            ...
                            <tr>
                                <td style="width: 100%">
                                    <telerik:RadGrid ID="rgAllRequestList" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        Font-Size="X-Small" TabIndex="-1" PageSize="50" ShowFooter="True">
