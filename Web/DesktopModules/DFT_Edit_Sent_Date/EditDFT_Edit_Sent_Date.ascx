<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_Edit_Sent_Date.EditDFT_Edit_Sent_Date" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_Edit_Sent_Date.ascx.vb" %>
