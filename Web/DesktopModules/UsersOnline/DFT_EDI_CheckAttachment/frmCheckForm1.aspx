    ...
    <form id="form1" runat="server" onclick="return form1_onclick()">
        ...
        <telerik:RadPane ID="RadPane1" BackColor="#cbe1ef" runat="server" Width="50%" Height="100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td style="text-align: center">
                                                                                        <div style="margin-top: 8px; margin-bottom: 8px;">
                                                                                            <asp:Button ID="Button1" runat="server" style="margin-bottom:5px;" Text="ผ่านการตรวจสอบ" OnClientClick="return confirm('คุณแน่ใจว่าต้องการกำหนดให้แบบฟอร์มนี้ ผ่านการตรวจสอบเอกสาร ใช่หรือไม่? \nกรุณาเลือกคลิกปุ่ม [OK]=ผ่านการตรวจสอบ หรือปุ่ม [Cancel]=ไม่ผ่าน');"
                                                                                                Width="120px" Font-Names="Tahoma" Font-Size="10pt" BackColor="#80FF80" />
                                                                                                ...
                                                                                                &#160;<asp:Button style="margin-bottom:5px;"
            ...
            <asp:Panel runat="server" ID="panelInfo" Style="border-top: 1px solid #cccccc; border-bottom: 2px solid #cccccc;
                ...
                <div style="text-align:center"><asp:Button runat="server" CausesValidation="false" UseSubmitBehavior="false" OnClientClick="return ShowRestatus();" Visible="false" ID="btnReStatus" Text="ย้อนสถานะผลการตรวจสอบ" /></div>
            </asp:Panel>
            ...
            <asp:Panel ID="panelFile" runat="server">
                ...
                <div style="padding: 5px; text-align:center; padding-left: 8px; border: 1px solid #666666; border-top: 2px solid #ff0000;
                    background: #ffffff;">
                    <table cellpadding="0" width="100%" cellspacing="0">
                        <tr>
                            <td align="center" style="font-size: 8pt; color: #666666;">
                                ผลการตรวจสอบคุณสมบัติทางด้านถิ่นกำเนิดของสินค้า:
            ...
            <iframe runat="server" height="100%" width="100%" frameborder="0" id="PDF_FRAME" style="margin-left:3px;"></iframe>
			</div>
        </telerik:RadPane>
