    ...
    Protected Sub CheckRollver(ByVal CERTNO As String, ByVal TAXNO As String, ByVal COUNTRY As String)
        Try
            ...
            strCommand = "SELECT transfer_date, tax_id, country, harmonized_no, certoforigin_no, CONVERT(varchar(8), certoforigin_date, 112) AS certoforigin_date, company_name_th, " & _
                         "company_name_en, goods_desc_th, goods_desc_en, models, country_code, CONVERT(varchar(8), DATEADD(yyyy, 2, certoforigin_date), 112) AS Cert_ExpiredDate, CONVERT(varchar(8),DATEADD(dd,-1,DATEADD(yyyy, 2, certoforigin_date)) , 112) AS Cert_ExpiredDate2 " & _
