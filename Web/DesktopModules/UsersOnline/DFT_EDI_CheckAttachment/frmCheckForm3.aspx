    ...
    <telerik:RadSplitter ID="RadSplitter1" runat="server" VisibleDuringInit="False" Width="100%"
        ...
        <telerik:RadPane ID="RadPane1" BackColor="#cbe1ef" runat="server" Width="50%" Height="99%">
                                                                                    ...
                                                                                    <td style="text-align: center">
                                                                                        <div style="margin-top: 8px; margin-bottom: 8px;">
                                                                                            <asp:Button ID="Button1" runat="server" Text="ผ่านการตรวจสอบ" OnClientClick="return confirm('คุณแน่ใจว่าต้องการกำหนดให้แบบฟอร์มนี้ ผ่านการตรวจสอบเอกสาร ใช่หรือไม่? \nกรุณาเลือกคลิกปุ่ม [OK]=ผ่านการตรวจสอบ หรือปุ่ม [Cancel]=ไม่ผ่าน');"
                                                                                                Width="120px" Font-Names="Tahoma" Font-Size="10pt" BackColor="#80FF80" />&#160;<asp:Button
            ...
            <asp:Panel runat="server" ID="panelInfo" Style="border-top: 1px solid #cccccc; border-bottom: 2px solid #cccccc;
                font-size: 10pt; margin: 3px;margin-right:18px; padding: 5px; background: #ffc888">
                ...
                <div style="text-align:center"><asp:Button CausesValidation="false" UseSubmitBehavior="false" OnClientClick="return ShowRestatus();" runat="server" Visible="false" ID="btnReStatus" Text="ย้อนสถานะผลการตรวจสอบ" /></div>
            </asp:Panel>
            <div style="margin: 3px; margin-right: 20px;">
                                    ...
                                    <td>
                                        ...
                                        <div class="RadGrid RadGrid_Office2007" style="font-family: Tahoma; font-size: X-Small;">
                                            <telerik:RadCodeBlock ID="RadCodeBlock11" runat="server">
                                                <table border="0" class="rgMasterTable" cellpadding="0" cellspacing="0" style="width: 100%;
                                                    ...
                                                    <asp:Panel runat="server" ID="PanelInv"><tr class="rgRow"><td style="width: 16px;"><a href="javascript:ShowInvoice();void(0);"><asp:Image ID="Image3" BorderStyle="None" ImageUrl="~/images/view.gif" ToolTip="View"
                                                ImageAlign="AbsMiddle" runat="server" /></a></td><td><a href="javascript:ShowInvoice();void(0);">ใบกำกับสินค้า(Invoice)</a> </td></tr></asp:Panel>
                                                    <%End If%>
                                                </table>
                                            </telerik:RadCodeBlock>
                                        </div>
                                        <div style="padding: 5px; padding-left: 8px; border: 1px solid #666666; border-top: 2px solid #ff0000;
                                            ...
                                            <span style="font-size: 10pt;">
                                                <a href="#" onclick="return ShowAttachSheet();"><img src="/images/view.gif" border="0" /></a>
                                                <input type="button" value="แสดง Attached Sheet เพื่อตรวจสอบต้นทุน" onclick="return ShowAttachSheet();" /></span></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
				...
				<div style="height:700px;" id="divForm">
