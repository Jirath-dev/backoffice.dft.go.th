<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_Report_04.ViewDFT_EDI_Report_04" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_Report_04.ascx.vb" %>
                ...
                <tr>
                    <td>
                                                ...
                                                <table cols="2" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td nowrap class="groupboxheader">
                                                            <font class="groupbox">&#160;&#160;รายงานการออกหนังสือรับรองถิ่นกำเนิดสินค้า&#160;&#160;</font></td>
                            ...
                            <tr class="m-frm-hdr">
                                <td>
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td style="width: 100%; text-align: center;">
                                                            <asp:Button ID="btnSearch" runat="server" Width="150px" Text="แสดงผล" Font-Names="Tahoma" Font-Size="10pt" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <table cellpadding="2" cellspacing="2" style="width: 100%">
                            <tr>
                                <td style="width: 100%">
                                    <asp:Button ID="btnPrint" runat="server" Text="พิมพ์รายงาน" Visible="False" Width="150px" Font-Names="Tahoma" Font-Size="10pt" /></td>
                            </tr>
                            <tr>
                                <td style="width: 100%">
                                    <telerik:RadGrid ID="rgCetificateList" runat="server" AllowSorting="True"
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" Width="100%" NoMasterRecordsText="ไม่พบรายการที่ทำการค้นหา">
                                            ...
                                            <Columns>
                                                <telerik:GridBoundColumn DataField="Description" HeaderText="ชื่อฟอร์ม"
                                                ...
                                                <telerik:GridNumericColumn DataField="SUM_FOB" ReadOnly="True" HeaderText="มูลค่า (USD)"
                                                    SortExpression="SUM_FOB" UniqueName="SUM_FOB" Aggregate="Sum" FooterText="รวม : " DataFormatString="{0:N2}">
                                                    <ItemStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Right"/>
                                                    <FooterStyle Font-Names="Tahoma" HorizontalAlign="Right" Font-Size="10pt"/>
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </telerik:GridNumericColumn>
