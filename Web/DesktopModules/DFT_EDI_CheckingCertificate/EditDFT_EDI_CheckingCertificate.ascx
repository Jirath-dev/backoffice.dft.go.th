<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_CheckingCertificate.EditDFT_EDI_CheckingCertificate" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_CheckingCertificate.ascx.vb" %>
