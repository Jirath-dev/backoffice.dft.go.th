<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_CheckingCertificate.ViewDFT_EDI_CheckingCertificate" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_CheckingCertificate.ascx.vb" %>
                                                    ...
                                                    <tr>
                                                        <td style="font-size: 12pt; color: #000000; font-family: Times New Roman">
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <font class="FormLabel">หมายเลขอ้างอิง (Barcode) &nbsp;:</font></td>
                                                                    <td>
                                                        ...
                                                        <td style="font-size: 12pt; color: #000000; font-family: Times New Roman">
                                                            <telerik:RadGrid ID="rgCertificateList" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" ClientDataKeyNames=""
                                                                    DataKeyNames="" NoMasterRecordsText="ไม่มีรายการใบเสร็จที่ผ่านการชำระแล้ว" Width="100%">
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridBoundColumn DataField="create_date" HeaderText="เวลาสร้าง" ReadOnly="True"
                                                                            SortExpression="create_date" UniqueName="create_date" DataFormatString="{0:dd/MM/yyyy}">
                                                                            <ItemStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Center" />
                                                                        </telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="sent_date" HeaderText="เวลาส่ง" ReadOnly="True"
                                                                            SortExpression="sent_date" UniqueName="sent_date" DataFormatString="{0:dd/MM/yyyy}">
                                                                            <ItemStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Center" />
                                                                        </telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="acknowledge_date" HeaderText="เวลารับ" ReadOnly="True"
                                                                            SortExpression="acknowledge_date" UniqueName="acknowledge_date" DataFormatString="{0:dd/MM/yyyy}">
                                                                            <ItemStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Center" />
                                                                        </telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="bill_date" HeaderText="เวลาออกใบเสร็จ" ReadOnly="True"
                                                                            SortExpression="bill_date" UniqueName="bill_date" DataFormatString="{0:dd/MM/yyyy}">
                                                                            <ItemStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Center" />
                                                                        </telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="bill_no" HeaderText="หมายเลขใบเสร็จ" ReadOnly="True"
                                                                        ...
                                                                        <telerik:GridBoundColumn DataField="receipt_site_id" HeaderText="ที่ออกใบเสร็จ" ReadOnly="True"
                                                                            SortExpression="receipt_site_id" UniqueName="receipt_site_id">
                                                                            <ItemStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Center" />
                                                                        </telerik:GridBoundColumn>
