...
Namespace NTi.Modules.DFT_EDI_F04_Report_06
    Partial Class ViewDFT_EDI_F04_Report_06
        ...
        Function LoadReport() As SqlDataReader
            Try
                ...
                strCommand = "SELECT A.reference_code2, A.company_name, A.approve_date, " & _
                             ...
                             "WHERE (A.edi_status_id = 'A') AND (A.Rep_status = 'W' OR A.Rep_status = 'A') AND (B.site_edit = '" & lblRoleID.Text & "') " & _
                             "AND (CONVERT(varchar(8), B.date_edit, 112) BETWEEN " & FunctionUtility.DMY2YMD(rdpFromDate.SelectedDate.Value) & "" & _
