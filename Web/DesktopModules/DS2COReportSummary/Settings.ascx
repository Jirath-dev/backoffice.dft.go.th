<%@ Control Language="vb" AutoEventWireup="false" Inherits="YourCompany.Modules.DS2COReportSummary.Settings" Codebehind="Settings.ascx.vb" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="DS2COReportSummary Settings Design Table">
    <tr>
