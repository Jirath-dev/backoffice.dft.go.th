<%@ Control language="vb" Inherits="YourCompany.Modules.DS2COReportSummary.EditDS2COReportSummary" AutoEventWireup="false" Explicit="True" Codebehind="EditDS2COReportSummary.ascx.vb" %>
