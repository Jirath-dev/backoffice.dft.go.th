<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_Report_Form_ByPro.EditDFT_Report_Form_ByPro" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_Report_Form_ByPro.ascx.vb" %>
