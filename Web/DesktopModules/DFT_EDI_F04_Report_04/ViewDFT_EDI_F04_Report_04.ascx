<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_F04_Report_04.ViewDFT_EDI_F04_Report_04" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_F04_Report_04.ascx.vb" %>
                                                ...
                                                <table cols="2" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td nowrap class="groupboxheader">
                                                            <font class="groupbox">&#160;&#160;รายงานการแจ้งแก้ไขเอกสารประจำวัน&#160;&#160;</font></td>
                                    ...
                                    <telerik:RadGrid ID="rgAllRequestList" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" Width="100%" NoMasterRecordsText="ไม่พบรายการที่ทำการค้นหา">
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="remark_docatt" HeaderText="เหตุผล"
                                                    ReadOnly="True" SortExpression="remark_docatt" UniqueName="remark_docatt">
                                                    <ItemStyle Font-Names="Tahoma" Font-Size="10pt" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="alert_user" HeaderText="ผู้แจ้งแก้ไข"
                                                    ReadOnly="True" SortExpression="alert_user" UniqueName="alert_user">
                                                    <ItemStyle Font-Names="Tahoma" Font-Size="10pt" />
                                                </telerik:GridBoundColumn>
                                            </Columns>
                                        </MasterTableView>
