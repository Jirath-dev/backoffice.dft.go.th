<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="crlReportbyCompany.ascx.vb"
    Inherits=".crlReportbyCompany" %>
                            ...
                            <div style="padding: 5px">
                                <telerik:RadGrid ID="RadGrid1" Visible="False" runat="server" CellPadding="1" CellSpacing="1"
                                    ...
                                    <MasterTableView>
                                        ...
                                        <Columns>
                                            <telerik:GridTemplateColumn HeaderText="ลำดับ" UniqueName="itemcount">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="วันที่เริ่มขอฟอร์ม" UniqueName="send_date"
                                                SortExpression="send_date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDate" runat="server" Text='<%#GetDateFormat(Eval("fist_send_date")) %>'></asp:Label>
                                                </ItemTemplate>
