...
Partial Public Class crlReportbyCompany
    ...
    Public Sub LoadReport(ByVal sdate As DateTime, ByVal edate As DateTime)
        Dim comm As String = "vi_report_edi_ReportbyCompany_NewDS"
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            lblMsg.Visible = True
            lblMsg.Text = "สรุปจำนวนการขอฟอร์มทั้งหมด ที่ผ่านและไม่ผ่านการตรวจสอบจากเจ้าหน้าที่  </br> ตั้งแต่  " & _
    ...
    Private Sub RadGrid1_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If TypeOf e.Item Is GridFooterItem Then
            ...
            footerItem("company_name").Controls.Add(New LiteralControl("<div style='color: black; font-weight: bold;text-align:center;'>รวม</div> "))
