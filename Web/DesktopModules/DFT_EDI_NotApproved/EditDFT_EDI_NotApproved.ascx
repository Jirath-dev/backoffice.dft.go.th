<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_NotApproved.EditDFT_EDI_NotApproved" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_NotApproved.ascx.vb" %>
