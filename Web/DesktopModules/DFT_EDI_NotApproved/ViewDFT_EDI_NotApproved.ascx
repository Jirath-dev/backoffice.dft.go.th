<%@ Control Language="vb" Inherits="NTi.Modules.DFT_EDI_NotApproved.ViewDFT_EDI_NotApproved"
    AutoEventWireup="false" Explicit="True" CodeBehind="ViewDFT_EDI_NotApproved.ascx.vb" %>
...
<script type="text/javascript">
    function OnKeyPress(sender, eventArgs) {
         ...
         if (navigator.userAgent.indexOf("Firefox") != -1) {
            var f = eventArgs.get_keyCode();
            if (f == 13) {
                var btnQiuckSearch = document.getElementById('<%=btnNotApproved.ClientID%>');
                                                            ...
                                                            <table width="300" border="0" cellspacing="2" cellpadding="0">
                                                                <tr>
                                                                    <td style="text-align: center">
                                                                        <asp:Button ID="btnNotApproved" runat="server" Text="ไม่ผ่านการอนุมัติ" Width="200px" Font-Names="Tahoma" Font-Size="10pt" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="text-align: center">
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE01" runat="server" Width="230px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE02" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE03" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE04" runat="server" Width="230px">
                                                                       <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE05" runat="server" Width="230px">
                                                                            <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE06" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE07" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE08" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE09" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE10" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE11" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE12" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE99" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="text-align: right">
                                                                        <font class="FormLabel">ยกเลิก</font></td>
                                                                    <td>
                                                                        <telerik:RadTextBox ID="txtE00" runat="server" Width="230px">
                                                                             <ClientEvents OnKeyPress="OnKeyPress" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                            </table>
...
<asp:TextBox ID="txttemp" runat="server" Width="0px" Height="0px" Text=""></asp:TextBox>
