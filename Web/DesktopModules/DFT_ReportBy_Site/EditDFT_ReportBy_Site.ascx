<%@ Control language="vb" Inherits="NTi.Modules.DFT_ReportBy_Site.EditDFT_ReportBy_Site" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_ReportBy_Site.ascx.vb" %>
