...
Public Class rpt_Receipt_Yellow 
    ...
    Private Sub Detail1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        'txtTempreference_code2.Text = "I" & txtreference_code2.Text

        ''ByTine ตัด I ออกจากใบเสร็จ 20-01-2560
        txtTempreference_code2.Text = txtreference_code2.Text
    End Sub
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        'Sum_Total = xxx.Text
        'xxx.Text = Format(Sum_Total, "#,##0.00")
    End Sub
