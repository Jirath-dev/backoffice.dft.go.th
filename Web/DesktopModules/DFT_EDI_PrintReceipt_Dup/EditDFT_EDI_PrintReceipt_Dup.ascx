<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_PrintReceipt_Dup.EditDFT_EDI_PrintReceipt_Dup" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_PrintReceipt_Dup.ascx.vb" %>
