<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_ReportEDIAll.EditDFT_ReportEDIAll" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_ReportEDIAll.ascx.vb" %>
