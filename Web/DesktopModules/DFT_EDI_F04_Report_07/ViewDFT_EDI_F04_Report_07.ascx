<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_F04_Report_07.ViewDFT_EDI_F04_Report_07" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_F04_Report_07.ascx.vb" %>
                                                ...
                                                <table cols="2" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td nowrap class="groupboxheader">
                                                            <font class="groupbox">&#160;&#160;รายงานการรับคืนเอกสารแก้ไขประจำวัน&#160;&#160;</font></td>
                                    ...
                                    <telerik:RadGrid ID="rgAllRequestList" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" Width="100%" NoMasterRecordsText="ไม่พบรายการที่ทำการค้นหา">
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="user_finish" HeaderText="ผู้รับคืนเอกสาร"
