...
Partial Public Class frmF04_Report_07
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            strCommand = "SELECT A.reference_code2, A.company_name, A.approve_date, " & _
                         ...
                         "WHERE (A.edi_status_id = 'A') AND (A.Rep_status = 'A') AND (B.site_finish = '" & Request.QueryString("SITEID") & "') " & _
                         "AND (CONVERT(varchar(8), B.date_finish, 112) BETWEEN " & Request.QueryString("FROM") & "" & _
                         "AND " & Request.QueryString("TO") & ")"
            ds = SqlHelper.ExecuteDataset(strConn, CommandType.Text, strCommand)

            If ds.Tables(0).Rows.Count > 0 Then
                Dim m_stream As New System.IO.MemoryStream()
                Dim rpt As New rptF04_Report_07
