<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_EDI_CheckInvoice_Cost.EditDFT_EDI_CheckInvoice_Cost" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_CheckInvoice_Cost.ascx.vb" %>
