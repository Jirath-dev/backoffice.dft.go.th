<%@ Control language="vb" Inherits="Nti.Modules.DFT_EDI_ResetReceipt.EditDFT_EDI_ResetReceipt" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_ResetReceipt.ascx.vb" %>
