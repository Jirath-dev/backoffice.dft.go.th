...
#Region "   Code Main Print   "
    ...
    Public Shared Function printMultireport(ByVal sendFormType As String, ByVal Cells As String, ByVal SiteID As String, ByVal sendRadio_Form As String, ByVal sendUser As String, ByVal sendRequest_print As String, ByVal PrintFlag As String, _
        ...
        Select Case By_CheckCaseOle
            Case True
                Select Case By_IDYear
                    Case "1" 'ปี 2007-2008
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_Ole01", _
                                                                New SqlParameter("@INVH_RUN_AUTO", Cells), _
                                                                New SqlParameter("@SITE_ID", SiteID))
                    Case "2" 'ปี 2009-2010
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_Ole02", _
                                                                New SqlParameter("@INVH_RUN_AUTO", Cells), _
                                                                New SqlParameter("@SITE_ID", SiteID))
                    Case "3" 'ปี 2011-2012
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_Ole03", _
                                                                New SqlParameter("@INVH_RUN_AUTO", Cells), _
                                                                New SqlParameter("@SITE_ID", SiteID))
                End Select
            Case False
                Select Case sendFormType
                    Case "FORM44_01", "FORM44_02"
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_RePrint_ASW",
                                        ...
                                        New SqlParameter("@SITE_ID", SiteID))
                    Case Else
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_RePrint",
                                        New SqlParameter("@INVH_RUN_AUTO", Cells),
                                        New SqlParameter("@SITE_ID", SiteID))
                End Select
