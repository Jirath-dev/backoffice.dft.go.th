...
Public Class rpt3_ediFORM44_02
    'by rut D new
            ...
            Case 1
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                ...
                                                                String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, ""), txtinvh_run_auto.Value) & "        " &
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                    ...
                                                                    BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " &
                                                                    BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " &
                                                                    BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & String_Total_USDOnly_New_Attach(txtDisplayUDS7.Text, txtCurrency_Code.Text, IIf(_IsAgent = False, TFob, _TAgent), CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, txtinvh_run_auto.Value) & vbNewLine &
                                                                    _TempB2B & vbNewLine &
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                    "       _____________________________"
                Else
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & String_Total_USDOnly_New_Attach(txtDisplayUDS7.Text, txtCurrency_Code.Text, IIf(_IsAgent = False, TFob, _TAgent), CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, txtinvh_run_auto.Value) & vbNewLine &
                                                                    _TempB2B & vbNewLine &
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                    "       _____________________________"
                Else
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value),
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & String_Total_USDOnly_New_Attach(txtDisplayUDS7.Text, txtCurrency_Code.Text, IIf(_IsAgent = False, TFob, _TAgent), CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, txtinvh_run_auto.Value) & vbNewLine &
                                                                    _TempB2B & vbNewLine &
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                    "       _____________________________"
                Else
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value),
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Visible = True
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & String_Total_USDOnly_New_Attach(txtDisplayUDS7.Text, txtCurrency_Code.Text, IIf(_IsAgent = False, TFob, _TAgent), CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, txtinvh_run_auto.Value) & vbNewLine &
                                                                    _TempB2B & vbNewLine &
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                    "       _____________________________"
                Else
