                                ...
                                <td class="m-frm" valign="top" width="100%">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr> 
                                                                <td style="width: 194px">
                                                                        <asp:Button ID="view" runat="server" Text="Duplicate" Width="150px" ValidationGroup="Print" /></td>
                                                            </tr>
                                                                <tr>
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton CommandName="view" ImageUrl="~/images/view.gif" runat="server" ID="btnView"
                                                    ToolTip="เรียกดู" />
                                            </ItemTemplate>
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRePrint_Remark"
                                                                ErrorMessage="กรุณาระบุเหตุผลการพิมพ์หนังสือรับรอง" Font-Names="Tahoma" Font-Size="10pt" ForeColor="Red" 
