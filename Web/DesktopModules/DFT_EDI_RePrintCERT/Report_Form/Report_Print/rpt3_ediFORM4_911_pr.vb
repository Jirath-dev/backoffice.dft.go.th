...
#Region "Code sign image"
    ...
    '            'Picture_SealAuthor.SizeMode = SizeModes.Stretch
    '            Picture_SealAuthor.Image = New Drawing.Bitmap(reports_CardID(arr_(0).ToString))
    '    End Select
    'End Sub
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_911_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        Dim y_txtmarks As Single = 4.93 '4.875
        'Dim width As Single = 6.0F
    ...
    Private Sub rpt3_ediFORM4_911_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        End If
    End Sub

    Private Sub rpt3_ediFORM4_911_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
    ...
    Function CallInvoice_() As String 'Check Invoince
        ...
        Select Case txtshow_check.Text
            Case "0100", "1100", "1110", "1111", "0101" 'invoice ต่างประเทศ
