...
#Region "by rut 15-10-2012 ปรับเรื่อง invoice eng ให้แสดง invoice thai ด้วยเวลาเลือก third country"
    ...
    Function Check_Th_invoiceOnly(ByVal By_invoiceEng As String) As Boolean
        ...
        '//2020-01-06
        '//ยกเลิกการตรวจ th invoice กับ thired invoice
...
#End Region
    ...
    Function GrossTxt(value_type As ValueType) As String
        ...
        'Str_GrossTxt = "G.W." & vbNewLine & Format(Dec_Gross, "#,##0.00##") & " " & DataUtil.ConvertToString(txtg_unit_code.Value) 'CStr(Dec_Gross) & " " & DataUtil.ConvertToString(txtg_unit_code.Value)
