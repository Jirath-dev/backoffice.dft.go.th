...
Public Class rpt3_ediFORM4_61_VR
...
#Region "by rut 15-10-2012 ปรับเรื่อง invoice eng ให้แสดง invoice thai ด้วยเวลาเลือก third country"
    ...
    Function Check_Th_invoiceOnly(ByVal By_invoiceEng As String) As Boolean
        ...
        '//2020-01-06
        '//ยกเลิกการตรวจ th invoice กับ third invoice
        Tempth_invoices = False
...
#End Region
    ...
    Dim SmsThird As String = """" & "The goods will be subject to another invoice to be issued in a third country for the importation into the importing Party" & """" & " "
    Dim All_str As String
    Sub Title_StrDetail()
            ...
            Case 1
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                ...
                                                                String_Total_USDOnly_New(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFOB, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther) &
                                                                IIf(Check_smsThird <> "", SmsThird, "") &
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                    ...
                                                                    BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " &
                                                                    BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf &
                                                                    String_Total_USDOnly_New(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFOB, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther) & vbNewLine &
                                                                    _TempB2B & vbNewLine &
                                                                    "       _____________________________"
                Else
                    txtT_product.Text = All_str
    ...
    Sub All_CheckThird_0(ByVal count_data As Integer)
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value),
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    txtT_product.Text = All_str & vbNewLine &
                                                                    _TempB2B & vbNewLine &
                                                                    "       _____________________________"
                Else
                    txtT_product.Text = All_str
        ...
        Select Case txtshow_check.Text
            Case "10" ' เรื่อง invoice ต่างประเทศ
                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                        str_gross = GrossTxt(ValueType.GW) & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) 'Mid(txtnet_weight.Value, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10) '& vbNewLine & FobTxt()
                    ...
                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
                        str_gross = GrossTxt(ValueType.GW) '& vbNewLine & FobTxt()
                        Select Case C_TotalRowDe.Text
                            Case 1
                                txtGrossTxt.Text = str_gross & vbNewLine & str_USDInvoice
                            Case Else
                                ...
                                End If
                        End Select
                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "OTHER QUANTITY" Then
                        str_gross = GrossTxt(ValueType.QTY) '& vbNewLine & FobTxt()
                        Select Case C_TotalRowDe.Text
                            Case 1
                                txtGrossTxt.Text = str_gross & vbNewLine & str_USDInvoice
                            Case Else
                ...
                ElseIf Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "NoDisplay" Then
                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                        str_gross = GrossTxt(ValueType.GW) & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) 'Mid(txtnet_weight.Value, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10)
                        Select Case C_TotalRowDe.Text
                            Case 1
                                txtGrossTxt.Text = str_gross & vbNewLine & str_USDInvoice
                            Case Else
                        ...
                        End Select
                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
                        str_gross = GrossTxt(ValueType.GW)
                        Select Case C_TotalRowDe.Text
                            Case 1
                                txtGrossTxt.Text = str_gross & vbNewLine & str_USDInvoice
                            Case Else
                        ...
                        End Select
                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "OTHER QUANTITY" Then
                        str_gross = GrossTxt(ValueType.QTY)
                        Select Case C_TotalRowDe.Text
                            Case 1
                                txtGrossTxt.Text = str_gross & vbNewLine & str_USDInvoice
                            Case Else
            ...
            Case Else 'ไม่ใช่ invoice ต่างประเทศ
                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                    ...
                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                        str_gross = GrossTxt(ValueType.GW) & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) & vbNewLine & FobTxt()
                        Select Case C_TotalRowDe.Text
                            Case 1
                    ...
                    Case "GWDetail" 'แยกรายการ ส่วน third
                        Select Case Check4_6In_report(Mid(CommonUtility.Get_StringValue(txtletter.Value), 1, 50), CommonUtility.Get_StringValue(txtbox8.Value))
                            Case "3" 'แสดงมูลค่า Detail ส่วน third [ต้องแสดงมูลค่า แต่ละรายการสินค้าหมดที่เป็น case 3 ยกเว้นยอดรวม]
                                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                                        str_gross = GrossTxtDetail(ValueType.GW) & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) 'Mid(Tnet, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10) '& vbNewLine & FobTxtAll()
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                    ...
                                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
                                        str_gross = GrossTxtDetail(ValueType.GW) '& vbNewLine & FobTxtAll()
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                                str_GrossF = str_gross & vbNewLine & str_USDInvoice
                                            Case Else
                                    ...
                                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "OTHER QUANTITY" Then
                                        str_gross = GrossTxtDetail(ValueType.QTY) '& vbNewLine & FobTxtAll()
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                                str_GrossF = str_gross & vbNewLine & str_USDInvoice
                                            Case Else
                                ...
                                ElseIf Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "NoDisplay" Then
                                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                                        str_gross = GrossTxtDetail(ValueType.GW) & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) 'Mid(Tnet, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10)
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                    ...
                                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
                                        str_gross = GrossTxtDetail(ValueType.GW)
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                                str_GrossF = str_gross
                                            Case Else
                                        ...
                                        End Select
                                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "OTHER QUANTITY" Then
                                        str_gross = GrossTxtDetail(ValueType.QTY)
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                                str_GrossF = str_gross
                                            Case Else
                    ...
                    Case "GWDetail" 'แยกรายการ ไม่ใช่ invoice ต่างประเทศ
                        Select Case Check4_6In_report(Mid(CommonUtility.Get_StringValue(txtletter.Value), 1, 50), CommonUtility.Get_StringValue(txtbox8.Value))
                            Case "3" 'แสดงมูลค่า Detail ไม่ใช่ invoice ต่างประเทศ
                                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                                        str_gross = GrossTxtDetail(ValueType.GW) & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) & vbNewLine & FobTxtAllSumNew() 'Mid(Tnet, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10) '& vbNewLine & FobTxtAll()
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                                str_GrossF = str_gross
                                            Case Else
                                        ...
                                        End Select
                                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
                                        str_gross = GrossTxtDetail(ValueType.GW) & vbNewLine & FobTxtAllSumNew()
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                                str_GrossF = str_gross
                                            Case Else
                                    ...
                                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "NET WEIGHT" Then
                                        ...
                                        End Select
                                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "OTHER QUANTITY" Then
                                        str_gross = GrossTxtDetail(ValueType.QTY) & vbNewLine & FobTxtAllSumNew()
                                        Select Case C_TotalRowDe.Text
                                            Case 1
                                                str_GrossF = str_gross
                                            Case Else
                                            ...
                                            Case Else
                                                If Cpage = CountAllDetail Then 'check เงื่อนไขรายการสุดท้าย
                                                    Select Case Check_CaseRVCCount
                                                        Case 9 'มีอย่างอื่นปน ไม่แสดงมูลค่ารวม
                                                            str_GrossF = str_gross & vbNewLine & str_USDInvoice & vbNewLine &
                                                                       "_______" & vbNewLine & AddGW_NWLine(2, Format(TGross, "#,##0.00##")) & " " & TempUnit3
    ...
    Function AddGW_NWLine(ByVal By_CaseGW_NW As Integer, ByVal by_Valuetxt As String) As String
        ...
        Select Case By_CaseGW_NW
            Case 0 'GROSS WEIGHT
                Line_temp = by_Valuetxt
            Case 1 'NET WEIGHT
                Line_temp = "N.W. " & by_Valuetxt
            Case Else '""
                Line_temp = by_Valuetxt
        End Select
    ...
    Function GrossTxt(value_type As ValueType) As String
        ...
        Select Case value_type
            Case ValueType.GW
                Str_GrossTxt = Format(Dec_Gross, "#,##0.00##") & " " & CheckUnitDetail(txtinvh_run_auto.Value) 'DataUtil.ConvertToString(txtunit_code3.Value)
            Case ValueType.NW
                Str_GrossTxt = "N.W. " & Format(Dec_Gross, "#,##0.00##") & " " & CheckUnitDetail(txtinvh_run_auto.Value) 'DataUtil.ConvertToString(txtunit_code3.Value)
            Case ValueType.QTY
                Str_GrossTxt = Format(Dec_Gross, "#,##0.00##") & " " & CheckUnitDetail(txtinvh_run_auto.Value) 'DataUtil.ConvertToString(txtunit_code3.Value)
        End Select
        Return Str_GrossTxt
    End Function
    'by rut rvc new
    Function GrossTxtDetail(value_type As ValueType) As String
        Dim Str_GrossTxt As String
        Dim Dec_Gross As Decimal
        ...
        Select Case value_type
            ...
            Case ValueType.QTY
                Str_GrossTxt = Format(Dec_Gross, "#,##0.00##") & " " & CheckUnitDetail(txtinvh_run_auto.Value) 'DataUtil.ConvertToString(txtunit_code3.Value)
        End Select
        'Str_GrossTxt = "G.W." & vbNewLine & Format(Dec_Gross, "#,##0.00##") & " " & CheckUnitDetail(txtinvh_run_auto.Value) 'DataUtil.ConvertToString(txtunit_code3.Value) 'CStr(Dec_Gross) & " " & DataUtil.ConvertToString(txtg_unit_code.Value)
    ...
    Private Sub rpt3_ediFORM4_6_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.33, 0.06, 8.32)
        Me.CurrentPage.DrawLine(0.75, 4.13, 0.75, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.7))
        Me.CurrentPage.DrawLine(1.8, 4.13, 1.8, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.7))
        Me.CurrentPage.DrawLine(5, 4.13, 5, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.7))
        Me.CurrentPage.DrawLine(6, 4.13, 6, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.7))
        Me.CurrentPage.DrawLine(7.1, 4.13, 7.1, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.7))
        Me.CurrentPage.DrawLine(8.19, 4.13, 8.19, 8.14)

        'Me.CurrentPage.DrawLine(0.06, 4.33, 0.06, 8.32)
        'Me.CurrentPage.DrawLine(0.75, 4.13, 0.75, 8.14)
        'Me.CurrentPage.DrawLine(1.8, 4.13, 1.8, 8.14)
        'Me.CurrentPage.DrawLine(5, 4.13, 5, 8.14)
        'Me.CurrentPage.DrawLine(6, 4.13, 6, 8.14)
        'Me.CurrentPage.DrawLine(7.1, 4.13, 7.1, 8.14)
        'Me.CurrentPage.DrawLine(8.19, 4.13, 8.19, 8.14)
    End Sub
