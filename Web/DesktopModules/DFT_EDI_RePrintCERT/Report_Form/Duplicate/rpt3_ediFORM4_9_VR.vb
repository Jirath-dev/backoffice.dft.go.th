...
Public Class rpt3_ediFORM4_9_VR
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_9_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.13, 0.06, 7.47)
        Me.CurrentPage.DrawLine(0.72, 4.13, 0.72, 7.47)
        Me.CurrentPage.DrawLine(1.8, 4.13, 1.8, 7.47)
        Me.CurrentPage.DrawLine(5.2, 4.13, 5.2, 7.47)
        Me.CurrentPage.DrawLine(6.0, 4.13, 6.0, 7.47)
        Me.CurrentPage.DrawLine(7.1, 4.13, 7.1, 7.47)
        Me.CurrentPage.DrawLine(8.19, 4.13, 8.19, 7.47)
    End Sub
