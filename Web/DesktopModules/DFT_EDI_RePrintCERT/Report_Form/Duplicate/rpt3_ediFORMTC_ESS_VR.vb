...
Public Class rpt3_ediFORMTC_ESS_VR
...
#Region "Function CHeck_DisPlay ของเก่า"
    ...
    '            Select Case CheckDetailGross
    '                Case "GWDetail" 'แยกรายการ
    '                    ''ByTine 06-10-2558 ปรับแก้ใหม่ตามFORM D ของพี่รุต
...
#End Region
    ...
    Sub check_show_check()
        ...
        Select Case txtshow_check.Value
            ''ByTine 24-09-2558
            Case "10" 'Third
                Pic_ch2_third.Visible = True
                txtRemarks.Text = txtTemp_Third.Text
            Case "01" 'Exhibition
                Pic_ch3_exhibi.Visible = True
            ...
            Case "00" 'ไม่ใช้ทั้งหมด
                Pic_ch3_exhibi.Visible = False
                Pic_ch2_third.Visible = False
                txtRemarks.Text = ""
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        'txtTolInvoice.Text = check_invoice_more(CommonUtility.Get_StringValue(txt_NewEmail_ch02.Text), CommonUtility.Get_StringValue(txtproduct_model.Text))
        'byrut 14/06/2011 invoice100
        'Select Case Mid(txtshow_check.Text, 2, 1) 'txtshow_check.Text
        '    Case "1", "010"
        '        txtTolInvoice.Text = check_invoice_more(CommonUtility.Get_StringValue(""), CommonUtility.Get_StringValue(txtproduct_model.Text))
        '    Case Else
        '        txtTolInvoice.Text = check_invoice_more(CommonUtility.Get_StringValue(txt_NewEmail_ch02.Text), CommonUtility.Get_StringValue(txtproduct_model.Text))
        'End Select
    ...
    Private Sub rpt3_ediFORM4_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        '''ByTine 08-10-2558 ไม่ได้ใช้ เพราะถ้าเปิดใช้ ค่าตรงช่อง Invoice จะขึ้นมา ทับกันทำให้มองไม่รู้เรื่อง และปิดไว้ก็ไม่มีผลกับระบบ
        'byrut 14/06/2011
