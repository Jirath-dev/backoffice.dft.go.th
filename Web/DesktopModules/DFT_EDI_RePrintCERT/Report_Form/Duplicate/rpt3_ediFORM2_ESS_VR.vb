...
Public Class rpt3_ediFORM2_ESS_VR
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value),
            ...
            Case 9 'T1_third_country
                If C_TotalRowDe.Text = count_data Then
                    ...
                    GroupFooter1.Visible = True
                    txtTotalAll.Visible = True
                    txtTotalAll.Visible = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                    BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " &
                                                                    BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " &
                                                                    txtthird_country.Text & vbCrLf &
                                                                    "       _____________________________"
    ...
    Private Sub rpt3_ediFORM2_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.82, 0.06, 7.62)
        Me.CurrentPage.DrawLine(2, 4.82, 2, 7.62)
        Me.CurrentPage.DrawLine(5.9, 4.82, 5.9, 7.62)
        Me.CurrentPage.DrawLine(6.72, 4.82, 6.72, 7.62)
        Me.CurrentPage.DrawLine(8.19, 4.82, 8.19, 7.62)
    End Sub
