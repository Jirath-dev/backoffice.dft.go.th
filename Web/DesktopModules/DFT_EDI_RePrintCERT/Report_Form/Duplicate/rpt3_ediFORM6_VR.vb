...
Public Class rpt3_ediFORM6_VR
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        txtTemp_unit_desc3.Text = Format(CDec(txtnet_weight.Value), "#,##0.00##") & " " & CommonUtility.Get_StringValue(txtunit_code2.Value) 'CommonUtility.Get_StringValue(txtnet_weight.Text) + " " + CommonUtility.Get_StringValue(txtunit_desc3.Text)
    ...
    Function confor_mat(ByVal d_date As Date) As String
        Dim str_for As String = Format(d_date, "dd/MM/yyyy")
        Return str_for
    End Function
...
#End Region
    ...
    End Sub
    Private Sub rpt3_ediFORM6_VR_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.5, 0.06, 8.08)
        Me.CurrentPage.DrawLine(5.8, 4.5, 5.8, 8.08)
        Me.CurrentPage.DrawLine(7.02, 4.5, 7.02, 8.08)
        Me.CurrentPage.DrawLine(8.189, 4.5, 8.189, 8.08)
    End Sub
    Private Sub rpt3_ediFORM6_VR_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        UpdateTotalPDFPage(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count))
    End Sub

    Private Sub rpt3_ediFORM6_VR_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        Me.ReportInfo1.FormatString = "Page : {PageNumber} of {PageCount}"
    End Sub

    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        txtBathNet.Text = BahtOnly(TNet, txtunit_code2.Text) '& " NET ONLY***"
    End Sub
End Class
