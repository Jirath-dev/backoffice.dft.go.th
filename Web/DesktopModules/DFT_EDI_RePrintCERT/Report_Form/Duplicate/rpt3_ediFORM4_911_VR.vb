...
Public Class rpt3_ediFORM4_911_VR
    ...
    Private Sub rpt3_ediFORM4_91_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.33, 0.06, 7.3)
        Me.CurrentPage.DrawLine(0.8, 4.33, 0.8, 7.3)
        Me.CurrentPage.DrawLine(1.8, 4.33, 1.8, 7.3)
        Me.CurrentPage.DrawLine(5.2, 4.33, 5.2, 7.3)
        Me.CurrentPage.DrawLine(6, 4.33, 6, 7.3)
        Me.CurrentPage.DrawLine(7.1, 4.33, 7.1, 7.3)
        Me.CurrentPage.DrawLine(8.19, 4.33, 8.19, 7.3)
    End Sub
            ...
            Case 1
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                ...
                                                                BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & IIf(CheckIsZeroOrNothing(txtthird_country.Text) = True, txtthird_country.Text & vbCrLf, "") &
            ...
            Case 7 'T1_third_country,T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And CommonUtility.Get_StringValue(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        ...
                        GroupFooter1.Visible = True
                        txtTotalAll.Visible = True
                        txtTotalAll.Text = "TOTAL: " & IIf(CheckIsZeroOrNothing(txtquantity1.Text) = True, BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        ", vbCrLf & "        ") &
                                            IIf(CheckIsZeroOrNothing(txtthird_country.Text) = True, txtthird_country.Text & vbCrLf, "") &
                                            IIf(CheckIsZeroOrNothing(txtback_country.Text) = True, txtback_country.Text & vbCrLf, "") &
                                                                                       "       _____________________________"
                    Else
