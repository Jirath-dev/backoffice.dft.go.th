...
Public Class rpt3_ediFORM4_5_VR
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_5_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.33, 0.06, 7.82)
        Me.CurrentPage.DrawLine(1, 4.33, 1, 7.82)
        Me.CurrentPage.DrawLine(2.1, 4.33, 2.1, 7.82)
        Me.CurrentPage.DrawLine(5.4, 4.33, 5.4, 7.82)
        Me.CurrentPage.DrawLine(6.2, 4.33, 6.2, 7.82)
        Me.CurrentPage.DrawLine(7.1, 4.33, 7.1, 7.82)
        Me.CurrentPage.DrawLine(8.19, 4.33, 8.19, 7.82)
    End Sub
