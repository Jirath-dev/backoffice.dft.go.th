...
Public Class rpt3_ediFORM2_4
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        Select Case txtSendCheckSeletedate.Text
            Case True 'ใช้วันที่เลือกเอง
                txtTemp_ProvinceName.Text = Province_Name(CommonUtility.Get_StringValue(txtsite_id.Text)) & " " & txtdateSelectRPT.Text
            Case False 'ใช้ วันอนุมัติ
                txtTemp_ProvinceName.Text = Province_Name(CommonUtility.Get_StringValue(txtsite_id.Text)) & " " & CommonUtility.Get_DateTime(txtapprove_date.Text).ToString("dd/MM/yyyy") 'format_dateSelect()
        End Select
    End Sub
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        ' Check_box8()
        If Cpage = 1 Then
            str_alltotal = Format((txtTotal_real_TonNet.Value * 1000), "#,##0.00##") & " KGM" & _
                                                   " (N.W.)" & vbNewLine & _
                                                   Format(txtTotal_real_TonNet.Value, "#,##0.00##") & " " & CommonUtility.Get_StringValue(txtunit_code2.Text) _
                                                   & " (N.W.)"
    ...
    Function NW_call(ByVal _GW As Object) As String
        Dim str_ As String

        str_ = "TOTAL: " & BahtOnly(_GW.ToString, "TON") & vbNewLine
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 1
                ...
                If C_TotalRowDe.Text = count_data Then
                    txtT_product.Text = All_str & NW_call(txtReserve1.Text) & _
    ...
    Private Sub rpt3_ediFORM2_2_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 6.25
        Dim ym As Single = 5
        'Dim width As Single = 6.0F
        Dim widthm As Single = 1.67
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 0.98
        Dim y_txtmarks As Single = 5
        'Dim width As Single = 6.0F
        Dim width_txtmarks As Single = 0.89
    ...
    Private Sub rpt3_ediFORM2_2_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        End If
    End Sub

    Private Sub rpt3_ediFORM2_2_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
