...
#Region "   Code Main Print   "
    ''--------------------------------------------------------------------------------------------------
    'เพิ่มเงื่อนไข กรณี พิมพ์ปีเก่า
    Public Shared Function printMultireport(ByVal sendFormType As String, ByVal Cells As String, ByVal SiteID As String, ByVal sendRadio_Form As String, ByVal sendUser As String, ByVal sendRequest_print As String, ByVal PrintFlag As String,
     ByVal sendFirstpage As String, ByVal sendLastpage As String, ByVal NamePrint_A As String, ByVal NamePrint_D As String, ByVal strDate As String, ByVal _SendCHDATE As Boolean, ByVal By_CheckCaseOle As Boolean, ByVal By_IDYear As String, ByVal _ChkTrueCopy As Boolean) As Integer
        ...
        '============== Part Report ==============
        Select Case By_CheckCaseOle
            Case True
                Select Case By_IDYear
                    Case "1" 'ปี 2007-2008
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_Ole01",
                                                                New SqlParameter("@INVH_RUN_AUTO", Cells),
                                                                New SqlParameter("@SITE_ID", SiteID))
                    Case "2" 'ปี 2009-2010
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_Ole02",
                                                                New SqlParameter("@INVH_RUN_AUTO", Cells),
                                                                New SqlParameter("@SITE_ID", SiteID))
                    Case "3" 'ปี 2011-2012
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_Ole03",
                                                                New SqlParameter("@INVH_RUN_AUTO", Cells),
                                                                New SqlParameter("@SITE_ID", SiteID))
                End Select
            Case False
                Select Case sendFormType
                    Case "FORM44_01", "FORM44_02", "FORMD_ESS", "FORMD_ESS_", "FORMD_ESS_ATTS", "FORMAHK", "FORME_01", "FORME_ESS"
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_RePrint_ASW",
                                        New SqlParameter("@INVH_RUN_AUTO", Cells),
                                        New SqlParameter("@SITE_ID", SiteID))
                        'Case "FORM4_9"
                        '    dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_RePrint_test",
                        '                    New SqlParameter("@INVH_RUN_AUTO", Cells),
                        '                    New SqlParameter("@SITE_ID", SiteID))
                    Case Else
                        dsRequestDetails = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form4_edi_printFormBar_NewDS_RePrint_test",
        ...
        '                New SqlParameter("@SITE_ID", SiteID))
        checkUpdate_user(CommonUtility.Get_StringValue(Cells), CommonUtility.Get_StringValue(sendUser), sendRadio_Form, By_CheckCaseOle, By_IDYear)
        ...
        If dsRequestDetails.Tables(0).Rows.Count > 0 Then
            ...
            Dim IsNewFormE As Boolean = CommonUtility.Get_Boolean(dsRequestDetails.Tables(0).Rows(0).Item("NewE"))
            ...
            Try
                ...
                If sendRadio_Form = "0" Then
                    ...
                    Select Case sendFormType
                        ...
                        Case "FORM44_01", "FORM44_02", "FORMD_ESS", "FORMD_ESS_", "FORMD_ESS_ATTS", "FORMAHK"
                            '===================================
                            Dim rpt = New rpt3_ReEdi_A
                            rpt.Document.Printer.PrinterName = PrintReceipt(sendFormType, SiteID, sendRequest_print, sendUser) 'ConfigurationManager.AppSettings("printNameCall").ToString()
                        ...
                        Case "FORM4_91", "FORM4_911"
                            ...
                            ''ByTine 15-10-2558 เพิ่มเติมฟอร์มไทย-ชิลี FORM5_2
                        Case "FORM5", "FORM5_1", "FORMTP_ESS", "FORM5_2", "FORMTC_ESS"
                ...
                Else
                    ...
                    Select Case sendFormType
                        ...
                        Case "FORM2_4" 'ฟอร์มใหม่
                            ...
                            ''ByTine 11-12-2559 ฟอร์มใหม่ COปลา / COข้าว
                        Case "FORM2_5"
                            'view
                        ...
                        Case "FORM4"
                            ...
                            'FORM44_41	ฟอร์ม ดี AICO ใหม่ (7 ประเทศ)
                            'FORM441_4	ฟอร์ม ดี AICO Attach Sheet รถยนต์ ใหม่ (7 ประเทศ)
                        Case "FORM44_4", "FORM44_44", "FORM44_41", "FORM441_4", "FORM44_01", "FORM44_02", "FORMD_ESS", "FORMD_ESS_", "FORMD_ESS_ATTS"
                            'view
                            Dim rpt As Object
                            Select Case sendFormType
                                Case "FORM44_4"
                                    ...
                                    If Cells = "20160801-002330" Then
                                        rpt = New rpt3_ediFORM44_400_pr
                                    End If
                                    'FORM44_400
                                Case "FORM44_44"
                        ...
                        Case "FORM4_2"
                            ...
                            Select Case SiteID
                                'Case "ST-003"
                                '    rpt = New rpt3_ediFORM4_2_pr_ST003
                                'Case "ST-001"
                            ...
                            If IsNewFormE = False Then
                                rpt = New rpt3_ediFORM4_2_pr_Old
                            End If
                        ...
                        Case "FORME_01"
                            ...
                            rpt = New rpt3_ediFORME_01_Reprint
                            '//2019-11-27
                        ...
                        Case "FORM4_9"
                            'view
                            Dim rpt = New rpt3_ediFORM4_9v1r
                            rpt.Document.Printer.PrinterName = PrintComplete(sendFormType, SiteID, sendUser, NamePrint_A, NamePrint_D) 'ConfigurationManager.AppSettings("printNameCall").ToString()
                        ...
                        Case "FORM4_91"
                            ...
                            End If
                                ...
                                ''ByTine 23-03-2559 ฟอร์ม AANZ ใหม่
                        Case "FORM4_911"
                            'view
                        ...
                        Case "FORMAHK"
                            'view
                            Dim rpt As New rpt3_ediFORMAHK_reprint
    ...
    Public Shared Function Call_SiteReceiptTest_ST_001_01(ByVal Form_ID As String) As String
        ...
        Select Case Form_ID
            ...
            Case "FORM3_1"
                ...
                'FORM44_41	ฟอร์ม ดี AICO ใหม่ (7 ประเทศ)
                'FORM441_4	ฟอร์ม ดี AICO Attach Sheet รถยนต์ ใหม่ (7 ประเทศ)
            Case "FORM44_4", "FORM44_44", "FORM44_41", "FORM441_4", "FORM44_01", "FORM44_02", "FORMD_ESS", "FORMD_ESS_", "FORMD_ESS_ATTS", "FORMAHK"
    ...
    Public Shared Function Call_SitePrintsDS_ST_003_V03(ByVal Form_ID As String) As String
        ...
        Select Case Form_ID
            ...
            Case "FORM1_4"
                SendPrinterName = ConfigurationManager.AppSettings("ST_003Edi_FORM1_4").ToString()
                Return SendPrinterName
            Case "FORM2", "FORM2_ESS", "FORM2_ESS"
                SendPrinterName = ConfigurationManager.AppSettings("ST_003Edi_FORM2").ToString()
                Return SendPrinterName
            Case "FORM2_1"
                SendPrinterName = ConfigurationManager.AppSettings("ST_003Edi_FORM2_1").ToString()
    ...
    Public Shared Function Call_SitePrints_CM_001(ByVal Form_ID As String) As String
        ...
        Select Case Form_ID
            ...
            Case "FORM3_1"
                ...
                'FORM44_41	ฟอร์ม ดี AICO ใหม่ (7 ประเทศ)
                'FORM441_4	ฟอร์ม ดี AICO Attach Sheet รถยนต์ ใหม่ (7 ประเทศ)
            Case "FORM44_4", "FORM44_44", "FORM44_41", "FORM441_4", "FORM44_01", "FORM44_02", "FORMD_ESS", "FORMD_ESS_", "FORMD_ESS_ATTS", "FOMRD_ESS", "FORMD_ESS_"
    ...
    Public Shared Function Call_SiteReceipt_CM_001_01(ByVal Form_ID As String) As String
        ...
        Select Case Form_ID
            ...
            Case "FORM3_1"
                ...
                'FORM44_41	ฟอร์ม ดี AICO ใหม่ (7 ประเทศ)
                'FORM441_4	ฟอร์ม ดี AICO Attach Sheet รถยนต์ ใหม่ (7 ประเทศ)
            Case "FORM44_4", "FORM44_44", "FORM44_41", "FORM441_4", "FORM44_01", "FORM44_02", "FORMD_ESS", "FORMD_ESS_", "FORMD_ESS_ATTS", "FORMAHK", "FORMD_ESS", "FORMD_ESS_"
...
#Region "B2B"
    ...
    '            'Loop
    '            ' ''===============================================================
    '            'rptTemp.Document.Printer.PrinterName = PrinterName
    '            'rptTemp.Run()
