<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_Report_Receipt_ByPro.EditDFT_Report_Receipt_ByPro" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_Report_Receipt_ByPro.ascx.vb" %>
