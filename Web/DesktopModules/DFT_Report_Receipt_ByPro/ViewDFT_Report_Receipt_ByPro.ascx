<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_Report_Receipt_ByPro.ViewDFT_Report_Receipt_ByPro" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_Report_Receipt_ByPro.ascx.vb" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="rblSystem">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rblSystem" />
        ...
        <telerik:AjaxSetting AjaxControlID="ddlSiteID">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rblSystem" />
                <telerik:AjaxUpdatedControl ControlID="CheckAllSite" />
                <telerik:AjaxUpdatedControl ControlID="ddlSiteID" />
        ...
        <telerik:AjaxSetting AjaxControlID="rblReceiptType">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rblSystem" />
                <telerik:AjaxUpdatedControl ControlID="CheckAllSite" />
                <telerik:AjaxUpdatedControl ControlID="ddlSiteID" />
        ...
        <telerik:AjaxSetting AjaxControlID="btnSearch">
            <UpdatedControls>
                ...
                <telerik:AjaxUpdatedControl ControlID="rgEDI" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
                                                ...
                                                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" align="left" style="height: 30px">
                                                           <asp:RadioButtonList ID="rblReceiptType" runat="server" AutoPostBack="True" RepeatDirection="Horizontal">
                                                                <asp:ListItem Text="ทุกแบบ" Value="0" Selected="True"></asp:ListItem>
                                                                <asp:ListItem Text="ใบเสร็จเขียว" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="ใบเสร็จเหลือง" Value="2"></asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="left" style="height: 40px;" valign="middle">
                                                            <table width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td valign="top" align="left" style="height: 30px; width: 67%;">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                        ...
                                        <MasterTableView NoMasterRecordsText="ไม่พบข้อมูล" AutoGenerateColumns="False"
                                            ...
                                            <GroupByExpressions>
                                                <telerik:GridGroupByExpression>
                                                    <SelectFields>
                                                        <telerik:GridGroupByField FieldName="Bill_Type" HeaderText="ประเภทใบเสร็จ" FieldAlias="Bill_Type"
                                                            FormatString="" />
                                                    </SelectFields>
                                                    <GroupByFields>
                                                        <telerik:GridGroupByField FieldName="Bill_Type" FieldAlias="Bill_Type" FormatString=""
                                                            HeaderText="" />
                                                    </GroupByFields>
                                                </telerik:GridGroupByExpression>
                                            </GroupByExpressions>
                                            <Columns>
                                                ...
                                                <telerik:GridNumericColumn DataField="FORM_COUNT" Aggregate="Sum" ReadOnly="True"
                                                    FooterText="รวม : " HeaderText="จำนวนฉบับ" SortExpression="FORM_COUNT"
                                                    GroupByExpression="site_name" UniqueName="FORM_COUNT"  DataFormatString="{0:#,###}">
