...
Partial Public Class frmEditCompanyCardDetail
    ...
    Protected Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            'ds = SqlHelper.ExecuteDataset(strConn, CommandType.StoredProcedure, "pl_EditCard", _
            ...
            New SqlParameter("@card_level", CommonUtility.Get_StringValue("กรรมการผู้จัดการ")), _
