<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmEditCompanyCardDetail.aspx.vb" Inherits=".frmEditCompanyCardDetail" %>
                ...
                <td style="width: 100%">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:CheckBoxList ID="chkCard_level" runat="server" Font-Names="Tahoma" Font-Size="10pt">
                                    <asp:ListItem Selected="True" Value="กรรมการผู้จัดการ">กรรมการผู้จัดการ</asp:ListItem>
                                </asp:CheckBoxList></td>
                        </tr>
                    </table>
                    </asp:Panel>
