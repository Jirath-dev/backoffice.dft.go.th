<%@ Control language="vb" Inherits="NTi.Modules.DFT_RFCard_PreCheck.EditDFT_RFCard_PreCheck" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_RFCard_PreCheck.ascx.vb" %>
