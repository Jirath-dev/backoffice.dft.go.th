<%@ Control Language="vb" Inherits="NTi.Modules.DFT_EDI_AttachDoc_V2_1.ViewDFT_EDI_AttachDoc_V2_1"
    AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_AttachDoc_V2_1.ascx.vb" %>
                                                                        ...
                                                                        <tr>
                                                                            <td class="m-frm" valign="top" width="100%">
                                                                                <telerik:RadTabStrip ID="RadTabStrip2" runat="server" Font-Names="Tahoma" Font-Size="10pt"
                                                                                    ...
                                                                                    <Tabs>
                                                                                        <telerik:RadTab runat="server" Font-Names="Tahoma" Font-Size="10pt" Text="รายการคำร้องไม่เกินกำหนดการแนบเอกสาร 10 วัน">
                                                                                        </telerik:RadTab>
                                                                                    </Tabs>
                                                                                </telerik:RadTabStrip>
                                                                            </td>
                                                                            ...
                                                                            <td class="m-frm" valign="top" width="100%">
                                                                                <telerik:RadMultiPage ID="RadMultiPage2" runat="server" SelectedIndex="0" TabIndex="-1"
                                                                                    ...
                                                                                    <telerik:RadPageView ID="RadPageView3" runat="server" Width="100%">
                                                                                        <telerik:RadGrid ID="rgAttachDocList2" runat="server" AllowSorting="True" GridLines="None"
                                                                                            ...
                                                                                            <MasterTableView AutoGenerateColumns="False" NoMasterRecordsText="ไม่มีรายการเอกสารแนบตามเงื่อนไขที่ทำการค้นหา"
                                                                                                ...
                                                                                                <GroupByExpressions>
                                                                                                    <telerik:GridGroupByExpression>
                                                                                                        <SelectFields>
                                                                                                            <telerik:GridGroupByField FieldAlias="form_name" FieldName="form_name" HeaderText=" " />
                                                                                                        </SelectFields>
                                                                                                        <GroupByFields>
                                                                                                            <telerik:GridGroupByField FieldAlias="form_name" FieldName="form_name" SortOrder="None"
                                                                                                                HeaderText="" />
                                                                                                        </GroupByFields>
                                                                                                    </telerik:GridGroupByExpression>
                                                                                                </GroupByExpressions>
