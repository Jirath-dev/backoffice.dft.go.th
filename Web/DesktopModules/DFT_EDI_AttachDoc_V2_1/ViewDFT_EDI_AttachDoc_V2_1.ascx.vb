...
Namespace NTi.Modules.DFT_EDI_AttachDoc_V2_1
    Partial Class ViewDFT_EDI_AttachDoc_V2_1
        ...
        Protected Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
            Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    rgAttachDocList2.DataSource = LoadReferenceNoAttach2()
                    rgAttachDocList2.DataBind()
                End If
        ...
        Function LoadReferenceNoAttach2() As DataTable
            Try
                Dim ds As New DataSet
                ds = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_select_RepAtt1_NewDS", _
                New SqlParameter("@TCat1", 2), _
                New SqlParameter("@TCat2", 2), _
                New SqlParameter("@dForm", ""), _
                New SqlParameter("@dTo", ""), _
                New SqlParameter("@total_day", 10), _
                New SqlParameter("@company_taxno", CommonUtility.Get_StringValue(txtCompany_Taxno.Text)), _
        ...
        Private Sub rgAttachDocList2_ItemCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles rgAttachDocList2.ItemCommand
        ...
        Private Sub rgAttachDocList2_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles rgAttachDocList2.ItemDataBound
        ...
        Private Sub rgAttachDocList2_PageIndexChanged(ByVal source As Object, ByVal e As Telerik.Web.UI.GridPageChangedEventArgs) Handles rgAttachDocList2.PageIndexChanged
            rgAttachDocList2.CurrentPageIndex = e.NewPageIndex
            rgAttachDocList2.DataSource = LoadReferenceNoAttach2()
            rgAttachDocList2.DataBind()
        End Sub
    End Class
