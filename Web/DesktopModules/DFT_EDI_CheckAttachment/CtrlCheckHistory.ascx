...
<telerik:RadCodeBlock ID="RadCodeBlockFirst" runat="server">
    ...
    function ShowCommentForm() {
        var url = "/DesktopModules/DFT_EDI_CheckAttachment/frmCheckSummary.aspx";
        //var form_type = "";
        //var from_date = "";
        //var to_date = ""
        //var site_id = "";
        //url = url + "&formtype=" + "&fromdate=" + "&todate=" + "&siteid=";
        window.radopen(url, "SummaryDialog");
        return false;
    }
...
<telerik:RadWindowManager ID="RadWindowManager1" Behavior="Close" runat="server"
    ...
    <Windows>
        <telerik:RadWindow ID="SummaryDialog" runat="server" Title="สรุปจำนวนคำขอฟอร์มแยกตามประเภทของฟอร์ม" Behaviors="Close"
                                ...
                                <td class="m-frm" valign="top" width="100%">
                                    <div style="margin: 10px;">
                                        <div style="font-size: 10pt; margin-top: 10px; margin-bottom: 10px;">
                                            แสดงผลรายการแบบฟอร์มคำร้อง และเอกสารแนบที่ตรวจสอบเรียบร้อยแล้ว
                                        </div>
                                        <div style="font-size: 10pt; margin: 5px;">
                                            <span runat="server" id="colIcon" style="color: #999999; font-size: 10px;" onclick="collapsSearch('collapsdiv');"
                                                onmouseover="this.style.cursor='pointer';">(+)</span> <a href="#" onclick="collapsSearch('collapsdiv');">ค้นหาขั้นสูง</a> &nbsp;<span class="FormLabel">(ค้นหาจากเลขที่อ้างอิง หรือเลขที่ Invoice)</span>
                                        </div>
                                        <div id="collaps_div_main" runat="server" style="margin-bottom: 6px; font-size: 9pt; padding-bottom: 1px; border-top: 1px solid #cccccc;">
                                            <div id="collapsdiv" runat="server" style="padding: 6px 6px 1px 6px; margin-bottom: 2px; display: none">
                                                ...
                                                <dl style="padding-top: 2px; margin-top: 0px; margin-bottom: 2px;">
                                                    ...
                                                    <dd>- <font style="color: Red; font-size: 11px; font-weight: normal;">การค้นหาตามเลขที่อ้างอิง
                                                            หรือเลขที่ Invoice ไม่จำเป็นต้องต้องระบุวันที่</font></dd>
                                                    <dd>- <font style="color: Red; font-size: 11px; font-weight: normal;">หากต้องการค้นหาตามวันที่
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="2" width="100%">
                                                        <tr>
                                                            <td>
                                                                <div style="margin-bottom: 10px; font-size: 10pt;display:none;">
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                ...
                                                                <telerik:RadGrid ID="rgRequestForm" runat="server" AllowPaging="True" GridLines="None"
                                                                    ...
                                                                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="invh_run_auto,form_type,SentBy,edi_status_id,company_taxno,SealSign,SignImageID"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <telerik:GridBoundColumn DataField="CheckDoc_Date" HeaderText="วันที่ตรวจสอบ" DataFormatString="{0:dd/MM/yyyy HH:mm}"
                                                                            ...
                                                                            <telerik:GridBoundColumn DataField="PrintFormDate" HeaderText="วันที่พิมพ์ฟอร์ม"
                                                                                DataFormatString="{0:dd/MM/yyyy HH:mm}" ReadOnly="True" SortExpression="PrintFormDate"
                                                                ...
                                                                <label style="cursor:pointer; font-size:medium;" onclick="ShowCommentForm();">(คลิก) สรุปจำนวนคำขอฟอร์มแยกตามประเภทของฟอร์ม </label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
