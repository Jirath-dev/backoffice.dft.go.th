...
"<tr><td rowspan=""2"" class=""header"">Item No.</td><td rowspan=""2"" class=""header"" style=""width:100px;"">Marks and numbers of packages</td><td rowspan=""2""class=""header"">Number and kind of packages; description of goods</td><td rowspan=""2"" class=""header"">Net weight</td><td rowspan=""2"" class=""header"">Gross weight</td><td rowspan=""2"" class=""header"">Amount FOB(USD)</td><td colspan=""" & num_quantity & """ class=""header"" style=""text-align:center"">Quantity</td></tr>"
        ...
        Try
            ...
            If ds.Tables.Count > 0 Then
                ...
                For Each row In ds.Tables(0).Rows
                    ...
                    If Q1 > 0 Then
                        str_product &= "<td>" & FormatNumber(row("quantity1"), 2) & "</td>"
                    End If

                    If Q2 > 0 Then
                        str_product &= "<td>" & FormatNumber(row("quantity2"), 2) & "</td>"
                    End If

                    If Q3 > 0 Then
                        str_product &= "<td>" & FormatNumber(row("quantity3"), 2) & "</td>"
                    End If

                    If Q4 > 0 Then
                        str_product &= "<td>" & FormatNumber(row("quantity4"), 2) & "</td>"
                    End If

                    If Q5 > 0 Then
                        str_product &= "<td>" & FormatNumber(row("quantity5"), 2) & "</td>"
                    End If
                ...
                If Q1 > 0 Then
                    str_product &= "<td style=""background:#efefef;""><b>" & FormatNumber(totalQuantity1, 2) & "</b> " & Quantity1Unit & "</td>"
                End If

                If Q2 > 0 Then
                    str_product &= "<td style=""background:#efefef;""><b>" & FormatNumber(totalQuantity2, 2) & "</b> " & Quantity2Unit & "</td>"
                End If

                If Q3 > 0 Then
                    str_product &= "<td style=""background:#efefef;""><b>" & FormatNumber(totalQuantity3, 2) & "</b> " & Quantity3Unit & "</td>"
                End If

                If Q4 > 0 Then
                    str_product &= "<td style=""background:#efefef;""><b>" & FormatNumber(totalQuantity4, 2) & "</b> " & Quantity4Unit & "</td>"
                End If

                If Q5 > 0 Then
                    str_product &= "<td style=""background:#efefef;""><b>" & FormatNumber(totalQuantity5, 2) & "</b> " & Quantity5Unit & "</td>"
                End If
    ...
    Function formatNotChangedigit(Value As String, digit As Integer) As String
        Dim Arr As Array = Value.Split(".")
        Return Arr(0) & "." & Microsoft.VisualBasic.Left(Arr(1), digit)
    End Function
    ...
    Protected Sub dlInvoice_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles dlInvoice.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or _
            ...
            lblSumQuantity1.Text = FormatNumber(CDec(lblSumQuantity1.Text) + CDec(lblQuantity1.Text), 2)
            ...
            lblSumQuantity2.Text = FormatNumber(CDec(lblSumQuantity2.Text) + CDec(lblQuantity2.Text), 2)
            ...
            lblSumQuantity3.Text = FormatNumber(CDec(lblSumQuantity3.Text) + CDec(lblQuantity3.Text), 2)
            ...
            lblSumQuantity4.Text = FormatNumber(CDec(lblSumQuantity4.Text) + CDec(lblQuantity4.Text), 2)
            ...
            lblSumQuantity5.Text = FormatNumber(CDec(lblSumQuantity5.Text) + CDec(lblQuantity5.Text), 2)
