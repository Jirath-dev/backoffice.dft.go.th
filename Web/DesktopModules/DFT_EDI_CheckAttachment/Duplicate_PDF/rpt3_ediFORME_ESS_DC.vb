...
Public Class rpt3_ediFORME_ESS_DC
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_2_pr_New_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Dim detail_line_end As Double = 8.1
    ...
    Private Sub rpt3_ediFORME_ESS_ReportEnd(sender As Object, e As EventArgs) Handles Me.ReportEnd
