...
Public Class rpt3_ediFORM4_9_DC
    ...
    Private Sub PageHeader1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageHeader1.Format
        ...
        Check_Issued()
    End Sub
    '   'เงื่อนไขเช็ค IsIssuedRetro (form_header_edi)
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_9_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.13, 0.06, 8.17)
        Me.CurrentPage.DrawLine(0.72, 4.13, 0.72, 8.17)
        Me.CurrentPage.DrawLine(1.8, 4.13, 1.8, 8.17)
        Me.CurrentPage.DrawLine(5.2, 4.13, 5.2, 8.17)
        Me.CurrentPage.DrawLine(6.0, 4.13, 6.0, 8.17)
        Me.CurrentPage.DrawLine(7.0, 4.13, 7.0, 8.17)
        Me.CurrentPage.DrawLine(8.19, 4.13, 8.19, 8.17)
    End Sub
