...
Partial Public Class CtrlHistoryByUser
...
#End Region
    Protected Sub CheckSummary()
        ...
        Try
            ...
            ds = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form_edi_getForCheckAtt_Summary_ByUser",
    ...
    Function LoadRequestFormList() As DataTable
        Try
            ...
            Else
                prm(6).Value = "0"
            End If
            prm(7) = New SqlClient.SqlParameter("@username", UserInfo.Username)

            ds = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "vi_form_edi_getForCheckAtt_History_ByUser", prm)
            Return ds.Tables(0)
        Catch ex As Exception
            Response.Write(ex.Message)
            'Return Nothing
    ...
    Private Sub rgRequestForm_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles rgRequestForm.ItemDataBound
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type").ToString().ToUpper() = "FORM44" _
                ...
                Or e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type").ToString().ToUpper() = "FORM44_44" Then
