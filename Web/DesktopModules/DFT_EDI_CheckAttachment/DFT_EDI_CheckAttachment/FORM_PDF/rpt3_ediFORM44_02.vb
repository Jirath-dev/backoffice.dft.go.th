...
Public Class rpt3_ediFORM44_02
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        'Dim strcommand As String = " SELECT reference_code2, printFormDate FROM form_header_edi WHERE (invh_run_auto = @invh_run_auto)"
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                    ...
                                                                    BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " &
                                                                    BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " &
                                                                    BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, ""), txtinvh_run_auto.Value) & "        " & vbNewLine &
                                                                    _TempB2B & vbNewLine &
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                    "       _____________________________"
                Else
    ...
    Function GrossTxtDetail() As String
        ...
        Str_GrossTxt = W_type & Format(Dec_Gross, "#,##0.00##") & " " & CheckUnitDetail(txtinvh_run_auto.Value) 'CommonUtility.Get_StringValue(txtunit_code3.Value) 'CStr(Dec_Gross) & " " & CommonUtility.Get_StringValue(txtg_unit_code.Value)
    ...
    Private Sub rpt3_ediFORM4_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        Dim y As Single = CSng(head_height + 0.3) '4.63 '4.606
        'Dim width As Single = 6.0F
        Dim width As Single = 0.94
        Dim height As Single = 3.2
        ...
        '==========================
        Dim xm As Single = 0.98
        Dim ym As Single = CSng(head_height + 0.3) '4.63
        'Dim width As Single = 6.0F
        Dim widthm As Single = 0.94
        Dim heightm As Single = 3.2
        ...
        Select Case CommonUtility.Get_StringValue(txtCheckGrossDetail.Text)
            Case Is <> "GWDetail"
                ...
                Dim height_GrossDetail As Single = 3.2
    ...
    Private Sub rpt3_ediFORM4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(0.5, 3.92, 0.5, 7.98) '7.74
        Me.CurrentPage.DrawLine(0.94, 3.93, 0.94, 7.98)
        Me.CurrentPage.DrawLine(1.94, 3.93, 1.94, 7.98)
        Me.CurrentPage.DrawLine(5.375, 3.93, 5.375, 7.98)
        Me.CurrentPage.DrawLine(6, 3.93, 6, 7.98)
        Me.CurrentPage.DrawLine(7, 3.93, 7, 7.98)
        Me.CurrentPage.DrawLine(8, 3.92, 8, 7.98)
