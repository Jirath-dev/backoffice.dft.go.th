...
Public Class rpt3_ediFORM2_2
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        txtTemp_ProvinceName.Text = Province_Name(CommonUtility.Get_StringValue(txtsite_id.Text)) & " " & Now.Day & "/" & Now.Month & "/" & Now.Year
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        str_alltotal = Format(txtTotal_net_weight.Value, "#,##0.00") & " " & CommonUtility.Get_StringValue(txtg_unit_code.Text) _
                                & " (G.W.)" & vbNewLine & CommonUtility.Get_StringValue(txtTotal_real_net_weight.Text) & " " & CommonUtility.Get_StringValue(txtunit_code2.Text) _
                                & " (N.W.)"
        '=================
        Cpage += 1
        ...
        Select Case C_TotalRowDe.Text
            Case 1
                ...
                txtTemp_AllTotal.Text = str_alltotal
            Case Else
                If Cpage > 1 Then
                    str_mark = ""
                    str_alltotal = ""
    ...
    Private Sub rpt3_ediFORM2_2_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.25, 0.06, 8.43)
        Me.CurrentPage.DrawLine(6.3, 4.25, 6.3, 7.09)
