...
#End Region
    ...
    Function CHeck_DisPlayF() As String
        ...
        If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
            ...
            If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                str_gross = GrossTxt() & vbNewLine & NetWeight_(TNet, txtunit_code2.Value) '& vbNewLine & FobTxt()
                str_return = str_gross
            ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
                str_gross = GrossTxt() '& vbNewLine & FobTxt()
                str_return = str_gross
            ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "NET WEIGHT" Then
                str_gross = NetWeight_(TNet, txtunit_code2.Value) '& vbNewLine & FobTxt()
                str_return = str_gross
            ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "" Then
                str_gross = GrossTxt() '& vbNewLine & FobTxt()
                str_return = str_gross
        ...
        ElseIf Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "NoDisplay" Then
            ...
            ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "" Then
                ...
                str_return = str_gross
            End If
        ElseIf Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "" Then 'ระบบเก่า
            str_gross = GrossTxt()
            str_return = str_gross
        End If
    ...
    Private Sub rpt3_ediFORM5_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 6.94
        Dim ym As Single = 4.724
        ...
        End With
        '============================
        Dim x_txtGrossTxt As Single = 6.05
        Dim y_txtGrossTxt As Single = 4.724
        'Dim width As Single = 6.0F
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 0.96
        Dim y_txtmarks As Single = 4.724
        'Dim width As Single = 6.0F
        Dim width_txtmarks As Single = 0.74
    ...
    Private Sub rpt3_ediFORM5_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Dim y1 As Double = 4.06
        Dim y2 As Double = 8.29
        Me.CurrentPage.DrawLine(0.06, y1, 0.06, y2)
        Me.CurrentPage.DrawLine(0.75, y1, 0.75, y2)
        Me.CurrentPage.DrawLine(1.75, y1, 1.75, y2)
        Me.CurrentPage.DrawLine(5.13, y1, 5.13, y2)
        Me.CurrentPage.DrawLine(5.94, y1, 5.94, y2)
        Me.CurrentPage.DrawLine(7.13, y1, 7.13, y2)
        Me.CurrentPage.DrawLine(8.19, y1, 8.19, y2)
    End Sub

    Private Sub rpt3_ediFORM5_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        End If
    End Sub

    Private Sub rpt3_ediFORM5_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
