...
Public Class rpt3_ediFORM4_5_pr
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_5_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        End With
        '============================
        Dim x_txtGrossTxt As Single = 6.25
        ...
        'Dim width As Single = 6.0F
        Dim width_txtmarks As Single = 0.88
    ...
    Private Sub rpt3_ediFORM4_5_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.33, 0.06, 8.32)
        Me.CurrentPage.DrawLine(1, 4.33, 1, 8.32)
        Me.CurrentPage.DrawLine(2.1, 4.33, 2.1, 8.32)
        Me.CurrentPage.DrawLine(5.4, 4.33, 5.4, 8.32)
        Me.CurrentPage.DrawLine(6.2, 4.33, 6.2, 8.32)
        Me.CurrentPage.DrawLine(7.1, 4.33, 7.1, 8.32)
        Me.CurrentPage.DrawLine(8.19, 4.33, 8.19, 8.32)
    End Sub
