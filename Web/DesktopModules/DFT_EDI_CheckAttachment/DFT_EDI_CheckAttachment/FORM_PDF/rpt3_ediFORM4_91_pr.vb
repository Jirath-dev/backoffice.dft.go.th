...
Public Class rpt3_ediFORM4_91_pr
    ...
    Private Sub rpt3_ediFORM4_91_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        '' ''Dim y_txtInvoice As Single = 4.875
        ' '' ''Dim width As Single = 6.0F
        '' ''Dim width_Invoice As Single = 0.94
    ...
    Private Sub rpt3_ediFORM4_91_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(0.06, 4.33, 0.06, 7.32)
        Me.CurrentPage.DrawLine(0.8, 4.33, 0.8, 7.32)
        Me.CurrentPage.DrawLine(1.8, 4.33, 1.8, 7.32)
        Me.CurrentPage.DrawLine(5.2, 4.33, 5.2, 7.32)
        Me.CurrentPage.DrawLine(6, 4.33, 6, 7.32)
        Me.CurrentPage.DrawLine(7.1, 4.33, 7.1, 7.32)
        Me.CurrentPage.DrawLine(8.19, 4.33, 8.19, 7.32)
    End Sub
...
#End Region
    ...
    '                    str_gross = NetWeight_(Tnet, txtunit_code2.Value) & vbNewLine & FobTxtAll()
    '                    str_GrossF = str_gross
