...
Public Class rpt3_ediFORM1RU_pr
    ...
    Sub check8()
        ...
        If regex.IsMatch(txtbox8.Text) Then
            match = regex.Match(txtbox8.Text)
            For i = 0 To match.Groups.Count - 1
                arr(i) = match.Groups(i).Value
            Next
        End If
        'txtdigit1
        Select Case CommonUtility.Get_StringValue(txtdigit2.Text)
            Case "2"
                txtTemp_box8.Text = """" + arr(2) + """" + Format(CDec(arr(4)), "0.00") + "%"
            Case "3"
                txtTemp_box8.Text = """" + arr(2) + """" + Format(CDec(arr(4)), "0.000") + "%"
            Case "4"
                txtTemp_box8.Text = """" + arr(2) + """" + Format(CDec(arr(4)), "0.0000") + "%"
        End Select
    End Sub
...
#End Region
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        Select Case CommonUtility.Get_StringValue(txtmaterial_type.Text)
            Case "1"
                Check_box8()
            Case Is <> "1"
                check8()
    ...
    Private Sub rpt3_ediFORM1RU_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
    ...
    Private Sub rpt3_ediFORM1RU_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.25, 0.06, 8.5)
        Me.CurrentPage.DrawLine(1, 4.25, 1, 8.5)
        Me.CurrentPage.DrawLine(2, 4.25, 2, 8.5)
        Me.CurrentPage.DrawLine(5.2, 4.25, 5.2, 8.5)
        Me.CurrentPage.DrawLine(6.07, 4.25, 6.07, 8.5)
        Me.CurrentPage.DrawLine(7.1, 4.25, 7.1, 8.5)
        Me.CurrentPage.DrawLine(8.19, 4.25, 8.19, 8.5)
    End Sub

    Private Sub rpt3_ediFORM1RU_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        'If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        ' End If
    End Sub

    Private Sub rpt3_ediFORM1RU_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
