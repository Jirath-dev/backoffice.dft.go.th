...
Public Class rpt3_ediFORM4 
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        Dim str_date As String = CommonUtility.Get_StringValue(Now.Day) & "/" & CommonUtility.Get_StringValue(Now.Month) & "/" & CommonUtility.Get_StringValue(Now.Year)
        txtcompany_provincefoot.Text = txtcompany_provincefoot1.Text & " " & str_date
    ...
    Sub All_CheckThird_5(ByVal count_data As Integer)
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 1
                ...
                If CommonUtility.Get_Int32(C_TotalRowDe.Text) = count_data Then
            ...
            Case "100000" ' เรื่อง invoice ต่างประเทศ
                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeader.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                        ...
                        Select Case CommonUtility.Get_Int32(C_TotalRowDe.Text)
                            Case 1
    ...
    Sub Count_RowToPage_DetailData()
        ...
        CountData_T = CommonUtility.Get_Int32(C_TotalRowDe.Text)
        ...
        CHeck_DisPlay()
        '============================================================
        'If txtNumRowCount.Text = CommonUtility.Get_Int32(C_TotalRowDe.Text) Then
    ...
    Private Sub rpt3_ediFORM4_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4, 0.06, 7.74)
        Me.CurrentPage.DrawLine(0.75, 4, 0.75, 7.74)
        Me.CurrentPage.DrawLine(1.82, 4, 1.82, 7.74)
        Me.CurrentPage.DrawLine(5.39, 4, 5.39, 7.74)
        Me.CurrentPage.DrawLine(6.07, 4, 6.07, 7.74)
        Me.CurrentPage.DrawLine(7.1, 4, 7.1, 7.74)
        Me.CurrentPage.DrawLine(8.19, 4, 8.19, 7.74)
        'Me.CurrentPage.DrawLine(8.07, 5, 8.07, 9)
    End Sub
