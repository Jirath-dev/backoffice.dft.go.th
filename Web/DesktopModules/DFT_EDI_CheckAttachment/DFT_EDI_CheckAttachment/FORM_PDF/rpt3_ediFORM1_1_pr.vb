...
Public Class rpt3_ediFORM1_1_pr
...
#End Region
    ...
    Private Sub rpt3_ediFORM1_1_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
    ...
    Private Sub rpt3_ediFORM1_1_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.25, 0.06, 8.24)
        Me.CurrentPage.DrawLine(1, 4.25, 1, 8.24)
        Me.CurrentPage.DrawLine(2, 4.25, 2, 8.24)
        Me.CurrentPage.DrawLine(5.2, 4.25, 5.2, 8.24)
        Me.CurrentPage.DrawLine(6.07, 4.25, 6.07, 8.24)
        Me.CurrentPage.DrawLine(7.1, 4.25, 7.1, 8.24)
        Me.CurrentPage.DrawLine(8.19, 4.25, 8.19, 8.24)
    End Sub

    Private Sub rpt3_ediFORM1_1_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        'If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        'End If
    End Sub

    Private Sub rpt3_ediFORM1_1_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
