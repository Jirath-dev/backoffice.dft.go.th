...
Partial Public Class rpt3_ediFORM4_8_New_pr
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtreference_code2_Temp.Style = "color: Blue; ddo-char-set: 1; text-align: center; font-weight: bold; font-size: 1" & _
        ...
        Me.Label20.Style = "ddo-char-set: 0; text-align: center; font-weight: bold; font-size: 9.75pt; font-f" & _
            "amily: Arial; "
        ...
        Me.Label22.Style = "color: #0000C0; ddo-char-set: 0; text-align: center; font-weight: bold; font-size" & _
        ...
        Me.Label9.Text = "Preferential Treatment Given Under ASEAN-Korea Free Trade Area Preferential Tarif" & _
            "f"
        Me.Label9.Top = 2.75!
