...
Public Class rpt3_ediFORM44_01
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value),
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Visible = True
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & vbNewLine &
                                                                _TempB2B & vbNewLine &
                                                                IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                "       _____________________________"
                Else
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And CommonUtility.Get_StringValue(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        ...
                        txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " &
                            IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                                        "       _____________________________"
                        'txtT_product.Text &= vbCrLf & "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " &
                        '   IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                        '                                                               "       _____________________________"
                    Else
                        txtT_product.Text = All_str &
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And CommonUtility.Get_StringValue(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        ...
                        GroupFooter1.Visible = True
                        txtTotalAll.Visible = True
                        txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & vbNewLine &
                        _TempB2B & vbNewLine &
                        IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                                        "       _____________________________"
                    Else
    ...
    Private Sub rpt3_ediFORM4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(7.2, 3.95, 7.2, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.95))
