...
Public Class rpt3_ediFORM1_pr
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        Form_AVIP(CommonUtility.Get_StringValue(txtvasel_name.Value))
    End Sub

    'check กรณี เอ พิเศษ เกี่ยวกับ ประเทศช่องล่าง check จากฟิวล์ "vasel_nam"  ทำไว้เพื่อบางบริษัท
    Sub Form_AVIP(ByVal _vasel_name As String)
        Select Case _vasel_name.Trim
            Case Is <> ""
                txtThaiLand.Visible = True
                txtThaiLand.Text = _vasel_name
            Case Else
                txtThaiLand.Visible = False
        End Select
    End Sub
    Dim TNet As Decimal
    ...
    Sub Head_Checkdestination_v2()
        ...
        ElseIf Mid(txtdest_remark1.Text, 1, 3) = "O/B" Then
            txtdestination_Check2.Text = txtdestination_company.Text & vbNewLine & txtdestination_address.Text & " " & _
                                    txtdestination_province.Text & " " & txtdest_Receive_country.Text & _
                                    IIf(CommonUtility.Get_StringValue(Check_NULLALL(txtdestination_phone.Text)) <> "", " TEL: " & txtdestination_phone.Text, "") & _
                                    IIf(CommonUtility.Get_StringValue(Check_NULLALL(txtdestination_fax.Text)) <> "", " FAX: " & txtdestination_fax.Text, "") _
                                    & IIf(CommonUtility.Get_StringValue(Check_NULLALL(txtdestination_taxid.Text)) <> "", " TAX ID: " & txtdestination_taxid.Text, "") & _
        ...
        ElseIf Mid(txtdest_remark1.Text, 2, 1) <> "/" Then
            txtdestination_Check2.Text = txtdestination_company.Text & vbNewLine & txtdestination_address.Text & " " & txtdestination_province.Text _
    ...
    Sub CallInvoiceCheck() 'Check Invoince
        ...
        Dim str_NumInvoice As String = CommonUtility.Get_StringValue(Check_NULLALL(txtNumInvoice.Text))
            ...
            Case Else
                Select Case Check_numinvoiceAll(CommonUtility.Get_String(txtinvoice_no1.Text), CommonUtility.Get_String(txtinvoice_no2.Text), CommonUtility.Get_String(txtinvoice_no3.Text), CommonUtility.Get_String(txtinvoice_no4.Text), CommonUtility.Get_String(txtinvoice_no5.Text))
                    ...
                    Case 5
                        ...
                        End If
                End Select
                'If CommonUtility.Get_String(txtinvoice_no1.Text.Trim) <> "" And CommonUtility.Get_String(txtinvoice_date1.Text) <> "" And CommonUtility.Get_String(txtinvoice_no2.Text.Trim) = "" And CommonUtility.Get_String(txtinvoice_date2.Text) = "" And CommonUtility.Get_String(txtinvoice_no3.Text.Trim) = "" And CommonUtility.Get_String(txtinvoice_date3.Text) = "" And CommonUtility.Get_String(txtinvoice_no4.Text.Trim) = "" And CommonUtility.Get_String(txtinvoice_date4.Text) = "" And CommonUtility.Get_String(txtinvoice_no5.Text.Trim) = "" And CommonUtility.Get_String(txtinvoice_date5.Text) = "" Then
                '    '1 invoice
                ...
                'If (Not txtinvoice_no1.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date1.Text) <> "" And (Not txtinvoice_no2.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date2.Text) = "" And (Not txtinvoice_no3.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date3.Text) = "" And (Not txtinvoice_no4.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date4.Text) = "" And (Not txtinvoice_no5.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date5.Text) = "" Then
                '    '1 invoice
                '    str_invoice = txtinvoice_no1.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date1.Text) <> "", confor_mat(CDate(txtinvoice_date1.Text).Date), Nothing)
                'ElseIf (Not txtinvoice_no1.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date1.Text) <> "" And (Not txtinvoice_no2.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date2.Text) <> "" And (Not txtinvoice_no3.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date3.Text) = "" And (Not txtinvoice_no4.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date4.Text) = "" And (Not txtinvoice_no5.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date5.Text) = "" Then
                '    '2 invoice
                '    str_invoice = txtinvoice_no1.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date1.Text) <> "", confor_mat(CDate(txtinvoice_date1.Text).Date), Nothing) & vbNewLine _
                '                        & txtinvoice_no2.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date2.Text) <> "", confor_mat(CDate(txtinvoice_date2.Text).Date), Nothing)

                'ElseIf (Not txtinvoice_no1.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date1.Text) <> "" And (Not txtinvoice_no2.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date2.Text) <> "" And (Not txtinvoice_no3.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date3.Text) <> "" And (Not txtinvoice_no4.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date4.Text) = "" And (Not txtinvoice_no5.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date5.Text) = "" Then
                '    '3 invoice
                '    str_invoice = txtinvoice_no1.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date1.Text) <> "", confor_mat(CDate(txtinvoice_date1.Text).Date), Nothing) & vbNewLine _
                '                        & txtinvoice_no2.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date2.Text) <> "", confor_mat(CDate(txtinvoice_date2.Text).Date), Nothing) & vbNewLine _
                '                        & txtinvoice_no3.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date3.Text) <> "", confor_mat(CDate(txtinvoice_date3.Text).Date), Nothing)

                'ElseIf (Not txtinvoice_no1.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date1.Text) <> "" And (Not txtinvoice_no2.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date2.Text) <> "" And (Not txtinvoice_no3.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date3.Text) <> "" And (Not txtinvoice_no4.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date4.Text) <> "" And (Not txtinvoice_no5.Text = String.Empty = False) And CommonUtility.Get_String(txtinvoice_date5.Text) = "" Then
                '    '4 invoice
                '    str_invoice = txtinvoice_no1.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date1.Text) <> "", confor_mat(CDate(txtinvoice_date1.Text).Date), Nothing) & vbNewLine _
                '                        & txtinvoice_no2.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date2.Text) <> "", confor_mat(CDate(txtinvoice_date2.Text).Date), Nothing) & vbNewLine _
                '                        & txtinvoice_no3.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date3.Text) <> "", confor_mat(CDate(txtinvoice_date3.Text).Date), Nothing) & vbNewLine _
                ...
                'ElseIf (Not txtinvoice_no1.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date1.Text) <> "" And (Not txtinvoice_no2.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date2.Text) <> "" And (Not txtinvoice_no3.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date3.Text) <> "" And (Not txtinvoice_no4.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date4.Text) <> "" And (Not txtinvoice_no5.Text = String.Empty = True) And CommonUtility.Get_String(txtinvoice_date5.Text) <> "" Then
                '    '5 invoice
                '    str_invoice = txtinvoice_no1.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date1.Text) <> "", confor_mat(CDate(txtinvoice_date1.Text).Date), Nothing) & vbNewLine _
                '                        & txtinvoice_no2.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date2.Text) <> "", confor_mat(CDate(txtinvoice_date2.Text).Date), Nothing) & vbNewLine _
                '                        & txtinvoice_no3.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date3.Text) <> "", confor_mat(CDate(txtinvoice_date3.Text).Date), Nothing) & vbNewLine _
...
#End Region
    ...
    Private Sub rpt3_ediFORM1_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        head_height = PageHeader1.Height

        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 6.94
        Dim ym As Single = CSng(head_height) '5
        'Dim width As Single = 6.0F
        Dim widthm As Single = 0.88
        ...
        End With
        '============================
        Dim x_txtGrossTxt As Single = 6.02
        Dim y_txtGrossTxt As Single = CSng(head_height) '5
        'Dim width As Single = 6.0F
        Dim width_txtGrossTxt As Single = 0.91
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 1.13
        Dim y_txtmarks As Single = CSng(head_height) '5
        'Dim width As Single = 6.0F
        Dim width_txtmarks As Single = 0.86
    ...
    Private Sub rpt3_ediFORM1_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.063, 4.25, 0.063, 8.24)
        Me.CurrentPage.DrawLine(1, 4.25, 1, 8.24)
        Me.CurrentPage.DrawLine(1.95, 4.25, 1.95, 8.24)
        Me.CurrentPage.DrawLine(5.2, 4.25, 5.2, 8.24)
        Me.CurrentPage.DrawLine(6.07, 4.25, 6.07, 8.24)
        Me.CurrentPage.DrawLine(7.0, 4.25, 7.0, 8.24)
        Me.CurrentPage.DrawLine(8.185, 4.25, 8.185, 8.24)
    End Sub

    Private Sub rpt3_ediFORM1_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        ''If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        ''End If
    End Sub

    Private Sub rpt3_ediFORM1_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
