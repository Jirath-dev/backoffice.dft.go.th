        ...
        <telerik:RadPane ID="RadPane2" runat="server" BackColor="#cbe1ef" Width="70%" Height="100%">
            ...
            <script type="text/javascript">
                ...
                function changePdf(obj,certno1,certno2,hasPdf,TAXNO,CHECK_ASSET_COUNTRY,ASSET_SHARES_COUNTRY,ASSET_SHARES_TAX) {
                    ...
                    if (certno1 != "") {
		                cert_no = certno1;
                        str_query = "?certno="+certno1+"&TAXNO="+GetTaxId(ASSET_SHARES_TAX)+"&COUNTRY="+CHECK_ASSET_COUNTRY;
                    } else if (certno2 != "") {
		                cert_no = certno2;
                        str_query = "?certno="+certno2+"&TAXNO="+GetTaxId(ASSET_SHARES_TAX)+"&COUNTRY="+ASSET_SHARES_COUNTRY;
                    }
//                    if (hasPdf == "Y") {
//                       // myFrame.src = "/DesktopModules/DFT_EDI_CheckAttachment/ViewCertDetail.aspx" + str_query;
//                        var url = "ViewCertDetail.aspx?certno=" + cert_no + "&TAXNO=" + GetTaxId(TAXNO);
//                        
//                        myFrame.src = url;

//                       // myFrame.src = "https://edi.dft.go.th/Portals/0/DocumentFiles/<%= Request.QueryString("TaxNo") %>/" + cert_no + ".pdf?v="+dd.getTime();
//                    } else {
//                        myFrame.src = "/DesktopModules/DFT_EDI_CheckAttachment/ViewCertDetail.aspx"+str_query;
//                    }
