...
<body>
    <form id="form1" runat="server">
        <div style="background: #ffffff;">
            <table width="100%" cellpadding="0" cellspacing="0" style="background: #ffffff;" bgcolor="White">
                <tr>
                    <td rowspan="3">
                        <h3 align="center">ผลการตรวจสอบคุณสมบัติทางด้านถิ่นกำเนิดของสินค้า<br />
                            ด้วยระบบคอมพิวเตอร์</h3>
                    </td>
            ...
            <table width="100%" cellpadding="0" style="background: #ffffff;" cellspacing="0">
                <tr>
                    <td class="style1"
                ...
                <tr>
                    <td class="style1">เลขประจำตัวผู้เสียภาษี</td>
                    <td colspan="3">
                ...
                <tr>
                    ...
                    เป็นไปตามหลักเกณฑ์ภายใต้กฏว่าด้วยถิ่นกำเนิดสินค้า&nbsp; ตามรายละเอียดดังต่อไปนี้ะเอียดดังต่อไปนี้</td>
                </tr>
                <tr>
                    <td valign="top">ชื่อสินค้า</td>
                    <td colspan="3">
                ...
                <tr>
                    <td class="style1" valign="top">ประเทศที่ขอใช้สิทธิฯ</td>
                    <td width="40%">
                        <asp:Label ID="lblCountry" runat="server" Font-Bold="True"></asp:Label>
                    </td>
                    <td align="center">พิกัดศุลกากรที่</td>
                    <td>
        ...
        <br />
        <center>
            <asp:Label ID="lblMsg" runat="server" ForeColor="#FF3300" Font-Bold="true"></asp:Label>
            <br />
            </center>
