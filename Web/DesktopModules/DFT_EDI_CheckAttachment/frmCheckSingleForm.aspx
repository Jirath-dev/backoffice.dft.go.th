<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCheckSingleForm.aspx.vb"
    Inherits=".frmCheckSingleForm" %>
...
<head runat="server">
    <title>รายละเอียดคำร้องและเอกสารแนบ Single Form</title>
                ...
                <telerik:RadPane ID="RadPane2" runat="server" Width="50%" Height="100%">
                    ...
                    <script type="text/javascript">
                        function changePdf(filename) {
                            var dd = new Date();
                            var myFrame = document.getElementById('PDFFrame');
                            myFrame.src = "http://edi.me/Portals/0/DocumentFiles/" + filename + "?v=" + dd.getTime();
