<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCheckForm1.aspx.vb"
    Inherits=".frmCheckForm1" %>
...
<head runat="server">
    <title>รายละเอียดคำร้องและเอกสารแนบ</title>
        ...
        <telerik:RadCodeBlock ID="RadCodeBlockFirst" runat="server">
            ...
            <script type="text/javascript">
                ...
                function ShowAttachSheet() {
                    ...
                    objWin = window.open("ViewAttachSheet.aspx?id=<%= Request.QueryString("RefNo") %>", null, winprops);
                    objWin.focus();
                ...
                function ShowBlackList() {
                    var com_tax = String('<%= Request.QueryString("TaxNo") %>');
                     window.radopen("/DesktopModules/DFT_EDI_CheckAttachment/frmBlackListV2.aspx?comtax=" + com_tax, "ViewDialog");
                     return false;
                 }
            </script>
        ...
        <telerik:RadWindowManager ID="RadWindowManager1" Behavior="Close" runat="server"
            ...
            <Windows>
                <telerik:RadWindow ID="ViewDialog" runat="server" Title="แสดงรายการสินค้า" ReloadOnShow="True"
                    ...
                    Top="" />
                <telerik:RadWindow ID="CommentDialog" runat="server" Title="แสดงรายการสินค้า" Behaviors="Minimize,Close,Move"
                    ReloadOnShow="True" ShowContentDuringLoad="False" Modal="false" VisibleStatusbar="False"
                    Width="800px" Height="560px" />
            </Windows>
        </telerik:RadWindowManager>
        <div id="ParentDivElement" style="height: 100%;">
            <telerik:RadSplitter ID="RadSplitter1" runat="server" VisibleDuringInit="False" Width="100%"
                Height="100%" LiveResize="True" Style="margin-right: 0px">
                <telerik:RadPane ID="RadPane1" BackColor="#cbe1ef" runat="server" Width="50%" Height="100%">
                    ...
                    <asp:Panel ID="panelSealSign" runat="server" Font-Size="10pt" Visible="False">
                        <div style="background: orange; padding: 5px; text-align: center;">
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="text-align: center">
                                                                                                <div style="margin-top: 8px; margin-bottom: 5px;">
                                                                                                    <asp:Button ID="Button1" runat="server" Style="margin-bottom: 5px;" Text="ผ่านการตรวจสอบ"
                                                                                                        OnClientClick="return confirm('คุณแน่ใจว่าต้องการกำหนดให้แบบฟอร์มนี้ ผ่านการตรวจสอบเอกสาร ใช่หรือไม่? \nกรุณาเลือกคลิกปุ่ม [OK]=ผ่านการตรวจสอบ หรือปุ่ม [Cancel]=ไม่ผ่าน');"
                                                                                                        Width="135px" Font-Names="Tahoma" Font-Size="10pt" BackColor="#80FF80" />
                                                                                                    <asp:Button ID="btnSignOK" runat="server" BackColor="#80FF80" Font-Names="Tahoma"
                                                                                                        Font-Size="10pt" Style="margin-bottom: 5px; width: 230px;" OnClientClick="return checkCertificate();"
                                                                                                    ...
                                                                                                    &#160;<asp:Button Style="margin-bottom: 5px;" ID="btnNotApproved" runat="server"
                                                                                                        Text="ไม่ผ่านการตรวจสอบ" Width="135px" Font-Names="Tahoma" Font-Size="10pt" ValidationGroup="NotApprove"
                                                                                                        OnClientClick="return ShowCommentForm();" BackColor="#FF8000" />
                                                                                                </div>
                                ...
                                <div style="margin-top: 3px;">
                                    <asp:Label ID="lblCheckResult" Style="margin-top: 3px;" runat="server"></asp:Label>
                                </div>
                            </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            ...
                            <td align="Center">
                                <asp:Label ID="lblMsgBlackList" runat="server" Font-Names="Tahoma"
                    ...
                    <div id="toggle_attach" style="display: ; padding: 2px; margin: 5px; margin-right: 20px;">
                                ...
                                <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" ClientDataKeyNames="FileID"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="TemplateViewColumn" HeaderText="">
                                            ...
                                            <ItemTemplate>
                                                <a href="#" onclick="changePdf2('<%#EVAL("FilesName") %>','<%#Eval("LocationType") %>','<%#Eval("FileLocation") %>')">
                                                    <asp:Image ID="Image2" ImageUrl="~/images/view.gif" ToolTip="View" runat="server" />
                                                </a>
                                            </ItemTemplate>
                        ...
                        <telerik:RadCodeBlock ID="RadCodeBlock3" runat="server">
                            <% If Request.QueryString("form_type").ToUpper() <> "FORM2" And Request.QueryString("form_type").ToUpper() <> "FORM2_1" Then%>
                            <div style="padding: 5px; text-align: center; padding-left: 8px; border: 1px solid #666666; border-top: 2px solid #ff0000; background: #ffffff;">
                                <table cellpadding="0" width="100%" cellspacing="0">
                                    <tr>
                                        <td align="center" style="font-size: 8pt; color: #666666;">ผลการตรวจสอบคุณสมบัติทางด้านถิ่นกำเนิดของสินค้า: &nbsp;
                                            <asp:Button ID="btnViewRollver" runat="server" Text="แสดงต้นทุน" OnClientClick="return ViewCertOfOrigin();return false;"
                ...
                <telerik:RadPane ID="RadPane2" runat="server" Width="50%" Height="100%">
                    ...
                    <script type="text/javascript">
                        function changePdf(filename) {
                            var dd = new Date();
                            var myFrame = document.getElementById('PDFFrame');
                            myFrame.src = "http://edi.dft.go.th/Portals/0/DocumentFiles/" + filename + "?v=" + dd.getTime();
                        }
                        function changePdf2(filename, location_type,file_location) {
                            var dd = new Date();
                            var myFrame = document.getElementById('PDFFrame');
                           
                            if (location_type == '2')
                            {
                                myFrame.src = "http://edi.dft.go.th/DocumentFiles/" + file_location + '/' + filename + "?v=" + dd.getTime();
                            } else {
                                myFrame.src = "http://edi.dft.go.th/Portals/0/DocumentFiles/" + filename + "?v=" + dd.getTime();
                            }
                        }
                    ...
                    <div style="height: 99%;">
                        <iframe id="PDFFrame" height="99%" width="100%" frameborder="0"></iframe>
                    </div>
                </telerik:RadPane>
            </telerik:RadSplitter>
            <table id="tblHeader" runat="server" cellpadding="0" cellspacing="0" width="100%">
                <tr>
