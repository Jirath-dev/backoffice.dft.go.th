...
Public Class rpt3_ediFORMsFTA_IN_pr
...
#End Region
            ...
            Case 9 'T1_third_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                ...
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " &
                                                                BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & "        " & """third country invoicing""" & " " & txtthird_country.Text & vbCrLf &
                                                                "       _____________________________"
                Else
                    txtT_product.Text = All_str
                End If
            ...
            Case 9 'T1_third_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " &
                                                                    ...
                                                                    BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " &
                                                                    BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " &
                                                                    """third country invoicing""" & " " & txtthird_country.Text & vbCrLf &
                                                                    "       _____________________________"
                Else
                    txtT_product.Text = All_str
                End If
    ...
    '            If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
    '                str_gross = GrossTxt() & vbNewLine & FobTxtAll() & vbNewLine & NetWeight_(TNet, txtunit_code2.Value) '& vbNewLine & FobTxtAll()
    ...
    Function CHeck_DisPlayF() As String
        ...
        Else
            If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                ...
                If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                    str_gross = GrossTxt() & vbNewLine & FobTxtAllSum() & vbNewLine & NetWeight_(TNet, txtunit_code2.Value) '& vbNewLine & FobTxtAll()
                    str_GrossF = str_gross
                ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
            ...
            ElseIf Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "" Then
                ...
                ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "" Then 'ระบบเก่า
                    str_gross = GrossTxt() & vbNewLine & FobTxtAllSum() 'ระบบเก่า
                    str_GrossF = str_gross
                End If
            End If
        End If
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        '//txtcompany_provincefoot.Text = txtcompany_provincefoot1.Text & " " & format_dateSelect() '& "====" & Me.PageNumber
    ...
    Private Sub rpt3_ediFORMsFTA_IN_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        head_height = PageHeader1.Height + 0.2

        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 7.14
        Dim ym As Single = CSng(head_height) '4.938 '4.76
        'Dim width As Single = 6.0F
        Dim widthm As Single = 0.85 '0.75
        ...
        End With
        '============================
        Dim x_txtGrossTxt As Single = 6.37
        Dim y_txtGrossTxt As Single = CSng(head_height) '4.938 '4.76
        'Dim width As Single = 6.0F
        Dim width_txtGrossTxt As Single = 0.75
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 1.2
        Dim y_txtmarks As Single = CSng(head_height) '4.938 '4.76
        'Dim width As Single = 6.0F
        Dim width_txtmarks As Single = 0.75
    ...
    Private Sub rpt3_ediFORMsFTA_IN_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.18, 0.06, 8.8)
        Me.CurrentPage.DrawLine(1, 4.18, 1, 8.3)
        Me.CurrentPage.DrawLine(2, 4.18, 2, 8.3)
        Me.CurrentPage.DrawLine(5.5, 4.18, 5.5, 8.3)
        Me.CurrentPage.DrawLine(6.38, 4.18, 6.38, 8.3)
        Me.CurrentPage.DrawLine(7.15, 4.18, 7.15, 8.3)
        Me.CurrentPage.DrawLine(8.19, 4.18, 8.19, 8.3)
    End Sub

    Private Sub rpt3_ediFORMsFTA_IN_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        UpdateTotalPDFPage(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count))
    End Sub

    Private Sub rpt3_ediFORMsFTA_IN_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
