...
Public Class rpt3_ediFORM4_1_pr
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_1_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        Dim y_txtGrossTxt As Single = 4.606
        'Dim width As Single = 6.0F
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 0.89
        Dim y_txtmarks As Single = 4.606
        'Dim width As Single = 6.0F
    ...
    Private Sub rpt3_ediFORM4_1_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        UpdateTotalPDFPage(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count))
    End Sub

    Private Sub rpt3_ediFORM441_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
