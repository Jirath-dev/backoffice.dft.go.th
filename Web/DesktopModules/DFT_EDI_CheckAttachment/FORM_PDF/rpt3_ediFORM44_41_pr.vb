...
Public Class rpt3_ediFORM44_41_pr
            ...
            Case 1
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                ...
                                                                String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & _
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                    ...
                                                                    BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " & _
                                                                    BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " & _
                                                                    BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & _
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                    "       _____________________________"
                Else
                    txtT_product.Text = All_str
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                    ...
                                                                    BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " & _
                                                                    BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " & _
                                                                    BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & vbNewLine & _
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & _
                                                                IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                "       _____________________________"
                Else
                    txtT_product.Text = All_str
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & vbNewLine & _
                                                                    _TempB2B & vbNewLine & _
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                    "       _____________________________"
                Else
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & _
                                                                IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                "       _____________________________"
                Else
                    txtT_product.Text = All_str
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & vbNewLine & _
                                                                    _TempB2B & vbNewLine & _
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                    "       _____________________________"
                Else
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Visible = True
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & _
                                                                IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                "       _____________________________"
                Else
                    txtT_product.Text = All_str
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Visible = True
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & vbNewLine & _
                                                                    _TempB2B & vbNewLine & _
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                    "       _____________________________"
                Else
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And CommonUtility.Get_StringValue(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        ...
                        GroupFooter1.Visible = True
                        txtTotalAll.Visible = True
                        txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & _
                        IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                                        "       _____________________________"
                    Else
                        txtT_product.Text = All_str & _
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And CommonUtility.Get_StringValue(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        ...
                        GroupFooter1.Visible = True
                        txtTotalAll.Visible = True
                        txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & vbNewLine & _
                                                                    _TempB2B & vbNewLine & _
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                    "       _____________________________"
                    Else
    ...
    '        str_USDInvoice = Format(CommonUtility.Get_Decimal(txtUSDInvoiceDetail.Text), "#,##0.00##") & " USD" 'invoice ต่างประเทศ แสดงมูลค่า รายการทุกรายการ
    '    Else
    ...
    '                                        Gr_ = Format(TGross, "#,##0.00##") & " " & CommonUtility.Get_StringValue(txtunit_code3.Value) & _
    '                                        vbNewLine & Format(TNet, "#,##0.00##") & " " & CommonUtility.Get_StringValue(txtunit_code2.Value) & _
    '                                        vbNewLine & Format(TUSD, "#,##0.00##") & " USD"
    '                                    Else
    '                                        str_Display = str_gross & vbNewLine & str_USDInvoice
    ...
    '    Select Case txtshow_check.Text
    '        Case "100000" ' เรื่อง invoice ต่างประเทศ
    '            If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
    '                If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeader.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
    '                    str_gross = GrossTxt() & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) 'Mid(txtnet_weight.Value, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10) '& vbNewLine & FobTxt()
    '                    Select Case C_TotalRowDe.Text
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        'If txtTitleMain.Text <> "" And noRec > 1 Then
        '    'If noRec > 1 Then
        '    txtT_product.Text = "rut" & Str_TitlePage & vbCrLf & txtT_product.Text
        '    txtNumRowCount.Location = New Drawing.PointF(txtNumRowCount.Location.X, Detail1.Height + 1)
        '    'txtNumRowCount.Location = New Drawing.PointF(txtNumRowCount.Location.X, txtT_product.Height + 0.03)
        '    txtTemp_box8.Location = New Drawing.PointF(txtTemp_box8.Location.X, txtT_product.Height - 0.001)
        '    '  End If
        'End If
    ...
    Private Sub rpt3_ediFORM4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        'Dim hp As Single = 0.0
        'Dim fp As Single = 0.0
        'Dim THF As Single = 0.0

        'hp = PageHeader1.Height
        'fp = PageFooter1.Height
        'THF = 3.95 + (12 - (hp + fp))
        Me.CurrentPage.DrawLine(0.06, 3.95, 0.06, 7.74) '7.74
        Me.CurrentPage.DrawLine(0.75, 3.95, 0.75, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.95))
        Me.CurrentPage.DrawLine(1.82, 3.95, 1.82, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.95))
        Me.CurrentPage.DrawLine(5.39, 3.95, 5.39, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.95))
        Me.CurrentPage.DrawLine(6.07, 3.95, 6.07, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.95))
        Me.CurrentPage.DrawLine(7, 3.95, 7, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.95))
    ...
    Function FLine_SizeSetting(ByVal By_form As String, ByVal By_Headline As Single, ByVal By_FootLine As Single, ByVal By_TempLineX As Single) As Single
        ...
        Select Case By_form.ToString.ToUpper
            Case "FORM4"
