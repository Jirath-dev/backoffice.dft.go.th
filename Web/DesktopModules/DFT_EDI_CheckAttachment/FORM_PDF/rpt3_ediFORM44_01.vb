...
Public Class rpt3_ediFORM44_01
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        'Dim strcommand As String = " SELECT reference_code2, approve_date FROM form_header_edi WHERE (invh_run_auto = @invh_run_auto)"
        ...
        '        txtcompany_provincefoot.Text = txtcompany_provincefoot1.Text & " " & Format(CDate(ds.Tables(0).Rows(0).Item("approve_date")), "dd/MM/yyy")
        '    Else
        ...
        'txtPrintDate.Text = String.Format("Print date:{0}", Date.Now.ToString("dd/MM/yyyy HH:mm:ss"))
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And DataUtil.ConvertToString(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        ...
                        GroupFooter1.Visible = True
                        txtTotalAll.Visible = True
                        txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, DataUtil.ConvertToString(txtshow_check.Text), TUSD, TUSDOther, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, "")) & "        " & vbNewLine &
                        _TempB2B & vbNewLine &
                        IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) &
                                                                                        "       _____________________________"
                    Else
    ...
    Function GrossTxtDetail() As String
        ...
        Str_GrossTxt = W_type & Format(Dec_Gross, "#,##0.00##") & " " & CheckUnitDetail_ASW(txtinvh_run_auto.Value)

        'DataUtil.ConvertToString(txtunit_code3.Value) 'CStr(Dec_Gross) & " " & DataUtil.ConvertToString(txtg_unit_code.Value)
    ...
    Private Sub rpt3_ediFORM4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        'by rut edit เส้น
        Dim detail_line_end As Double = 8.05
        Me.CurrentPage.DrawLine(0.062, 3.94, 0.062, detail_line_end) '7.74
        Me.CurrentPage.DrawLine(0.55, 3.94, 0.55, detail_line_end)
        Me.CurrentPage.DrawLine(1.52, 3.94, 1.52, detail_line_end)
        Me.CurrentPage.DrawLine(5.39, 3.94, 5.39, detail_line_end)
        Me.CurrentPage.DrawLine(6.07, 3.94, 6.07, detail_line_end)
        Me.CurrentPage.DrawLine(7.2, 3.94, 7.2, detail_line_end)
        Me.CurrentPage.DrawLine(8.186, 3.94, 8.186, detail_line_end)
