...
Public Class rpt3_ediFORM5_1_pr
...
#End Region
    ...
    Private Sub rpt3_ediFORM5_1_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Dim y1 As Double = 3.81
        Dim y2 As Double = 8.29
        Me.CurrentPage.DrawLine(0.06, y1, 0.06, y2)
        Me.CurrentPage.DrawLine(0.81, y1, 0.81, y2)
        Me.CurrentPage.DrawLine(1.81, y1, 1.81, y2)
        Me.CurrentPage.DrawLine(5.13, y1, 5.13, y2)
        Me.CurrentPage.DrawLine(5.94, y1, 5.94, y2)
        Me.CurrentPage.DrawLine(7.06, y1, 7.06, y2)
