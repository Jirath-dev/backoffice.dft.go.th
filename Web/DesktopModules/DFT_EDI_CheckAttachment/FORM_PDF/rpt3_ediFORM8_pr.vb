...
Public Class rpt3_ediform8_pr
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Cpage += 1
        'CallInvoiceCheck()
        txtTemp_fob_amt.Text = txtFOB_AMT.Text & " USD"
        Check_ship_by()
    ...
    Private Sub rpt3_ediform8_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.25, 0.06, 8.3)
        Me.CurrentPage.DrawLine(1.7, 4.25, 1.7, 8.3)
        Me.CurrentPage.DrawLine(6.07, 4.25, 6.07, 8.3)
        Me.CurrentPage.DrawLine(7.05, 4.25, 7.05, 8.3)
        Me.CurrentPage.DrawLine(8.19, 4.25, 8.19, 8.3)
    End Sub

    Private Sub rpt3_ediform8_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        Me.ReportInfo1.FormatString = "Page : {PageNumber} of {PageCount}"
    End Sub
    Sub Check_ship_by()
        Select Case DataUtil.ConvertToString(txtship_by.Text)
            Case "0"
