...
Public Class rpt3_ediFORMs4_3
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        txtcompany_provincefoot.Text = txtcompany_provincefoot1.Text & " " & str_datenow '& "====" & Me.PageNumber
    End Sub
    ...
    Private Sub rpt3_ediFORMs4_3_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.18, 0.06, 8.8)
        Me.CurrentPage.DrawLine(1, 4.18, 1, 8.3)
        Me.CurrentPage.DrawLine(2.1, 4.18, 2.1, 8.3)
        Me.CurrentPage.DrawLine(5.6, 4.18, 5.6, 8.3)
        Me.CurrentPage.DrawLine(6.3, 4.18, 6.3, 8.3)
        Me.CurrentPage.DrawLine(7.2, 4.18, 7.2, 8.3)
