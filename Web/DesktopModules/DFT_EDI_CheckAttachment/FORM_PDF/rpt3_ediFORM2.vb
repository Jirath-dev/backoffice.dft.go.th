...
Public Class rpt3_ediFORM2
    Private Sub rpt3_ediFORM2_ReportEnd(sender As Object, e As EventArgs) Handles MyBase.ReportEnd
    ...
    'End Sub
    ''Dim TGross, TNet, TFob, TUSD As Decimal
    'Dim TGross, TNet As Decimal
    ...
    '    str_ = CommonUtility.Get_StringValue(txtReserve1.Text) & " " & CommonUtility.Get_StringValue(txtIMPORT_COUNTRY.Text.Trim)
    '    If CommonUtility.Get_StringValue(txtReserve1.Text) = "" Then
    '        txtTemp_AllCountry.Text = CommonUtility.Get_StringValue(txtIMPORT_COUNTRY.Text)
    '    Else
    '        Select Case Len(str_)
    '            Case Is > 24
    '                txtTemp_AllCountry.Text = CommonUtility.Get_StringValue(txtReserve1.Text) & vbNewLine & CommonUtility.Get_StringValue(txtIMPORT_COUNTRY.Text.Trim)
    '            Case Else
    '                txtTemp_AllCountry.Text = str_
    '        End Select
    '    End If
    ...
    '        Case "0"
    '            txtship_by_0.Visible = True
    '            txtship_by_0.Text = "X"

    '            txtship_by_1.Visible = False
    '            txtship_by_2.Visible = False
    '            txtship_by_3.Visible = False
    '        Case "1"
    '            txtship_by_1.Visible = True
    '            txtship_by_1.Text = "X"

    '            txtship_by_0.Visible = False
    '            txtship_by_2.Visible = False
    '            txtship_by_3.Visible = False
    '        Case "2"
    '            txtship_by_2.Visible = True
    '            txtship_by_2.Text = "X"
    ...
    '                                    IIf(CommonUtility.Get_StringValue(txtdestination_taxid.Text) <> "", " " & txtdestination_taxid.Text, "") & _
    ...
    '                '1 invoice
    '                txtTolInvoice.Text = txtinvoice_no1.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date1.Text) <> "", confor_mat(CDate(txtinvoice_date1.Value).Date), Nothing)

    '            ElseIf CommonUtility.Get_String(txtinvoice_no1.Text) <> "" And CommonUtility.Get_String(txtinvoice_date1.Text) <> "" And CommonUtility.Get_String(txtinvoice_no2.Text) <> "" And CommonUtility.Get_String(txtinvoice_date2.Text) <> "" And CommonUtility.Get_String(txtinvoice_no3.Text) = "" And CommonUtility.Get_String(txtinvoice_date3.Text) = "" And CommonUtility.Get_String(txtinvoice_no4.Text) = "" And CommonUtility.Get_String(txtinvoice_date4.Text) = "" And CommonUtility.Get_String(txtinvoice_no5.Text) = "" And CommonUtility.Get_String(txtinvoice_date5.Text) = "" Then
    '                '2 invoice
    '                txtTolInvoice.Text = txtinvoice_no1.Text & vbNewLine & IIf(CommonUtility.Get_String(txtinvoice_date1.Text) <> "", confor_mat(CDate(txtinvoice_date1.Value).Date), Nothing) & vbNewLine _
    ...
    ''    Dim sss As String = txtgross_weightH.Text
    ...
    '        Case Is <> "" ' เรื่อง invoice ต่างประเทศ แสดงมูลค่า
    '            Select Case CheckDetailGross
    '                Case "GWDetail" 'แยกรายการ, FOBDisplay ไม่ได้เก็บดิสเพล pol แก้เพื่อเก็บค่าแสดง HS CODE
    '                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
    '                        str_gross = "G.W." & vbNewLine & GrossTxtDetail() & vbNewLine & "N.W." & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) 'Mid(txtnet_weight.Value, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10) '& vbNewLine & FobTxt()
    '                        Select Case C_TotalRowDe.Text
    '                            Case 1
    ...
    '                                    "_______" & vbNewLine & "G.W." & vbNewLine & Format(TGross, "#,##0.00##") & " " & CommonUtility.Get_StringValue(txtunit_code3.Value) & _
    '                                    vbNewLine & "N.W." & vbNewLine & Format(TNet, "#,##0.00##") & " " & CommonUtility.Get_StringValue(txtunit_code2.Value)
    '                                Else
    '                                    str_Display = str_gross '& vbNewLine & str_USDInvoice
    '                                End If
    ...
    '                        End Select
    '                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
    '                        str_gross = "G.W." & vbNewLine & GrossTxtDetail() '& vbNewLine & FobTxt()
    '                        Select Case C_TotalRowDe.Text
    '                            Case 1
    '                                str_Display = str_gross '& vbNewLine & str_USDInvoice
    '                            Case Else
    '                                If Cpage = CountAllDetail Then
    '                                    str_Display = str_gross & vbNewLine & _
    '                                    "_______" & vbNewLine & "G.W." & vbNewLine & Format(TGross, "#,##0.00##") & " " & CommonUtility.Get_StringValue(txtunit_code3.Value)
    ...
    '                Case Else
    '                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
    '                        str_gross = "G.W." & vbNewLine & GrossTxt() & vbNewLine & "N.W." & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value) 'Mid(txtnet_weight.Value, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10) '& vbNewLine & FobTxt()
    '                        Select Case C_TotalRowDe.Text
    '                            Case 1
    '                                str_Display = str_gross '& vbNewLine & str_USDInvoice
    '                            Case Else
    ...
    '            Select Case CheckDetailGross
    '                Case "GWDetail"
    '                    'form2 ใช้ WeightDisplayHeaderH
    '                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
    '                        str_gross = "G.W." & vbNewLine & GrossTxtDetail() & vbNewLine & "N.W." & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value)
    '                        Select Case C_TotalRowDe.Text
    '                            Case 1
    ...
    '                Case Else
    '                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
    '                        str_gross = "G.W." & vbNewLine & GrossTxt() & vbNewLine & "N.W." & vbNewLine & NetWeight_(TNet, txtunit_code2.Value)
    '                        Select Case C_TotalRowDe.Text
    '                            Case 1
    '                                str_Display = str_gross
    '                            Case Else
    ...
    'Private Sub rpt3_ediFORM2_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
    '    Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

    '    Dim xm As Single = 7.11
    '    Dim ym As Single = 5.315
    ...
    '            Dim y_txtGrossTxt As Single = 5.315
    '            'Dim width As Single = 6.0F
    '            Dim width_txtGrossTxt As Single = 0.86
    ...
    '    '============================
    '    Dim x_txtmarks As Single = 0.38
    '    Dim y_txtmarks As Single = 5.315
    '    'Dim width As Single = 6.0F
    '    Dim width_txtmarks As Single = 1.75
    ...
    'Private Sub rpt3_ediFORM2_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
    '    Me.CurrentPage.DrawLine(0.06, 4.82, 0.06, 8.3)
    '    Me.CurrentPage.DrawLine(1.8, 4.82, 1.8, 8.3)
    '    Me.CurrentPage.DrawLine(5.8, 4.82, 5.8, 8.3)
    '    Me.CurrentPage.DrawLine(6.8, 4.82, 6.8, 8.3)
    '    Me.CurrentPage.DrawLine(8.19, 4.82, 8.19, 8.3)
    'End Sub

    'Private Sub rpt3_ediFORM2_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
