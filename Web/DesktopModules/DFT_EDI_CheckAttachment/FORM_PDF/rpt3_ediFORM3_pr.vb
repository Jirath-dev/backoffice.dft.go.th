...
#End Region
    ...
    Private Sub rpt3_ediFORM3_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.065, 2.31, 0.065, 7.1)
        Me.CurrentPage.DrawLine(1.2, 2.31, 1.2, 7.1)
        Me.CurrentPage.DrawLine(4.9, 2.31, 4.9, 7.1)
        Me.CurrentPage.DrawLine(5.9, 2.31, 5.9, 7.1)
        Me.CurrentPage.DrawLine(6.73, 2.31, 6.73, 7.1)
        Me.CurrentPage.DrawLine(8.19, 2.31, 8.19, 7.1)
    End Sub
