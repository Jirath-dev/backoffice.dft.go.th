...
Public Class rpt3_ediFORM8_7_pr
...
#End Region
    ...
    Sub CHeck_DisPlay()
        ...
        If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
            ...
            If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                str_gross = "G.W." & vbNewLine & GrossTxt() & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value)
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Cpage += 1
        'CallInvoiceCheck()
        txtTemp_fob_amt.Text = Format(txtFOB_AMT.Value, "#,##0.00##") & " USD"
    ...
    Private Sub rpt3_ediFORM8_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
    ...
    Private Sub rpt3_ediFORM8_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(6.06, 4.82, 6.06, 8.3)
        Me.CurrentPage.DrawLine(7.06, 4.82, 7.06, 8.3)
