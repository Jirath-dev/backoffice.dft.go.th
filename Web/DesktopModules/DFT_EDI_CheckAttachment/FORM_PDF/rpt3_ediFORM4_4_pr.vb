...
Public Class rpt3_ediFORM4_4_pr
...
#End Region
    ...
    Function check_invoice_more(ByVal str_checkCase As String, ByVal value_invoiceMore As String) As String
        ...
        Return send_invoice
    End Function
    Private Sub rpt3_ediFORM4_4_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        head_height = PageHeader1.Height

        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 7.13
        Dim ym As Single = CSng(head_height) '5.042 '4.938
        ...
        '============================
        Dim x_txtGrossTxt As Single = 6.35
        Dim y_txtGrossTxt As Single = CSng(head_height) '5.042 '4.938
        'Dim width As Single = 6.0F
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 1.28
        Dim y_txtmarks As Single = CSng(head_height) '5.042 '4.938
        'Dim width As Single = 6.0F
        Dim width_txtmarks As Single = 0.7
    ...
    Private Sub rpt3_ediFORM4_4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.065, 4.25, 0.065, 8.2)
        Me.CurrentPage.DrawLine(1, 4.25, 1, 8.3)
        Me.CurrentPage.DrawLine(2, 4.25, 2, 8.3)
        Me.CurrentPage.DrawLine(5.45, 4.25, 5.45, 8.3)
        Me.CurrentPage.DrawLine(6.3, 4.25, 6.3, 8.3)
        Me.CurrentPage.DrawLine(7.2, 4.25, 7.2, 8.3)
        Me.CurrentPage.DrawLine(8.19, 4.25, 8.19, 8.3)
    End Sub

    Private Sub rpt3_ediFORM4_4_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        UpdateTotalPDFPage(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count))
    End Sub

    Private Sub rpt3_ediFORM4_4_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
