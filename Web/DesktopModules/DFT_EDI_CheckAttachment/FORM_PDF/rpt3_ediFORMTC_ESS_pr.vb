...
Public Class rpt3_ediFORMTC_ESS_pr
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(0.75, 3.95, 0.75, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 4.55))
        Me.CurrentPage.DrawLine(1.82, 3.95, 1.82, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 4.55))
        Me.CurrentPage.DrawLine(5.39, 3.95, 5.39, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 4.55))
        Me.CurrentPage.DrawLine(6.07, 3.95, 6.07, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 4.55))
        Me.CurrentPage.DrawLine(7, 3.95, 7, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 4.55))
