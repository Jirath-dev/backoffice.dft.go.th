...
Public Class rpt3_ediFORM4_2_pr_New
...
#Region "ByTine ของใหม่ เคสแยก GW/NW 28-8-2560"
    ...
    Function CHeck_DisPlay(ByVal CountAllDetail As String, ByVal CheckDetailGross As String) As String
        ...
        If DataUtil.ConvertToString(txtCheckGrossDetail.Text) = "GWDetail" Then
            ...
            End If
            '& " USD" 'invoice ต่างประเทศ แสดงมูลค่า รายการทุกรายการ
        Else
                        ...
                        Select Case Mid(DataUtil.ConvertToString(txtletter.Value), 1, 50)
                            Case "2" 'แสดงมูลค่า Detail ส่วน third [ต้องแสดงมูลค่า แต่ละรายการสินค้าหมดที่เป็น case 3 ยกเว้นยอดรวม]
                                If Mid(DataUtil.ConvertToString(txtFOBDisplay.Value), 1, 50) = "Display" Then
                                    If Mid(DataUtil.ConvertToString(txtWeightDisplayHeaderH.Value), 1, 50) = "NET WEIGHT" Then
                                        ...
                                        Select Case C_TotalRowDe.Text
                                            ...
                                            Case Else 'รายการที่ไม่ใช่รายการที่ 1
                                                    ...
                                                    Select Case Check_CaseRVCCount
                                                        Case 9 'มีอย่างอื่นปน ไม่แสดงมูลค่ารวม
                                                            str_GrossF = str_gross & vbNewLine & str_USDInvoice & vbNewLine &
                                                                      "_______" &
                                                                      vbNewLine & AddGW_NWLineForFormE(1) & Format(TNet, "#,##0.00##") & " " & DataUtil.ConvertToString(txtunit_code2.Value) &
                                                ...
                                                End If
                                        End Select
                                    ElseIf Mid(DataUtil.ConvertToString(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                                        ...
                                        Select Case C_TotalRowDe.Text
                                            ...
                                            Case Else 'รายการที่ไม่ใช่รายการที่ 1
                                                ...
                                                End If
                                        End Select
                                    ElseIf Mid(DataUtil.ConvertToString(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
                                    ...
                                    ElseIf Mid(DataUtil.ConvertToString(txtWeightDisplayHeaderH.Value), 1, 50) = "GW" Then 'ระบบเก่า มีแต่ GW
                                        str_gross = GrossTxtDetail() '& vbNewLine & FobTxtAll()
                                        Select Case C_TotalRowDe.Text
                                            Case 1 'รายการแรก
                                    ...
                                    ElseIf Mid(DataUtil.ConvertToString(txtWeightDisplayHeaderH.Value), 1, 50) = "" Then
                                        str_gross = GrossTxtDetail() '& vbNewLine & FobTxtAll()
                                        Select Case C_TotalRowDe.Text
                                            Case 1 'รายการแรก
                                                str_GrossF = str_gross & vbNewLine & str_USDInvoice
                                    ...
                                    End If
                                ElseIf Mid(DataUtil.ConvertToString(txtFOBDisplay.Value), 1, 50) = "NoDisplay" Then 'ถึงจะอยู่ใน case 2 ที่ต้องแสดงมูลค่าแต่ถ้าเข้าเงื่อนไขนี้ มูลค่าไม่แสดง [เคสนี้ไม่มี เผื่อไว้ ในอนาคต]
                                    If Mid(DataUtil.ConvertToString(txtWeightDisplayHeaderH.Value), 1, 50) = "NET WEIGHT" Then
                                ...
                                ElseIf Mid(DataUtil.ConvertToString(txtFOBDisplay.Value), 1, 50) = "" Then 'กรณี ไม่มีค่าในช่องนี้ [เผื่อไว้]
                            ...
                            Case Else 'X ไม่แสดงมูลค่า Detail ส่วน third letter ไม่เท่ากับ 3
                                If Mid(DataUtil.ConvertToString(txtFOBDisplay.Value), 1, 50) = "Display" Then
                                    ...
                                    End If
                                ElseIf Mid(DataUtil.ConvertToString(txtFOBDisplay.Value), 1, 50) = "NoDisplay" Then
                                    If Mid(DataUtil.ConvertToString(txtWeightDisplayHeaderH.Value), 1, 50) = "NET WEIGHT" Then
                                        str_gross = NetWeight_(txtnet_weight.Value, txtunit_code2.Value) 'Mid(Tnet, 1, 9) & " " & Mid(txtunit_code2.Value, 1, 10)
                                        Select Case C_TotalRowDe.Text
                                            Case 1 'รายการแรก
                                ...
                                ElseIf Mid(DataUtil.ConvertToString(txtFOBDisplay.Value), 1, 50) = "" Then
                        ...
                        Select Case Mid(DataUtil.ConvertToString(txtletter.Value), 1, 50)
                            Case "2" 'แสดงมูลค่า Detail ไม่ใช่ invoice ต่างประเทศ
                                If Mid(DataUtil.ConvertToString(txtFOBDisplay.Value), 1, 50) = "Display" Then
                                    ...
                                    ElseIf Mid(DataUtil.ConvertToString(txtWeightDisplayHeaderH.Value), 1, 50) = "GW" Then 'ระบบเก่า
                                        str_gross = GrossTxtDetail() & vbNewLine & FobTxtAllSumNew()
                                        Select Case C_TotalRowDe.Text
                                            Case 1 'รายการแรก
                                                str_GrossF = str_gross
...
#End Region
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 1
                ...
                If C_TotalRowDe.Text = count_data Then
                    txtT_product.Text = All_str & NewStr_AddressDetail(CommonUtility.Get_StringValue(txtob_address.Text))
    ...
    Private Sub rpt3_ediFORM4_2_pr_New_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 3.95, 0.06, 7.55)
        Me.CurrentPage.DrawLine(0.72, 3.95, 0.72, 7.55)
        Me.CurrentPage.DrawLine(1.8, 3.95, 1.8, 7.55)
        Me.CurrentPage.DrawLine(5.2, 3.95, 5.2, 7.55)
        Me.CurrentPage.DrawLine(6, 3.95, 6, 7.55)
        Me.CurrentPage.DrawLine(6.95, 3.95, 6.95, 7.55)
        Me.CurrentPage.DrawLine(8.19, 3.95, 8.19, 7.55)
    End Sub
