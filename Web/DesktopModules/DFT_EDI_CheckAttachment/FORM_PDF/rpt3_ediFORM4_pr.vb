...
Public Class rpt3_ediFORM4_pr
    ...
    Private Sub rpt3_ediFORM4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(0.75, 3.95, 0.75, 7.74)
        Me.CurrentPage.DrawLine(1.82, 3.95, 1.82, 7.74)
        Me.CurrentPage.DrawLine(5.39, 3.95, 5.39, 7.74)
        Me.CurrentPage.DrawLine(6.07, 3.95, 6.07, 7.74)
        Me.CurrentPage.DrawLine(7, 3.95, 7, 7.74)
