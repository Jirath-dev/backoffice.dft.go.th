...
Public Class rpt3_ediFORM9 
    ...
    Private Sub rpt3_ediFORM9_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.25, 0.06, 8.15)
        Me.CurrentPage.DrawLine(6.07, 4.25, 6.07, 8.15)
        Me.CurrentPage.DrawLine(7.05, 4.25, 7.05, 8.15)
        Me.CurrentPage.DrawLine(8.19, 4.25, 8.19, 8.15)
    End Sub
