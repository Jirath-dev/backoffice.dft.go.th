...
Public Class rpt3_ediFORMAI_ESS_PR
...
#End Region
    ...
    Function CHeck_DisPlayF() As String
        ...
        Select Case txtshow_check.Text
            Case "1000", "10000" ' เรื่อง invoice ต่างประเทศ
                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
        ...
        Select Case txtshow_check.Value
            ...
            Case "0010", "00110" 'Back-to-Back CO
                ...
                Else
                    ...
                    txtTemp_back_country.Text = "THAILAND"
                End If
            Case "1001", "10001" 'Third-Country Cumulation
                If txtthird_country.Value <> "" Then
                    PCheck_third_country.Visible = True
    ...
    Private Sub rpt3_ediFORMAI_ESS_PR_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
    ...
    Private Sub rpt3_ediFORMAI_ESS_PR_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.13, 0.06, 7.5)
        Me.CurrentPage.DrawLine(0.72, 4.13, 0.72, 7.5)
        Me.CurrentPage.DrawLine(1.8, 4.13, 1.8, 7.5)
        Me.CurrentPage.DrawLine(5.2, 4.13, 5.2, 7.5)
        Me.CurrentPage.DrawLine(6.0, 4.13, 6.0, 7.5)
        Me.CurrentPage.DrawLine(7.1, 4.13, 7.1, 7.5)
        Me.CurrentPage.DrawLine(8.19, 4.13, 8.19, 7.5)
    End Sub

    Private Sub rpt3_ediFORMAI_ESS_PR_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        UpdateTotalPDFPage(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count))
    End Sub

    Private Sub rpt3_ediFORMAI_ESS_PR_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
