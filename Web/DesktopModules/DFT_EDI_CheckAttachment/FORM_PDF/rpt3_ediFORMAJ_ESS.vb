...
#End Region
    ...
    Private Sub rpt3_ediFORM4_6_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(0.75, 4.13, 0.75, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.85))
        Me.CurrentPage.DrawLine(1.8, 4.13, 1.8, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.85))
        Me.CurrentPage.DrawLine(5, 4.13, 5, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.85))
        Me.CurrentPage.DrawLine(6, 4.13, 6, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.85))
        Me.CurrentPage.DrawLine(7.1, 4.13, 7.1, FLine_SizeSetting("FORM4", PageHeader1.Height, PageFooter1.Height, 3.85))
