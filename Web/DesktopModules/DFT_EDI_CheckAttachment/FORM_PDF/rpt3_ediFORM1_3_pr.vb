...
Public Class rpt3_ediFORM1_3_pr
...
#End Region
    ...
    Private Sub rpt3_ediFORM1_3_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
    ...
    Private Sub rpt3_ediFORM1_3_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.25, 0.06, 8.36)
        Me.CurrentPage.DrawLine(1, 4.25, 1, 8.36)
        Me.CurrentPage.DrawLine(2, 4.25, 2, 8.36)
        Me.CurrentPage.DrawLine(5.2, 4.25, 5.2, 8.36)
        Me.CurrentPage.DrawLine(5.95, 4.25, 5.95, 8.36)
        Me.CurrentPage.DrawLine(7.1, 4.25, 7.1, 8.36)
        Me.CurrentPage.DrawLine(8.19, 4.25, 8.19, 8.36)
    End Sub

    Private Sub rpt3_ediFORM1_3_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        UpdateTotalPDFPage(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count))
    End Sub

    Private Sub rpt3_ediFORM1_3_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
