...
Public Class rpt3_ediFORMD_ESS_
    ...
    Private Sub rpt3_ediFORM4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(0.5, 3.92, 0.5, 7.67) '7.74
        Me.CurrentPage.DrawLine(0.94, 3.93, 0.94, 7.67)
        Me.CurrentPage.DrawLine(1.94, 3.93, 1.94, 7.67)
        Me.CurrentPage.DrawLine(5.375, 3.93, 5.375, 7.67)
        Me.CurrentPage.DrawLine(6, 3.93, 6, 7.67)
        Me.CurrentPage.DrawLine(7, 3.93, 7, 7.67)
        Me.CurrentPage.DrawLine(8, 3.92, 8, 7.67)
