...
Public Class rpt3_ediFORMRCEP
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        check_show_check()
        'แสดงฺB2B ในช่อง14
        txt_b2b.Text = _TempB2B & " " & DataUtil.ConvertToString(txtsupplementary_details.Value)
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            'issued
            Select Case CheckIssuedDate_Forms_RCEP(CDate(txtdeparture_date.Value), CDate(IIf(IsDBNull(CDate(ds.Tables(0).Rows(0).Item("printFormDate"))) = True, Now.Date, CDate(ds.Tables(0).Rows(0).Item("printFormDate")))))
                Case True
                    Pic_ch7_Issued.Visible = True
                Case False
                    Pic_ch7_Issued.Visible = False
    ...
    Sub All_CheckThird_5(ByVal count_data As Integer)
        txt_tariff_code.Text = tariff_All(DataUtil.ConvertToString(txttariff_code.Text))
        txthird_country.Text = txtthird_country.Text
        ...
        Select Case Check_Third(DataUtil.ConvertToString(txtthird_country.Value),
            ...
            Case 1
                All_str =
                                        txtproduct_n1.Text & txtproduct_n2.Text & txtcompany_description.Text & " ****" & vbCrLf
    ...
    Function CHeck_DisPlay(ByVal CountAllDetail As String, ByVal CheckDetailGross As String) As String
        ...
        Select Case checkNull_Show(DataUtil.ConvertToString(txtshow_check.Text))
            Case "10" ' เรื่อง invoice ต่างประเทศ แสดงมูลค่า
    ...
    Private Sub rpt3_ediFORMRCEPpr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart

        'by rut edit เส้น
        Dim detail_line_start As Double = 3.815
        Dim detail_line_end As Double = 7.78
        ...
        Me.CurrentPage.DrawLine(1.6, detail_line_start, 1.6, detail_line_end)
        Me.CurrentPage.DrawLine(3.8, detail_line_start, 3.8, detail_line_end)
        Me.CurrentPage.DrawLine(4.5, detail_line_start, 4.5, detail_line_end)
        Me.CurrentPage.DrawLine(5.3, detail_line_start, 5.3, detail_line_end)
