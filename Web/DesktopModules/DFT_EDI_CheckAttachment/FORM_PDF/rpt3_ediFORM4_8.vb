...
Public Class rpt3_ediFORM4_8
    ...
    Sub Check_box8()
        Select Case CommonUtility.Get_StringValue(txtbox8.Value)
            Case """RVC"""
                txtTemp_box8.Text = """RVC" & " " & txtprofit_per_unit.Value & " %" & """"
            Case """2RV"""
                txtTemp_box8.Text = """RVC" & " " & txtprofit_per_unit.Value & " %" & """"
            Case """CC&RVC"""
    ...
    Private Sub rpt3_ediFORM4_8_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
