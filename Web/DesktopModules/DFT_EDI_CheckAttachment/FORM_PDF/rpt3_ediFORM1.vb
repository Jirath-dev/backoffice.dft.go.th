...
Public Class rpt3_ediFORM1 
    ...
    Private Sub rpt3_ediFORM1_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.125, 4.25, 0.125, 8.24)
        ...
        Me.CurrentPage.DrawLine(7.2, 4.25, 7.2, 8.24)
        Me.CurrentPage.DrawLine(8.25, 4.25, 8.25, 8.24)
    End Sub
