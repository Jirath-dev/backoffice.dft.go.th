...
Public Class rpt3_ediFORMRCEP_A4
    ...
    Function CHeck_DisPlay(ByVal CountAllDetail As String, ByVal CheckDetailGross As String) As String
        ...
        If txtCurrency_Code.Text = "USD" Then
            Total_FOB = TUSD
            'แก้FOBแสดงในช่อง12
            str_USDInvoice = Format(CommonUtility.Get_Decimal(txtFOB_AMT.Text), "#,##0.00##") & " " & txtCurrency_Code.Text
        Else
            Total_FOB = TUSDOther
    ...
    Private Sub rpt3_ediFORM4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Dim detail_line_end As Double = 7.7
        ...
        Me.CurrentPage.DrawLine(3.6, detail_line_start, 3.6, detail_line_end)
