...
Public Class rpt3_ediFORM1_4_pr
    ...
    Sub Head_Checkcompany_v1()
        ...
        ElseIf Mid(txtdest_remark.Text, 1, 3) = "O/B" Then
            txtCompany_Check_1.Text = txtcompany_name.Text & " " & txtcompany_address.Text & " " & txtcompany_province.Text _
                                & " " & txtcompany_country.Text & IIf(Check_NULLALL(CommonUtility.Get_StringValue(txtcompany_phone.Text)) <> "", " TEL: " & txtcompany_phone.Text, "") & _
                                IIf(CommonUtility.Get_StringValue(Check_NULLALL(txtcompany_fax.Text)) <> "", " FAX: " & txtcompany_fax.Text, "") _
                                & IIf(CommonUtility.Get_StringValue(Check_NULLALL(txtcompany_taxno.Text)) <> "", " TAX ID: " & txtcompany_taxno.Text, "") & _
...
#End Region
    Dim All_str As String
    Sub Title_StrDetail()
        All_str = CarTxt(CommonUtility.Get_StringValue(txtSINGLE_COUNTRY_CONTENT.Value), CommonUtility.Get_StringValue(txtInvoiceDetailTH.Value)) & txtproduct_description.Text & " ****" & vbCrLf
    End Sub
    Sub All_CheckThird_5(ByVal count_data As Integer)
        Title_StrDetail()
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
    ...
    Private Sub rpt3_ediFORM1_4_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
    ...
    Private Sub rpt3_ediFORM1_4_pr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        Me.CurrentPage.DrawLine(0.06, 4.25, 0.06, 8.43)
        Me.CurrentPage.DrawLine(1, 4.25, 1, 8.43)
        Me.CurrentPage.DrawLine(2, 4.25, 2, 8.43)
        Me.CurrentPage.DrawLine(5.2, 4.25, 5.2, 8.43)
        Me.CurrentPage.DrawLine(6.07, 4.25, 6.07, 8.43)
        Me.CurrentPage.DrawLine(7.1, 4.25, 7.1, 8.43)
        Me.CurrentPage.DrawLine(8.19, 4.25, 8.19, 8.43)
    End Sub

    Private Sub rpt3_ediFORM1_4_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        UpdateTotalPDFPage(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count))
    End Sub

    Private Sub rpt3_ediFORM1_4_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
