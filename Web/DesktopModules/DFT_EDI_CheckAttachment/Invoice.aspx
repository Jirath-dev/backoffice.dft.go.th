...
<body>
    <form id="form1" runat="server">
        <div style="color: #cccccc; background: #333333; text-align: center; padding: 10px;
            ...
            <h3 style="margin: 0px;">
                ข้อมูลใบกำกับสินค้า (Invoice)</h3>
        </div>
        <asp:DataList ID="dlInvoice" runat="server" Width="100%">
            <ItemTemplate>
                <div style="background: #ffffff; padding: 15px; margin-bottom: 15px;">
                    <div style="margin-bottom: 5px; font-size: 8pt; text-align: center; color: #666666;">
                        ใบกำกับสินค้า ลำดับที่ #<asp:Label ID="lblInvNo" Text='<%# Container.ItemIndex + 1 %>'
                    ...
                    <table cellpadding="0" class="tb-data1" cellspacing="0" width="100%" style="margin-bottom: 10px;">
                        ...
                        <tr>
                            <td class="box" style="background: #ffffff">
                                Invoice Date:</td>
                            <td class="box" style="background: #ffffff">
                                <asp:Label ID="lblInvoiceDate" CssClass="data" Text='<%# Eval("invoice_date", "{0:dd/MM/yyyy}") %>'
                    ...
                    <table cellpadding="0" class="tb-data" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblConsign" runat="server" CssClass="data" Text='<%# Eval("destination_address") %>'></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="border-top: 1px solid #cccccc; border-bottom: none;">
                                Vessel&#39;s name/<br />
                                Aircraft etc.</td>
                        ...
                        <tr>
                            <td style="background: #ffffff; border-top: 1px solid #999999;">
                                Shipped on Board:</td>
                            <td style="background: #ffffff; border-top: 1px solid #999999;">
                                <asp:Label ID="lblETD" runat="server" Text='<%# Eval("etd", "{0:dd/MM/yyyy}") %>'
    ...
    <td class="header">
                    ...
                    <table style="display: none; margin-top: 20px;">
                        <tr>
                            <td style="vertical-align: top">
                                <table cellpadding="0" class="tb-data2" cellspacing="0" style="background: #efefef;">
                                    <tr>
                                        <td width="130">
                                            Total Net Weight:</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            Total Quantity #1:</td>
                                        <td>
                                            <asp:Label ID="lblTotalQuantity1" CssClass="data" runat="server" Text='<%# Eval("total_quantity1", "{0:#,##0.000}") %>'></asp:Label>
                                    ...
                                    <tr>
                                        <td>
                                            Total Quantity #2:</td>
                                        <td>
                                            <asp:Label ID="lblTotalQuantity2" CssClass="data" runat="server" Text='<%# Eval("total_quantity2", "{0:#,##0.000}") %>'></asp:Label>
                                    ...
                                    <tr>
                                        <td>
                                            Total Quantity #3:</td>
                                        <td>
                                            <asp:Label ID="lblTotalQuantity3" CssClass="data" runat="server" Text='<%# Eval("total_quantity3", "{0:#,##0.000}") %>'></asp:Label>
                                    ...
                                    <tr>
                                        <td>
                                            Total Quantity #4:</td>
                                        <td>
                                            <asp:Label ID="lblTotalQuantity4" CssClass="data" runat="server" Text='<%# Eval("total_quantity4", "{0:#,##0.000}") %>'></asp:Label>
                                    ...
                                    <tr>
                                        <td>
                                            Total Quantity #5:</td>
                                        <td>
                                            <asp:Label ID="lblTotalQuantity5" CssClass="data" runat="server" Text='<%# Eval("total_quantity5", "{0:#,##0.000}") %>'></asp:Label>
        ...
        <div style="background: #ffffcc; padding: 15px; margin-bottom: 15px;">
            ...
            <table style="margin-top: 10px;">
                <tr>
                    <td style="vertical-align: top">
                        <table cellpadding="0" class="tb-data2" cellspacing="0" style="background: #ffffff;">
                            <tr>
                                <td width="130">
                                    Total Net Weight:</td>
                                <td>
