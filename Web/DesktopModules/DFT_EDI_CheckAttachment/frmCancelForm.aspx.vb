...
#End Region
    Protected Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            ds = SqlHelper.ExecuteDataset(strEDIConn, CommandType.StoredProcedure, "sp_form4_edi_notApproveForm_CheckDoc",
            New SqlParameter("@INVH_RUN_AUTO", CommonUtility.Get_StringValue(txtInvHRunAuto.Text)),
            New SqlParameter("@USER_ID", CommonUtility.Get_StringValue(objUserInfo.Username.ToLower)),
            New SqlParameter("@E01", CommonUtility.Get_String(txtE01.Text.Trim())),
            New SqlParameter("@E02", CommonUtility.Get_String(txtE02.Text.Trim())),
            New SqlParameter("@E03", CommonUtility.Get_String(txtE03.Text.Trim())),
            New SqlParameter("@E04", ""),
            New SqlParameter("@E05", CommonUtility.Get_String(txtE05.Text.Trim())),
            New SqlParameter("@E06", CommonUtility.Get_String(txtE06.Text.Trim())),
            New SqlParameter("@E07", CommonUtility.Get_String(txtE07.Text.Trim())),
            New SqlParameter("@E08", CommonUtility.Get_String(txtE08.Text.Trim())),
            New SqlParameter("@E09", CommonUtility.Get_String(txtE09.Text.Trim())),
            New SqlParameter("@E10", CommonUtility.Get_String(txtE10.Text.Trim())),
            New SqlParameter("@E11", CommonUtility.Get_String(txtE11.Text.Trim())),
            New SqlParameter("@E12", CommonUtility.Get_String(txtE12.Text.Trim())),
            New SqlParameter("@E99", CommonUtility.Get_String(txtE99.Text)),
