...
Partial Public Class frmCheckSingleForm
...
#End Region
    ...
    Private Sub LoadAttachFile(ByVal RefNo As String)
        Try
            ...
            '//ไปดึงข้อมูลจาก NSW Single form
    ...
    'Private Sub LoadNSWAttachment()
    '    Dim client = New RestClient("http://thainsw.net/UNSWWS_TEST/NSWService/getNSWAttachment")
    '    Dim request = New RestRequest(Method.POST)
    '    request.RequestFormat = DataFormat.Json
    '    request.AddBody(New With {
    '                    .userNSW = "doftst1",
    '                    .passNSW = "11111111",
    '                    .ogaTaxNum = "0994000159561",
    '                    .ogaTaxBranch = "0",
    '                    .referenceNum = "HEFR000003710",
    '                    .requestId = "55"})
