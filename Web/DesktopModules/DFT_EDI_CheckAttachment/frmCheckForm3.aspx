<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCheckForm3.aspx.vb"
    Inherits=".frmCheckForm3" %>
...
<head runat="server">
    <title>ตรวจสอบรายละเอียดคำร้องและเอกสารแนบ สำหรับข้อมูลที่ส่งจากไฟล์ XML</title>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadCodeBlock ID="RadCodeBlockFirst" runat="server">
            ...
            function ShowAttachSheet() {
                ...
                objWin = window.open("ViewAttachSheet.aspx?taxno=" + GetTaxId('<%= Request.QueryString("TaxNo") %>') + "&id=<%= Request.QueryString("RefNo") %>", null, winprops);
                     objWin.focus();
                 ...
                 function ViewCertOfOrigin() {
                     ...
                     objWin = window.open("ViewCertOfOrigin.aspx?item_no=" + item_no + "&invh_run_auto=<%= Request.QueryString("RefNo") %>", null, winprops);
                     objWin.focus();
                 }
        ...
        <div id="ParentDivElement" style="height: 100%;">
            <telerik:RadSplitter ID="RadSplitter1" runat="server" VisibleDuringInit="False" Width="100%"
                ...
                <telerik:RadPane ID="RadPane1" BackColor="#cbe1ef" runat="server" Width="50%" Height="99%">
                    ...
                    <asp:Panel runat="server" ID="panelInfo" Style="border-top: 1px solid #cccccc; border-bottom: 2px solid #cccccc; font-size: 10pt; margin: 3px; margin-right: 18px; padding: 5px; background: #ffc888">
                        ...
                        <div style="text-align: center">
                            <asp:Button CausesValidation="false" UseSubmitBehavior="false" OnClientClick="return ShowRestatus();" runat="server" Visible="false" ID="btnReStatus" Text="ย้อนสถานะผลการตรวจสอบ" /></div>
                    </asp:Panel>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                ...
                                                <div class="RadGrid RadGrid_Office2007" style="font-family: Tahoma; font-size: X-Small;">
                                                    <telerik:RadCodeBlock ID="RadCodeBlock11" runat="server">
                                                        <table border="0" class="rgMasterTable" cellpadding="0" cellspacing="0" style="width: 100%; table-layout: auto; empty-cells: show;">
                                                            <%If Request.QueryString("taxno") = "0115546006888" And Request.QueryString("RefNo") <> "20110928-003951" Then%>
                                                            <asp:Panel runat="server" ID="PanelInv">
                                                                <tr class="rgRow">
                                                                    <td style="width: 16px;"><a href="javascript:ShowInvoice();void(0);">
                                                                        <asp:Image ID="Image3" BorderStyle="None" ImageUrl="~/images/view.gif" ToolTip="View"
                                                                            ImageAlign="AbsMiddle" runat="server" /></a></td>
                                                                    <td><a href="javascript:ShowInvoice();void(0);">ใบกำกับสินค้า(Invoice)</a> </td>
                                                                </tr>
                                                            </asp:Panel>
                                                            <%End If%>
                                                        </table>
                                                ...
                                                <div style="padding: 5px; padding-left: 8px; border: 1px solid #666666; border-top: 2px solid #ff0000; background: #ffffff; text-align: center">
                                                    <span style="font-size: 10pt;">
                                                        <a href="#" onclick="return ShowAttachSheet();">
                                                            <img src="/images/view.gif" border="0" /></a>
                                                        <input type="button" value="แสดง Attached Sheet เพื่อตรวจสอบต้นทุน" onclick="return ShowAttachSheet();" /></span>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                        ...
                        function ShowInvoice() {
                            ...
                            myFrame.src = "Invoice.aspx?RefNo=" + '<%= Request.QueryString("RefNo") %>';
                        }
