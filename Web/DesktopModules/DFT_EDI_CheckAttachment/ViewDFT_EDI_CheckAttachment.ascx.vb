...
#End Region
        Private Sub rgRequestForm_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles rgRequestForm.ItemDataBound
            If TypeOf e.Item Is GridDataItem Then
                ...
                'If e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("IsSingleCO").ToString().ToLower() = "true" Then
                '    viewLink.Attributes("onclick") = [String].Format("return popup('{0}');", "/DesktopModules/DFT_EDI_CheckAttachment/frmCheckSingleForm.aspx?TaxNo=" &
                '        e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("company_taxno") &
                '        "&RefNo=" & e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("invh_run_auto") &
                '        "&form_type=" & e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type") &
                '        "&nswref=" & e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("NSWReferenceNo"))
                'Else
                ...
                If e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type").ToString().ToUpper() = "FORM44" _
                        ...
                        Or e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type").ToString().ToUpper() = "FORMD_ESS_" _
                        Or e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type").ToString().ToUpper() = "FORMD_ESS_ATTS" _
                        Or e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type").ToString().ToUpper() = "FORM44_02" Then

                    viewLink.Attributes("onclick") = [String].Format("return popup('{0}');", "/DesktopModules/DFT_EDI_CheckAttachment/frmCheckForm3.aspx?TaxNo=" + e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("company_taxno") + "&RefNo=" + e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("invh_run_auto") & "&form_type=" & e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type"))
                Else
                    If e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("SentBy") = "1" Then
                        viewLink.Attributes("onclick") = [String].Format("return popup('{0}');", "/DesktopModules/DFT_EDI_CheckAttachment/frmCheckForm1.aspx?TaxNo=" + e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("company_taxno") + "&RefNo=" + e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("invh_run_auto") & "&form_type=" & e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type"))
                    ElseIf e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("SentBy") = "2" Then
                        viewLink.Attributes("onclick") = [String].Format("return popup('{0}');", "/DesktopModules/DFT_EDI_CheckAttachment/frmCheckForm2.aspx?TaxNo=" + e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("company_taxno") + "&RefNo=" + e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("invh_run_auto") & "&form_type=" & e.Item.OwnerTableView.DataKeyValues(e.Item.ItemIndex)("form_type"))
                    End If
                End If
        ...
        Private Sub LoadFormTypeForSearching()
            Try
                ...
                strCommand = "SELECT form_type AS CODE, form_nameUsd AS DESCRIPTION " &
                             "FROM form_type " &
                "WHERE (isShowBackOffice = 1)" & "ORDER BY ShowOrder"
                ds = SqlHelper.ExecuteDataset(strEDIConn, CommandType.Text, strCommand)
