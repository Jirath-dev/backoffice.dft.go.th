<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_ChangeApproveDate.EditDFT_ChangeApproveDate" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_ChangeApproveDate.ascx.vb" %>
