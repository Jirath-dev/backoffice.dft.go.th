<%@ Control Language="vb" AutoEventWireup="false" Inherits="Nti.Modules.DFT_IISPoolManage.Settings" Codebehind="Settings.ascx.vb" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="DFT_IISPoolManage Settings Design Table">
    <tr>
