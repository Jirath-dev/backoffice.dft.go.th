<%@ Control language="vb" Inherits="NTI.Modules.DFT_EDI_SiteManage.EditDFT_EDI_SiteManage" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_SiteManage.ascx.vb" %>
