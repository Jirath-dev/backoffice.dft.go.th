<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_AddTariffFormAll.EditDFT_AddTariffFormAll" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_AddTariffFormAll.ascx.vb" %>
