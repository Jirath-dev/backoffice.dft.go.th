<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_F04_Report_05.ViewDFT_EDI_F04_Report_05" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_F04_Report_05.ascx.vb" %>
                                                ...
                                                <table cols="2" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td nowrap class="groupboxheader">
                                                            <font class="groupbox">&#160;&#160;รายงานเลยกำหนดส่งคืน 5 วัน&#160;&#160;</font></td>
                                    ...
                                    <telerik:RadGrid ID="rgAllRequestList" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <MasterTableView AutoGenerateColumns="False" CellSpacing="-1" Width="100%" NoMasterRecordsText="ไม่พบรายการที่ทำการค้นหา">
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="remark_docatt" HeaderText="เหตุผลการส่งคืน"
                                                    ReadOnly="True" SortExpression="remark_docatt" UniqueName="remark_docatt">
                                                    <ItemStyle Font-Names="Tahoma" Font-Size="10pt" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="date_edit" HeaderText="วันส่งคืน"
                                                    ReadOnly="True" SortExpression="date_edit" UniqueName="date_edit" DataFormatString="{0:dd/MM/yyyy}">
                                                    <ItemStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Center"/>
                                                </telerik:GridBoundColumn>
                                            </Columns>
                                        </MasterTableView>
