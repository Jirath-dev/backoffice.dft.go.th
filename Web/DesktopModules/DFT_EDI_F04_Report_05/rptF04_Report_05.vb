...
Public Class rptF04_Report_05
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        txtDate_Edit.Text = Convert.ToDateTime(txtDate_Edit.Text).ToString("d", New System.Globalization.CultureInfo("en-GB"))
            ...
            If dr.HasRows() Then
                ...
                If Not (dr.Item("invoice_no1").Equals(System.DBNull.Value) Or CommonUtility.Get_StringValue(dr.Item("invoice_no1")) = "") Then
                    If isFirst Then
                        ...
                        isFirst = False
                    Else
                        strInvoice &= "," & vbCrLf & CommonUtility.Get_StringValue(dr.Item("invoice_no1"))
                    End If
                End If
                ...
                If Not (dr.Item("invoice_no2").Equals(System.DBNull.Value) Or CommonUtility.Get_StringValue(dr.Item("invoice_no2")) = "") Then
                    If isFirst Then
                        ...
                        isFirst = False
                    Else
                        strInvoice &= "," & vbCrLf & CommonUtility.Get_StringValue(dr.Item("invoice_no2"))
                    End If
                End If
                ...
                If Not (dr.Item("invoice_no3").Equals(System.DBNull.Value) Or CommonUtility.Get_StringValue(dr.Item("invoice_no3")) = "") Then
                    If isFirst Then
                        ...
                        isFirst = False
                    Else
                        strInvoice &= "," & vbCrLf & CommonUtility.Get_StringValue(dr.Item("invoice_no3"))
                    End If
                End If
                ...
                If Not (dr.Item("invoice_no4").Equals(System.DBNull.Value) Or CommonUtility.Get_StringValue(dr.Item("invoice_no4")) = "") Then
                    If isFirst Then
                        ...
                        isFirst = False
                    Else
                        strInvoice &= "," & vbCrLf & CommonUtility.Get_StringValue(dr.Item("invoice_no4"))
                    End If
                End If
                ...
                If Not (dr.Item("invoice_no5").Equals(System.DBNull.Value) Or CommonUtility.Get_StringValue(dr.Item("invoice_no5")) = "") Then
                    If isFirst Then
                        ...
                        isFirst = False
                    Else
                        strInvoice &= "," & vbCrLf & CommonUtility.Get_StringValue(dr.Item("invoice_no5"))
                    End If
                End If
