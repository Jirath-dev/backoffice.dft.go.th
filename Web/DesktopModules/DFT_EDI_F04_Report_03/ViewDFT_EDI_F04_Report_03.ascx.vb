...
Namespace NTi.Modules.DFT_EDI_F04_Report_03
    Partial Class ViewDFT_EDI_F04_Report_03
...
#End Region
        Private Sub LoadFormType()
            Try
                ...
                ds = SqlHelper.ExecuteDataset(strConn, CommandType.StoredProcedure, "vi_select_form", _
        ...
        Function LoadReport() As SqlDataReader
            Try
                ...
                myReader = SqlHelper.ExecuteReader(objConn, CommandType.StoredProcedure, "vi_select_RepAtt2_NewDSByForm", _
