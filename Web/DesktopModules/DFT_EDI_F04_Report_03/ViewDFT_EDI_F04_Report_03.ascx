<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_F04_Report_03.ViewDFT_EDI_F04_Report_03" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_F04_Report_03.ascx.vb" %>
                                                ...
                                                <table cols="2" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td nowrap class="groupboxheader">
                                                            <font class="groupbox">&#160;&#160;รายงานการรับรายงานเอกสารประกอบคำขอหนงสือรับรองฯ&#160;&#160;</font></td>
                                    ...
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td style="width: 100%">
                                                ...
                                                <telerik:RadComboBox ID="dropFormType" runat="server" Skin="Web20" Width="500px" Filter="StartsWith" MarkFirstMatch="True" DataTextField="form_name" DataValueField="form_type">
                                                </telerik:RadComboBox>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td style="width: 100%">
                                    <telerik:RadGrid ID="rgAllRequestList" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        Font-Size="X-Small" TabIndex="-1" PageSize="40" ShowFooter="True">
                                        <MasterTableView AutoGenerateColumns="False" Width="100%" NoMasterRecordsText="ไม่พบรายการที่ทำการค้นหา" ShowGroupFooter="True">
                                            <GroupByExpressions>
                                                <telerik:GridGroupByExpression>
                                                    <SelectFields>
                                                        <telerik:GridGroupByField FieldAlias="form_name" FieldName="form_name" HeaderText=" "></telerik:GridGroupByField>
                                                    </SelectFields>
                                                    <GroupByFields>
                                                        <telerik:GridGroupByField FieldName="form_name" SortOrder="None" FieldAlias="form_name" HeaderText=""></telerik:GridGroupByField>
                                                    </GroupByFields>
                                                </telerik:GridGroupByExpression>
                                            </GroupByExpressions>
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="rep_by" HeaderText="ผู้บันทึกรับรายงาน"
