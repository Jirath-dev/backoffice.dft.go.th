<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_Rollver.EditDFT_EDI_Rollver" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_Rollver.ascx.vb" %>
