<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_BookingForm.EditDFT_EDI_BookingForm" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_BookingForm.ascx.vb" %>
