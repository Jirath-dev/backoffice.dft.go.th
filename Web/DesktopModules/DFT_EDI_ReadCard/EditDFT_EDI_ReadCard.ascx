<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_ReadCard.EditDFT_EDI_ReadCard" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_ReadCard.ascx.vb" %>
