<%@ Control language="vb" Inherits="NTi.Modules.DFT_FormE20Approve.EditDFT_FormE20Approve" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_FormE20Approve.ascx.vb" %>
