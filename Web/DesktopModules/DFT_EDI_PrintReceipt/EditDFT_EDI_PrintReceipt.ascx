<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_PrintReceipt.EditDFT_EDI_PrintReceipt" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_PrintReceipt.ascx.vb" %>
