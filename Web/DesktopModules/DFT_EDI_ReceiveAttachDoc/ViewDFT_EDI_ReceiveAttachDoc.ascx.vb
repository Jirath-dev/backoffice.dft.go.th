...
Namespace NTi.Modules.DFT_EDI_ReceiveAttachDoc
    Partial Class ViewDFT_EDI_ReceiveAttachDoc
            ...
            Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    If CommonUtility.Get_Int32(ds.Tables(0).Rows(0).Item("retSTATUS")) = 0 Then
                        'QUOTA END
                        Me.RadAjaxManager1.ResponseScripts.Add("window.alert('ทำการรับคืนหนังสือรับรองเลขที่ " & lblReferenceCode2.Text & " เรียบร้อยแล้ว');")
                        tblHeader.Visible = False
