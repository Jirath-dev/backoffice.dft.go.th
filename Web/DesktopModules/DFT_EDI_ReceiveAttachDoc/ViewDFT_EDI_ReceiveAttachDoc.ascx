<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_ReceiveAttachDoc.ViewDFT_EDI_ReceiveAttachDoc" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_ReceiveAttachDoc.ascx.vb" %>
                                                    ...
                                                    <tr class="m-frm-hdr">
                                                        <td width="88%" align="left" class="m-frm-hdr">
                                                            <table cols="2" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td nowrap class="groupboxheader">
                                                                        <font class="groupbox">&#160;&#160;รับคืนเอกสาร&#160;&#160;</font></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                                <tr>
                                                                    <td style="text-align: center">
                                                                        <asp:Button ID="btnEditDocAttach" runat="server" Text="รับคืนเอกสาร" Width="200px" Font-Names="Tahoma" Font-Size="10pt" /></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
