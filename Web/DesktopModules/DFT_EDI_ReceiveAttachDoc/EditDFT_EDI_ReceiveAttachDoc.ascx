<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_ReceiveAttachDoc.EditDFT_EDI_ReceiveAttachDoc" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_ReceiveAttachDoc.ascx.vb" %>
