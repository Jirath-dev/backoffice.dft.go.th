...
Namespace NTi.Modules.DFT_EDI_SendAttachDoc
    Partial Class ViewDFT_EDI_SendAttachDoc
...
#End Region
        ...
        Protected Sub btnEditDocAttach_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEditDocAttach.Click
            Try
                ...
                New SqlParameter("@remark_docatt", CommonUtility.Get_StringValue("")), _
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    If CommonUtility.Get_Int32(ds.Tables(0).Rows(0).Item("retSTATUS")) = 0 Then
                        'QUOTA END
                        Me.RadAjaxManager1.ResponseScripts.Add("window.alert('ทำการส่งแก้ไขหนังสือรับรองเลขที่ " & lblReferenceCode2.Text & " เรียบร้อยแล้ว');")
                        tblHeader.Visible = False
