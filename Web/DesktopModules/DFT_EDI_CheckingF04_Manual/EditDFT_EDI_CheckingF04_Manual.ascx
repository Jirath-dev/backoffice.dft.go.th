<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_CheckingF04_Manual.EditDFT_EDI_CheckingF04_Manual" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_CheckingF04_Manual.ascx.vb" %>
