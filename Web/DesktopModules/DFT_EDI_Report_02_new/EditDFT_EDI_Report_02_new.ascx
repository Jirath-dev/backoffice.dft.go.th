<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_EDI_Report_02_new.EditDFT_EDI_Report_02_new" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_Report_02_new.ascx.vb" %>
