<%@ Control Language="vb" AutoEventWireup="false" Inherits="YourCompany.Modules.DFT_EDI_Report_02_new.Settings" Codebehind="Settings.ascx.vb" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="DFT_EDI_Report_02_new Settings Design Table">
    <tr>
