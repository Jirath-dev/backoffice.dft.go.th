<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_Report_12.EditDFT_EDI_Report_12" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_Report_12.ascx.vb" %>
