<%@ Control language="vb" Inherits="Nti.Modules.DFT_EDI_ResetForm.EditDFT_EDI_ResetForm" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_ResetForm.ascx.vb" %>
