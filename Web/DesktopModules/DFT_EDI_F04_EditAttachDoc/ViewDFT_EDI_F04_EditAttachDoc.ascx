<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_F04_EditAttachDoc.ViewDFT_EDI_F04_EditAttachDoc" AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_F04_EditAttachDoc.ascx.vb" %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                                <tr>
                                                                    <td style="text-align: left">
                                                                        <font class="FormLabel">รายละเอียดที่ต้องแก้ไข</font></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="text-align: left">
                                                                        <telerik:RadTextBox ID="txtEditDetail" runat="server" Width="100%" Height="100px" TextMode="MultiLine">
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="text-align: center">
                                                                        <asp:Button ID="btnEditDocAttach" runat="server" Text="แจ้งแก้ไขเอกสาร" Width="200px" Font-Names="Tahoma" Font-Size="10pt" /></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
