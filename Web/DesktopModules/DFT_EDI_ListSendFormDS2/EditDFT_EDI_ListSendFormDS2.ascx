<%@ Control language="vb" Inherits="NTI.Modules.DFT_EDI_ListSendFormDS2.EditDFT_EDI_ListSendFormDS2" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_ListSendFormDS2.ascx.vb" %>
