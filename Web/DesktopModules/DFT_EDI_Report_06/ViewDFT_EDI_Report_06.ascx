<%@ Control Language="vb" Inherits="NTi.Modules.DFT_EDI_Report_06.ViewDFT_EDI_Report_06"
    AutoEventWireup="false" Explicit="True" Codebehind="ViewDFT_EDI_Report_06.ascx.vb" %>
