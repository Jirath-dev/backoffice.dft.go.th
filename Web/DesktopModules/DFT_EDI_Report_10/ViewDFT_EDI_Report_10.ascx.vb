...
Namespace NTi.Modules.DFT_EDI_Report_10
    Partial Class ViewDFT_EDI_Report_10
...
#End Region
        ...
        Function LoadData() As DataTable
            Try
                ...
                'sp_report_Notfound_form_manual '20090303','ST-001'
                ds = SqlHelper.ExecuteDataset(objConn, CommandType.StoredProcedure, "sp_report_Notfound_form_manual", _
