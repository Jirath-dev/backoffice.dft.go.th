...
Partial Public Class frmEDI_Report_00
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            ds = SqlHelper.ExecuteDataset(strConn, CommandType.StoredProcedure, "vi_select_RepAtt2_NewDS", _
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Dim rpt As New rptEDI_Report_00
