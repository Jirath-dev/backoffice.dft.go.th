...
Namespace NTi.Modules.DFT_EDI_Report_00
    Partial Class ViewDFT_EDI_Report_00
...
#End Region
        Function LoadReport() As SqlDataReader
            Try
                ...
                myReader = SqlHelper.ExecuteReader(objConn, CommandType.StoredProcedure, "vi_select_RepAtt2_NewDS", _
