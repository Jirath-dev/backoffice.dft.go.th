<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_PrintCertificate.EditDFT_EDI_PrintCertificate" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_PrintCertificate.ascx.vb" %>
