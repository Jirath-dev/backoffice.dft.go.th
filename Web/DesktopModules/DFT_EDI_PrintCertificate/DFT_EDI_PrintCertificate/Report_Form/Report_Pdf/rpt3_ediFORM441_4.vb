...
Public Class rpt3_ediFORM441_4
    'by rut D new
    ...
    Sub check_Issued_()
        ...
        Dim strBack_1, strBack_2, strBack_3 As String

        str_1 = CommonUtility.Get_DateTime(txtdeparture_date.Value).Day
        str_2 = CInt(str_1) + 1
        str_3 = CInt(str_1) + 2

        strBack_1 = CommonUtility.Get_DateTime(txtdeparture_date.Value).Day
        strBack_2 = CInt(strBack_1) - 1
        strBack_3 = CInt(strBack_1) - 2
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        Try
            ...
            'Select Case checkIssued_date(CommonUtility.Get_StringValue(txtinvh_run_auto.Value), CommonUtility.Get_DateTime(txtdeparture_date.Value)) 'CommonUtility.Get_StringValue(txtCheckIssued.Text)
            '    Case 1
            '        Pic_ch7_Issued.Visible = True
            '    Case Else
            '        Pic_ch7_Issued.Visible = False
    ...
    End Sub
    'backup ไว้ก่อน
    'Sub Check_show_check(ByVal F_check As Integer)
    '    Select Case F_check
    '        Case 1 And (Mid(CommonUtility.Get_StringValue(txtshow_check.Text), 1, 1) = "1")
    '            Pic_ch1_third.Visible = True
    '        Case 2 And (Mid(CommonUtility.Get_StringValue(txtshow_check.Text), 2, 1) = "1")
    '            Pic_ch2_accu.Visible = True
    '        Case 3 And (Mid(CommonUtility.Get_StringValue(txtshow_check.Text), 3, 1) = "1")
    '            Pic_ch3_back.Visible = True

    '        Case 4 And (Mid(CommonUtility.Get_StringValue(txtshow_check.Text), 4, 1) = "1")
    '            Pic_ch4_par.Visible = True
    '        Case 5 And (Mid(CommonUtility.Get_StringValue(txtshow_check.Text), 5, 1) = "1")
    '            Pic_ch5_exhibi.Visible = True
    '        Case 6 And (Mid(CommonUtility.Get_StringValue(txtshow_check.Text), 6, 1) = "1")
            ...
            Case 1
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                ...
                                                                String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, ""), txtinvh_run_auto.Value) & "        " & _
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                    ...
                                                                    BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " & _
                                                                    BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " & _
                                                                    BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, ""), txtinvh_run_auto.Value) & "        " & _
                                                                    IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                    "       _____________________________"
                Else
                    txtT_product.Text = All_str
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, ""), txtinvh_run_auto.Value) & "        " & _
                                                                IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                "       _____________________________"
                Else
                    txtT_product.Text = All_str
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, ""), txtinvh_run_auto.Value) & "        " & _
                                                                IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                "       _____________________________"
                Else
                    txtT_product.Text = All_str
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    ...
                    txtTotalAll.Visible = True
                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
                                                                BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, ""), txtinvh_run_auto.Value) & "        " & _
                                                                IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                "       _____________________________"
                Else
                    txtT_product.Text = All_str
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And CommonUtility.Get_StringValue(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        ...
                        GroupFooter1.Visible = True
                        txtTotalAll.Visible = True
                        txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, IIf(_IsAgent = True, txtInvAgentType.Text, ""), txtinvh_run_auto.Value) & "        " & _
                        IIf(_IsAgent = False, "", CheckInvAgent(_IsAgent, _Invoice_Agent, _CompanyName_Agent)) & _
                                                                                        "       _____________________________"
                    Else
                        txtT_product.Text = All_str & _
    ...
    '                                                            BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " & _
    '                                                            BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & _
    '                                                            String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, txtinvh_run_auto.Value) & "        " & _
    '                                                             IIf(CheckIsZeroOrNothing(txtthird_country.Text) = True, txtthird_country.Text & vbCrLf, "") & _
    '                                                            IIf(CheckIsZeroOrNothing(txtback_country.Text) = True, txtback_country.Text & vbCrLf, "") & _
    '                                                            IIf(CheckIsZeroOrNothing(txtplace_exibition.Text) = True, txtplace_exibition.Text & vbCrLf, "") & _
    '                                                            "       _____________________________"
    ...
    '                                                                BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " & _
    '                                                                BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " & _
    '                                                                BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, txtinvh_run_auto.Value) & "        " & _
    '                                                                "       _____________________________"
    '            Else
    '                txtT_product.Text = All_str
    '            End If
    ...
    '                                                            BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " & _
    '                                                            BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & "        " & _
    '                                                            BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, txtinvh_run_auto.Value) & "        " & _
    '                                                            "       _____________________________"
    '            Else
    '                txtT_product.Text = All_str
    '            End If
    ...
    '                txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
    '                                                            BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & "        " & _
    '                                                            BahtOnly(txtquantity3.Text, txtq_unit_code3.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, txtinvh_run_auto.Value) & "        " & _
    '                                                            "       _____________________________"
    '            Else
    '                txtT_product.Text = All_str
    '            End If
    ...
    '                txtTotalAll.Visible = True
    '                txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & "        " & _
    '                                                            BahtOnly(txtquantity2.Text, txtq_unit_code2.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, txtinvh_run_auto.Value) & "        " & _
    '                                                            "       _____________________________"
    '            Else
    '                txtT_product.Text = All_str
    '            End If
    ...
    '                    GroupFooter1.Visible = True
    '                    txtTotalAll.Visible = True
    '                    txtTotalAll.Text = "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New_Attach_ForAgent(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFob, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther, txtgross_weightH.Value, txtg_unit_code.Text, _IsAgent, _TAgent, txtinvh_run_auto.Value) & "        " & _
    '                                                                                    "       _____________________________"
    '                Else
    '                    txtT_product.Text = All_str & _
    '                                       "       _____________________________"
    ...
    'ก่อนปรับ
    'Sub CHeck_DisPlay(ByVal CountAllDetail As String, ByVal CheckDetailGross As String)
    ...
    Sub check_show_checkNS() 'อันเก่า ที่เลือกกรณี ได้เพียงอันเดียว ไม่ได้ใช้
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        Try
            ...
            TFob += Check_Null(txtAttUSDTotal.Value)

            ''rut att
            ''TUSD += Check_Null(txtUSDInvoiceDetail.Value)
            TUSD += Check_Null(txtAttThirdUSDTotal.Value)
