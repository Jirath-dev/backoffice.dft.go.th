...
#Region "back ตัวเก่าที่ยังไม่มี Title ไว้ก่อน"
...
#Region "back เก็บไว้ก่อน ใส่ Title แล้ว ก่อนที่จะแก้ ใช้อีกแบบ"
    'Sub All_CheckThird_5(ByVal count_data As Integer)
    '    Dim All_str As String
    '    Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
    '                            CommonUtility.Get_StringValue(txtback_country.Value), _
...
#End Region
    ...
    Private Sub rpt3_ediFORM1RU_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
    ...
    Private Sub rpt3_ediFORM1RU_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        End If
    End Sub

    Private Sub rpt3_ediFORM1RU_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
