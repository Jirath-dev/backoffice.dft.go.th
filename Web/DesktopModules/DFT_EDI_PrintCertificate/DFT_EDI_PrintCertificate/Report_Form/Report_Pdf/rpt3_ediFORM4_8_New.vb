...
Public Class rpt3_ediFORM4_8_New
    Dim Cpage As Integer
    Dim CpageNum, Check_CaseRVCCount As Integer

    Public _TempB2B As String
    'by rut gross new
    Dim TGross, TUSD, TUSDOther As Decimal
    Dim Str_USDinvoiceDetail, Str_TitlePage, head_height As String
...
#End Region
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 3 'T3_place_exibition
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And CommonUtility.Get_StringValue(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        txtT_product.Text = All_str & _
                                           "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFOB, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther) & _
                                                                                        "       _____________________________"
                    Else
                        txtT_product.Text = All_str & _
                                            "       _____________________________"
            ...
            Case 5 'T2_back_country
                ...
                If C_TotalRowDe.Text = count_data Then
                    If (Not txtquantity1.Text = String.Empty = True) And CommonUtility.Get_StringValue(txtquantity1.Text) <> "" And CommonUtility.Get_Decimal(IIf(Not (txtquantity1.Text = String.Empty) = False, 0, txtquantity1.Value)) <> 0 Then
                        txtT_product.Text = All_str & _
                                           "TOTAL: " & BahtOnly(txtquantity1.Text, txtq_unit_code1.Text) & vbCrLf & String_Total_USDOnly_New(txtDisplayUDS7.Text, txtCurrency_Code.Text, TFOB, CommonUtility.Get_StringValue(txtshow_check.Text), TUSD, TUSDOther) & vbNewLine & _
                                                                    _TempB2B & vbNewLine & _
                                                                    "       _____________________________"
                    Else
                        txtT_product.Text = All_str & _
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        'COpy From P'rut sign image ลายเซ็น กรรมการและผู้รับมอบ
            ...
            Select Case txtTemp_form_type.Text.ToUpper
                ...
                Case "FORM4_5", "FORM4_6" 'เฉพาะสินค้าที่ส่งออกไปประเทศญี่ปุ่น เท่านั้น
                    If txtTemp_destination_country.Text.ToUpper = "JP" Then
                        ...
                        CaseCheck_ApproveSign(search_imageForm(txtinvh_run_auto.Text))
                    End If
                Case "FORM4_8", "FORM4_81" 'ByTine 17-12-2558 ฟอร์ม AK เก่าและใหม่ ทุกประเทศ
                    'If txtTemp_destination_country.Text.ToUpper = "JP" Then
                    CaseCheck_numimagesSign(search_imageForm(txtinvh_run_auto.Text))
                    CaseCheck_ApproveSign(search_imageForm(txtinvh_run_auto.Text))
                    'End If
