...
Public Class rpt3_ediFORM441
    ...
    ''สำหรับ FORM441 เพราะไม่มีข้อมูลเข้าที่ฟิล์ด show_check
        ...
        Select Case Check_Third(CommonUtility.Get_StringValue(txtthird_country.Value), _
            ...
            Case 1
                ...
                If C_TotalRowDe.Text = count_data Then
                    txtT_product.Text = All_str & Form_NewStr_AddressDetail(CommonUtility.Get_StringValue(txtByCom_CH03.Text)) & _
    ...
    Private Sub rpt3_ediFORM4_1_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 7.06
        Dim ym As Single = 4.567
        'Dim width As Single = 6.0F
        Dim widthm As Single = 0.98
        ...
        Dim y_txtGrossTxt As Single = 4.567
        'Dim width As Single = 6.0F
        Dim width_txtGrossTxt As Single = 0.98
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 0.76
        Dim y_txtmarks As Single = 4.567
        'Dim width As Single = 6.0F
        Dim width_txtmarks As Single = 1.02
    ...
    Private Sub rpt3_ediFORM4_1_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
