...
Public Class rpt3_ediFORM4_2_pr
    ...
    Function CHeck_DisPlayF() As String
        ...
        If CommonUtility.Get_StringValue(txtUSDInvoice.Value) <> "" Then
            str_USDInvoice = Format(CommonUtility.Get_Decimal(txtUSDInvoice.Value), "#,###.##") & " USD"
        Else
            str_USDInvoice = ""
        End If
                ...
                Select Case _LETTER
                    Case "2"
                        If _SINGLE_COUNTRY_CONTENT <> "" Then
                            str_text = """" & _Box8Str & "%""" & vbNewLine & _SINGLE_COUNTRY_CONTENT
                        Else
                            str_text = """" & _Box8Str & "%"""
                        End If
                    Case Else
...
#Region "Back"
    ...
    '                                                                BahtOnly(txtquantity4.Text, txtq_unit_code4.Text) & vbCrLf & "        " & _
    '                                                                BahtOnly(txtquantity5.Text, txtq_unit_code5.Text) & vbCrLf & _
    '                                                                CommonUtility.Get_StringValue(txtsupplementary_details.Value) & vbCrLf & _
    '                                                                "DATE " & Format(txtRep_Doc_date2.Value, "d/MM/yyy") & _
    '                                                                                        " , Ref." & txtReserve1.Value & vbNewLine & _
    '                                                                "       _____________________________"
    '            Else
    '                txtT_product.Text = All_str
    '            End If
