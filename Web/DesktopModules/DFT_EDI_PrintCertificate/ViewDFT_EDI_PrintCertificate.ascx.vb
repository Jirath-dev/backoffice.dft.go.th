...
Namespace NTi.Modules.DFT_EDI_PrintCertificate
    Partial Class ViewDFT_EDI_PrintCertificate
        ...
        'เปลี่ยนตอน refresh
        Dim strEDIConnFre As String = ConfigurationManager.ConnectionStrings("EDIConnection").ConnectionString
        ...
        Sub ShowForm_AD(ByVal _siteID As String)
            Select Case _siteID
                Case "ST-001"
					...
					If (UserInfo.Username.ToLower = "nattayasds" Or UserInfo.Username.ToLower = "panaddam") Then
                        rdoD_ALL.SelectedValue = "D2"
                    End If
                Case Else
        ...
        Protected Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
            Try
                ...
                If ReportPrintClass.CheckSetActiveWsRover = True Then ''เปิดใช้งาน
                    grdBlackListV2.DataSource = ReportPrintClass.GetOriginAlertDetail(txtCompany_Taxno.Text.Trim)
                    grdBlackListV2.DataBind()

                    txtReturnMsgBlack.ForeColor = Drawing.Color.Orange
                    txtReturnMsgBlack.Text = ReportPrintClass.CheckOrginAlert(txtCompany_Taxno.Text.Trim)
                Else
                    grdBlackListV2.DataSource = Nothing
                    grdBlackListV2.DataBind()
        ...
        Function GetFormName_(ByVal sent_check As Object) As String
            ...
            If Not sent_check.Equals(System.DBNull.Value) = True Then
                Select Case sent_check
                    ...
                    Case "FORMRussia"
                        S_check = "เอ RUSSIAN"
                    Case "FORM44_01", "FORMD_ESS"
                        S_check = "ดี ASW "
                    Case "FORM44_02", "FORMD_ESS_", "FORM_ESS_ATTS"
                        S_check = "ดี ASW Attach Sheet "
                    Case "FORMAHK"
                        S_check = "AHK"
                    Case "FORME_01"
                        S_check = "อี (ใหม่)"
                    Case "FORMTC_ESS"
                        S_check = "ไทย-ชิลี (ESS)"
                    Case "FORME_ESS"
                        S_check = "อี (ESS)"
                    Case "FORMRCEP"
                        S_check = "RCEP"
