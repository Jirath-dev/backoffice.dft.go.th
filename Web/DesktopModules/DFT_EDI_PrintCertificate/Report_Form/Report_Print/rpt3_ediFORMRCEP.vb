...
Public Class rpt3_ediFORMRCEP
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            'issued
            Select Case CheckIssuedDate_Forms_TP(CDate(txtdeparture_date.Value), CDate(IIf(IsDBNull(CDate(ds.Tables(0).Rows(0).Item("printFormDate"))) = True, Now.Date, CDate(ds.Tables(0).Rows(0).Item("printFormDate")))))
                Case True
                    Pic_ch7_Issued.Visible = True
                Case False
                    Pic_ch7_Issued.Visible = False
    ...
    Private Sub rpt3_ediFORMRCEPpr_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageStart
        ...
        Me.CurrentPage.DrawLine(1.4, detail_line_start, 1.4, detail_line_end)
        Me.CurrentPage.DrawLine(3.7, detail_line_start, 3.7, detail_line_end)
