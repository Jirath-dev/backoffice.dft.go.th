...
Public Class rpt3_ediFORMFTA_IN_pr
...
#End Region
    ...
    Private Sub rpt3_ediFORMFTA_IN_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        head_height = PageHeader1.Height + 0.18
    ...
    Private Sub rpt3_ediFORMFTA_IN_pr_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        End If
    End Sub

    Private Sub rpt3_ediFORMFTA_IN_pr_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
