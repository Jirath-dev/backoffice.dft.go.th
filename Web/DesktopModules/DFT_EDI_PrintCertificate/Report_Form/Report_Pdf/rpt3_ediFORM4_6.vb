        ...
        Select Case txtshow_check.Text
            ...
            Case Else 'ไม่ใช่ invoice ต่างประเทศ
                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                    ...
                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "NET WEIGHT" Then
                        str_gross = NetWeight_(TNet, txtunit_code2.Value)
                        str_GrossF = str_gross & vbNewLine & FobTxtAllSum()
        ...
        If reports_CardID(arr_(0).ToString) <> "" Then
            Select Case arr_.Length - 1
                Case 1
                    ...
                    '                    Picture_SealAuthor.Image = New Drawing.Bitmap("Z:\0405533000247\2013\SealPerson\3660400121998\3660400121998_New_นพอนันต์ NK1.jpg") 'reports_CardID(arr_(0).ToString))
...
#End Region
    ...
    Private Sub rpt3_ediFORM4_6_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        Dim ym As Single = CSng(head_height) '4.813
        ...
        Dim y_txtGrossTxt As Single = CSng(head_height) '4.813
        'Dim width As Single = 6.0F
        ...
        Dim y_txtmarks As Single = CSng(head_height) '4.813
        'Dim width As Single = 6.0F
