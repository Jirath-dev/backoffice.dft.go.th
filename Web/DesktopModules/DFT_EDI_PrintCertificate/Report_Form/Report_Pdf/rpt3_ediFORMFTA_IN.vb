...
Public Class rpt3_ediFORMFTA_IN
...
#End Region
    ...
    Private Sub rpt3_ediFORMs4_3_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        head_height = PageHeader1.Height

        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 7.22
        Dim ym As Single = CSng(head_height) '4.898
        ...
        Dim y_txtGrossTxt As Single = CSng(head_height) '4.898
        'Dim width As Single = 6.0F
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 1.15
        Dim y_txtmarks As Single = CSng(head_height) '4.898
        'Dim width As Single = 6.0F
    ...
    Private Sub rpt3_ediFORMs4_3_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        End If
    End Sub

    Private Sub rpt3_ediFORMs4_3_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
