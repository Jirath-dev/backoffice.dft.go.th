...
#Region "back อันเก่า ก่อนใส่ title"
...
#End Region
    ...
    Function CHeck_DisPlayF() As String
        ...
        If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
            ...
            If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                str_gross = GrossTxt() & vbNewLine & vbNewLine & NetWeight_(TNet, txtunit_code2.Value)
    ...
    Private Sub rpt3_ediFORM1_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        End With
        '============================
        Dim x_txtGrossTxt As Single = 6.18
    ...
    Private Sub rpt3_ediFORM1_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        End If
    End Sub

    Private Sub rpt3_ediFORM1_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
