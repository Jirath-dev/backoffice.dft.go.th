...
Imports Module_CallBathEng
Imports ReportPrintClass
Public Class rpt3_ediFORM3
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        txtTemp_Company_province.Value = CommonUtility.Get_StringValue(txtcompany_province.Text) & " " & format_dateSelect()
    ...
    Sub Head_CheckFac()
        txtTemp_factory.Text = txtfactory_address.Text & " " & txtfactory_province.Text & " " & txtfactory_country.Text _
                                        & vbNewLine & IIf(CommonUtility.Get_StringValue(txtfactory_phone.Text) <> "", "TEL: " & txtfactory_phone.Text, "") & _
                                        IIf(CommonUtility.Get_StringValue(txtfactory_fax.Text) <> "", " FAX: " & txtfactory_fax.Text, "") _
                                        & vbNewLine & IIf(CommonUtility.Get_StringValue(txtfactory_taxid.Text) <> "", "TAX: " & txtfactory_taxid.Text, "")
    End Sub
    ...
    Sub Head_Checkcompany_v1()
        If Mid(txtdest_remark.Text, 1, 3) = "C/O" Then
            txtCompany_Check_1.Text = str_01 & txtob_address.Text & IIf(Check_NULLALL(txtNewEmail_ch01.Text) <> "", " E-mail: " & txtNewEmail_ch01.Text, "") & " CARE OF " & txtcompany_name.Text & " " & txtcompany_address.Text _
        ...
        ElseIf Mid(txtdest_remark.Text, 1, 3) = "O/B" Then
            txtCompany_Check_1.Text = str_01 & txtcompany_name.Text & " " & txtcompany_address.Text & " " & txtcompany_province.Text _
    ...
    Sub Head_Checkdestination_v2()
        If Mid(txtdest_remark1.Text, 1, 3) = "C/O" Then
            txtdestination_Check2.Text = str_02 & txtob_dest_address.Text & IIf(Check_NULLALL(txtNewEmail_ch02.Text) <> "", " E-mail: " & txtNewEmail_ch02.Text, "") & " CARE OF " & txtdestination_company.Text & " " & txtdestination_address.Text _
        ...
        ElseIf Mid(txtdest_remark1.Text, 1, 3) = "O/B" Then
            txtdestination_Check2.Text = str_02 & txtdestination_company.Text & " " & txtdestination_address.Text & " " & _
                                    txtdestination_province.Text & " " & txtdest_Receive_country.Text & _
                                    IIf(CommonUtility.Get_StringValue(Check_NULLALL(txtdestination_phone.Text)) <> "", " TEL: " & txtdestination_phone.Text, "") & _
                                    IIf(CommonUtility.Get_StringValue(Check_NULLALL(txtdestination_fax.Text)) <> "", " FAX: " & txtdestination_fax.Text, "") _
                                    & IIf(CommonUtility.Get_StringValue(Check_NULLALL(txtdestination_taxid.Text)) <> "", " TAX ID: " & txtdestination_taxid.Text, "") & _
        ...
        ElseIf Mid(txtdest_remark1.Text, 2, 1) <> "/" Then
            txtdestination_Check2.Text = str_02 & txtdestination_company.Text & " " & txtdestination_address.Text & " " & txtdestination_province.Text _
...
#End Region
    ...
    Private Sub rpt3_ediFORM3_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 4.9
        Dim ym As Single = PageHeader1.Height '2.638
        'Dim width As Single = 6.0F
        Dim widthm As Single = 1.08
    ...
    Private Sub rpt3_ediFORM3_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
        If updatePrintTotal(txtinvh_run_auto.Value, CStr(Me.Document.Pages.Count)) = True Then

        End If
    End Sub

    Private Sub rpt3_ediFORM3_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
