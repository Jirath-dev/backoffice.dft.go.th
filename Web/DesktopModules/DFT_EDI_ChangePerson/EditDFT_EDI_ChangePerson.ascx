<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_EDI_ChangePerson.EditDFT_EDI_ChangePerson" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_ChangePerson.ascx.vb" %>
