<%@ Control language="vb" Inherits="YourCompany.Modules.RadModuleTest.EditRadModuleTest" AutoEventWireup="false" Explicit="True" Codebehind="EditRadModuleTest.ascx.vb" %>
