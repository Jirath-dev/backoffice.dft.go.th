<%@ Control Language="vb" AutoEventWireup="false" Inherits="YourCompany.Modules.RadModuleTest.Settings" Codebehind="Settings.ascx.vb" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="RadModuleTest Settings Design Table">
    <tr>
