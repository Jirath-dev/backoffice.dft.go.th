<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_EDI_ChangePasswordCard.EditDFT_EDI_ChangePasswordCard" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_ChangePasswordCard.ascx.vb" %>
