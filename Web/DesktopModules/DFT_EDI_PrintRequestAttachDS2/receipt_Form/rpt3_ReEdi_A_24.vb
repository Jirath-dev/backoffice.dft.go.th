...
Public Class rpt3_ReEdi_A_24
    ...
    Private Sub Detail1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail1.Format
        ...
        txtNET_WEIGHT_unit_code2.Text = Format(txtKGSNet.Value, "#,##0.00##") + " KGS" '+ txtunit_code2.Text
...
#End Region
    Private Sub PageHeader1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageHeader1.Format
        ...
        Select Case CommonUtility.Get_StringValue(txtform_type.Text)
            Case "FORM2_4"
                txtForm_Name_Temp.Text = "คำขอหนังสือรับรองถิ่นกำเนิดสินค้าเกษตรเพื่อนำเข้าสหภาพยุโรป (แป้งมันสำปะหลัง)"
        End Select
    ...
    Private Sub PageFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PageFooter1.Format
        ...
        txtSum_Net_Weight.Text = "(" & Format(CDec(txtReserve1.Text), "#,##0.00##") & " TON)" & " " & Format(CDec(txtSumKGSNetDetail.Text), "#,##0.00##") & " KGS" '& txtunit_code2.Text
