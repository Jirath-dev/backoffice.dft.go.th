...
Public Class rpt3_ediFORMs4_3_pr
    ...
    Sub CallInvoiceCheck() 'Check Invoince
        If CommonUtility.Get_StringValue(txtNumInvoice.Value) <> "" And CommonUtility.Get_StringValue(txtUSDInvoice.Value) <> "" Then
    ...
    Function CHeck_DisPlayF() As String
        ...
        If str_NumInvoice <> "" And str_USDInvoice <> "" Then
            If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                ...
                If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                    str_gross = "G.W." & vbNewLine & GrossTxt() & vbNewLine & "N.W." & vbNewLine & NetWeight_(TNet, txtunit_code2.Value) '& vbNewLine & FobTxtAll()
        ...
        Else
            If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                ...
                If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                    str_gross = "G.W." & vbNewLine & GrossTxt() & vbNewLine & FobTxtAllSum() & vbNewLine & "N.W." & vbNewLine & NetWeight_(TNet, txtunit_code2.Value) '& vbNewLine & FobTxtAll()
                    str_GrossF = str_gross
                ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT" Then
            ...
            ElseIf Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "" Then
                ...
                ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "" Then 'ระบบเก่า
                    str_gross = "G.W." & vbNewLine & GrossTxt() & vbNewLine & FobTxtAllSum() 'ระบบเก่า
                    str_GrossF = str_gross
                End If
            End If
        End If
    ...
    Private Sub rpt3_ediFORMs4_3_pr_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        ...
        Dim ym As Single = 4.938 '4.76
        'Dim width As Single = 6.0F
        Dim widthm As Single = 0.75
        ...
        Dim y_txtGrossTxt As Single = 4.938 '4.76
        'Dim width As Single = 6.0F
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 1.25
        Dim y_txtmarks As Single = 4.938 '4.76
        'Dim width As Single = 6.0F
