...
Public Class rpt3_ediFORM5 
    ...
    Private Sub rpt3_ediFORM5_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 6.99
        Dim ym As Single = 4.724
        'Dim width As Single = 6.0F
        Dim widthm As Single = 0.91
        ...
        End With
        '============================
        Dim x_txtGrossTxt As Single = 6.08
    ...
    Private Sub rpt3_ediFORM5_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
