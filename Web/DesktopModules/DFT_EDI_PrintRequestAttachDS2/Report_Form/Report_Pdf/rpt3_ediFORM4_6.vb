...
Public Class rpt3_ediFORM4_6
            ...
            Case "10" ' เรื่อง invoice ต่างประเทศ
                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                    ...
                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "NW" Then 'ระบบเก่า
                        str_gross = "N.W." & vbNewLine & NetWeight_(TNet, txtunit_code2.Value)
            ...
            Case Else 'ไม่ใช่ invoice ต่างประเทศ
                If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
                    ...
                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GW-NW" Then 'ระบบเก่า
                        ...
                        str_GrossF = str_gross
                    ElseIf Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "NW" Then 'ระบบเก่า
                        str_gross = "N.W." & vbNewLine & NetWeight_(TNet, txtunit_code2.Value) & vbNewLine & FobTxtAllSum()
                        str_GrossF = str_gross
                    End If
                ElseIf Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "NoDisplay" Then
                    If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "NET WEIGHT" Then
    ...
    Private Sub rpt3_ediFORM4_6_PageEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PageEnd
        Dim f As New System.Drawing.Font("BrowalliaUPC", 11)

        Dim xm As Single = 7.06
        Dim ym As Single = 4.813
        ...
        Dim y_txtGrossTxt As Single = 4.813
        'Dim width As Single = 6.0F
        Dim width_txtGrossTxt As Single = 1.02
        ...
        End With
        '============================
        Dim x_txtmarks As Single = 0.77
        Dim y_txtmarks As Single = 4.813
        'Dim width As Single = 6.0F
    ...
    Private Sub rpt3_ediFORM4_6_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
    ...
    Private Sub rpt3_ediFORM4_6_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
