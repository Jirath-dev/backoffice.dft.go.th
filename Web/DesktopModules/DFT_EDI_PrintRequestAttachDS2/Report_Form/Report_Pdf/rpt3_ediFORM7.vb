...
Public Class rpt3_ediFORM7
    ...
    Sub CHeck_DisPlay()
        ...
        If Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "Display" Then
            ...
            If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                str_gross = "G.W." & vbNewLine & GrossTxt() & vbNewLine & FobTxt() & vbNewLine & "N.W." & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value)
        ...
        ElseIf Mid(CommonUtility.Get_StringValue(txtFOBDisplay.Value), 1, 50) = "NoDisplay" Then
            If Mid(CommonUtility.Get_StringValue(txtWeightDisplayHeaderH.Value), 1, 50) = "GROSS WEIGHT - NET WEIGHT" Then
                str_gross = "G.W." & vbNewLine & GrossTxt() & vbNewLine & "N.W." & vbNewLine & NetWeight_(txtnet_weight.Value, txtunit_code2.Value)
                Select Case C_TotalRowDe.Text
                    Case 1
                        txtGrossTxt.Text = str_gross
                    Case Else
    ...
    Private Sub rpt3_ediFORM7_ReportEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportEnd
