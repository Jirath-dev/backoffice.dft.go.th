<%@ Control Language="vb" AutoEventWireup="false" Inherits="NTi.Modules.DFT_EDI_Report_09.Settings" Codebehind="Settings.ascx.vb" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="DFT_EDI_Report_09 Settings Design Table">
    <tr>
