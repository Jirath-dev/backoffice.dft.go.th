...
#End Region
        ...
        Private Sub LoadAllCompany()
            Try
                ...
                strCommand = "select aa.* from (select COMPANY_TAXNO,COMPANY_ENG from COMPANY union select '%' as COMPANY_TAXNO,'ทุกบริษัท' as COMPANY_ENG from COMPANY) aa order by aa.COMPANY_ENG"
