...
Namespace NTi.Modules.DFT_EDI_F04_Report_01
    Partial Class ViewDFT_EDI_F04_Report_01
...
#End Region
        Function LoadReport() As SqlDataReader
            Try
                ...
                myReader = SqlHelper.ExecuteReader(objConn, CommandType.StoredProcedure, "vi_select_RepAtt2_F04_NewDS", _
