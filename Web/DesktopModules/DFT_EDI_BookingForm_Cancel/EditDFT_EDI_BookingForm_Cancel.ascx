<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_BookingForm_Cancel.EditDFT_EDI_BookingForm_Cancel" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_BookingForm_Cancel.ascx.vb" %>
