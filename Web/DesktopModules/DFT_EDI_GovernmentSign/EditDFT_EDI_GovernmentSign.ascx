<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_GovernmentSign.EditDFT_EDI_GovernmentSign" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_GovernmentSign.ascx.vb" %>
