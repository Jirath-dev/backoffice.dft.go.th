<%@ Control Language="vb" Inherits="YourCompany.Modules.DFT_ReportEDIByCountryForm.ViewDFT_ReportEDIByCountryForm"
    AutoEventWireup="false" Explicit="True" CodeBehind="ViewDFT_ReportEDIByCountryForm.ascx.vb" %>
                                                ...
                                                <table cols="2" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td nowrap class="groupboxheader">
                                                            <font class="groupbox">&#160;&#160;รายงานสรุปยอดการออกหนังสือรับรอง(EDI) By Country&#160;&#160;</font>
                                                        </td>
                                                ...
                                                <table cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" align="left" style="height: 30px">
                                                            ...
                                                            Filter="StartsWith" MarkFirstMatch="True" Width="400px" Font-Names="Tahoma"
                                                            Font-Size="10pt">
                                                        </telerik:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td valign="top" align="left" style="height: 30px">
                                                            <telerik:RadComboBox ID="ddlSelectCountry" runat="server" AllowCustomText="True"
                                                            DropDownWidth="300px" EmptyMessage="-----กรุณาเลือกประเทศ-----" MaxHeight="200px"
                                                            Width="220px" Filter="Contains">
                                                        </telerik:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                            ...
                            <tr>
                                <td style="width: 100%">
                                    <telerik:RadGrid ID="rgEDI" runat="server" AllowSorting="True" GridLines="None" ShowStatusBar="True"
                                        Skin="Office2007" TabIndex="-1" Width="100%" ShowHeader="true" ShowFooter="true"
                                        ...
                                        <MasterTableView NoMasterRecordsText="ไม่พบข้อมูลหนังสือรับรอง" AutoGenerateColumns="False"
                                            Width="100%" GroupLoadMode="Client" TableLayout="Auto" ShowGroupFooter="True"
                                            NoDetailRecordsText="ไม่พบข้อมูลหนังสือรับรอง" IsFilterItemExpanded="False" GroupsDefaultExpanded="false">
                                            <GroupByExpressions>
                                                <telerik:GridGroupByExpression>
                                                    <SelectFields>
                                                        <telerik:GridGroupByField FieldName="country_name" HeaderText="ประเทศ " FieldAlias="country_name"
                                                            FormatString="" />
                                                        <telerik:GridGroupByField FieldName="SentBy" HeaderText="ส่ง " FieldAlias="SentBy"
                                                            FormatString="" />
                                                    </SelectFields>
                                                    <GroupByFields>
                                                        <telerik:GridGroupByField FieldName="country_name" FieldAlias="country_name" FormatString=""
                                                            HeaderText="" />
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn Aggregate="Sum" DataField="fob_amt" HeaderText="มูลค่า (FOB)"
                                                    FooterText="รวม : " UniqueName="fob_amt">
                                                ...
                                                <telerik:GridBoundColumn Aggregate="Sum" DataField="Form_Count" HeaderText="จำนวนฉบับ (ตามเลขที่อ้างอิง)"
                                                    FooterText="รวม : " UniqueName="Form_Count">
                                                    <FooterStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Right" />
                                                    <ItemStyle Font-Names="Tahoma" Font-Size="10pt" HorizontalAlign="Right" />
                                                </telerik:GridBoundColumn>
