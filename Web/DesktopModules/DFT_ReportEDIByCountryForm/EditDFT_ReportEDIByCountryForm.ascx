<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_ReportEDIByCountryForm.EditDFT_ReportEDIByCountryForm" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_ReportEDIByCountryForm.ascx.vb" %>
