...
Partial Public Class frmEditProductItem
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            '============================
            txtTariffCode.Text = CommonUtility.Get_StringValue(Request.QueryString("tariff_code"))
            txtCertificateNo.Text = CommonUtility.Get_StringValue(Request.QueryString("certoforigin_no"))
            txtTariffName.Text = CommonUtility.Get_StringValue(Request.QueryString("product_description"))
            txtNetWeight.Value = CommonUtility.Get_Decimal(Request.QueryString("net_weight"))
            txtFOB.Value = CommonUtility.Get_Decimal(Request.QueryString("fob_amt"))
        End If
    End Sub
