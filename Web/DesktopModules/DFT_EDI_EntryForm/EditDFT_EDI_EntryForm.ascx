<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_EntryForm.EditDFT_EDI_EntryForm" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_EntryForm.ascx.vb" %>
