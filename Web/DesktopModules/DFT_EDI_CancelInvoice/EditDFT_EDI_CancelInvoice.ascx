<%@ Control language="vb" Inherits="NTi.Modules.DFT_EDI_CancelInvoice.EditDFT_EDI_CancelInvoice" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_EDI_CancelInvoice.ascx.vb" %>
