<%@ Control Language="vb" AutoEventWireup="false" Inherits="NTI.Modules.DFT_DS2_AdminDashboard.Settings" Codebehind="Settings.ascx.vb" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="DFT_DS2_AdminDashboard Settings Design Table">
    <tr>
