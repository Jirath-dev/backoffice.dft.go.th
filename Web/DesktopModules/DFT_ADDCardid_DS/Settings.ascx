<%@ Control Language="vb" AutoEventWireup="false" Inherits="YourCompany.Modules.DFT_ADDCardid_DS.Settings" Codebehind="Settings.ascx.vb" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="0" cellpadding="2" border="0" summary="DFT_ADDCardid_DS Settings Design Table">
    <tr>
