<%@ Control language="vb" Inherits="YourCompany.Modules.DFT_ADDCardid_DS.EditDFT_ADDCardid_DS" AutoEventWireup="false" Explicit="True" Codebehind="EditDFT_ADDCardid_DS.ascx.vb" %>
